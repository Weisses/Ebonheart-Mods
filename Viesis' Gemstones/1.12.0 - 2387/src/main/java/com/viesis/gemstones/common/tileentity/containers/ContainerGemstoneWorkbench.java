...
public class ContainerGemstoneWorkbench extends ContainerVC {
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int i = 0; i < this.listeners.size(); ++i)
        {
            ...
            {
                icontainerlistener.sendWindowProperty(this, 0, this.gemstoneWorkbench.getField(0));
            }
            
            if (this.totalCutTime != this.gemstoneWorkbench.getField(1))
            {
                icontainerlistener.sendWindowProperty(this, 1, this.gemstoneWorkbench.getField(1));
            }
            
            if (this.procChance != this.gemstoneWorkbench.getField(2))
            {
                icontainerlistener.sendWindowProperty(this, 2, this.gemstoneWorkbench.getField(2));
            }
        }
