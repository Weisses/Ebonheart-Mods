...
public class GuiTileEntityGemstoneWorkbenchMain extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		{
			this.fontRenderer.drawString(this.gemstoneWorkbench.getField(2) + "%", 14, 27, 0);
		}
		else if(this.gemstoneWorkbench.getField(2) >= 100)
		{
			this.fontRenderer.drawString(this.gemstoneWorkbench.getField(2) + "%", 16, 27, 0);
		}
		else if(this.gemstoneWorkbench.getField(2) > 9)
		{
			this.fontRenderer.drawString(this.gemstoneWorkbench.getField(2) + "%", 17, 27, 0);
		}
		else if(this.gemstoneWorkbench.getField(2) > 0)
		{
			this.fontRenderer.drawString(this.gemstoneWorkbench.getField(2) + "%", 20, 27, 0);
		}
		else if(this.gemstoneWorkbench.getField(2) == 0)
		{
