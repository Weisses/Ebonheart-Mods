...
import com.viesis.gemstones.api.creativeTab.VGTabBlocksRegular;
import com.viesis.gemstones.api.creativeTab.VGTabGeneral;
...
public class ViesisGemstones {
	...
	public static final VGTabGeneral tabVGGeneral = new VGTabGeneral("tabVGGeneral");
	public static final VGTabItems tabVGItems = new VGTabItems("tabVGItems");
	public static final VGTabBlocksRegular tabVGBlocksRegular = new VGTabBlocksRegular("tabVGBlocksRegular");
