package com.viesis.gemstones.api.zzzArk;
...
public class RenderEnchantedEbonheart extends Render<EntityEnchantedEbonheart>
{
	...
	public static final ResourceLocation ENTITY_TEXTURE = new ResourceLocation(References.MOD_ID, "textures/items/gems/enchanted_ebonheart.png");
    private float scale;
    ...
    public void doRender(EntityEnchantedEbonheart entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        TextureAtlasSprite textureatlassprite = Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(InitItemsVG.gemstone_item_basic_v1//.enchanted_ebonheart
        		);
