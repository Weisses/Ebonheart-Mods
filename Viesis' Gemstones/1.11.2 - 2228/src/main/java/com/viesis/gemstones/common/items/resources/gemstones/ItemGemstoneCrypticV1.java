...
public class ItemGemstoneCrypticV1 extends Item {
	
	public ItemGemstoneCrypticV1() 
	{
		ItemHelper.setItemName(this, "gemstone/cryptic/item_cryptic");
    ...
    {
        return (I18n.translateToLocal("vg.item.cryptic") + " " + 
