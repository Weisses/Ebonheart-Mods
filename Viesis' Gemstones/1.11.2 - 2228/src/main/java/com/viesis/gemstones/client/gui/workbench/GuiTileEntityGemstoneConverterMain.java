...
public class GuiTileEntityGemstoneConverterMain extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		{
			this.fontRendererObj.drawString(this.gemstoneConverter.getField(2) + "%", 14, 27, 0);
		}
		else if(this.gemstoneConverter.getField(2) >= 100)
		{
			this.fontRendererObj.drawString(this.gemstoneConverter.getField(2) + "%", 16, 27, 0);
		}
		else if(this.gemstoneConverter.getField(2) > 9)
		{
			this.fontRendererObj.drawString(this.gemstoneConverter.getField(2) + "%", 17, 27, 0);
		}
		else if(this.gemstoneConverter.getField(2) > 0)
		{
			this.fontRendererObj.drawString(this.gemstoneConverter.getField(2) + "%", 20, 27, 0);
		}
		else if(this.gemstoneConverter.getField(2) == 0)
		{
