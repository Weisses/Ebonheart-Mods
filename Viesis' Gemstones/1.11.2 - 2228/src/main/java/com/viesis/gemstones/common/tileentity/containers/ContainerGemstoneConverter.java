...
public class ContainerGemstoneConverter extends ContainerVC {
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int i = 0; i < this.listeners.size(); ++i)
        {
            ...
            {
                icontainerlistener.sendProgressBarUpdate(this, 0, this.gemstoneConverter.getField(0));
            }
            
            if (this.totalCutTime != this.gemstoneConverter.getField(1))
            {
                icontainerlistener.sendProgressBarUpdate(this, 1, this.gemstoneConverter.getField(1));
            }
            
            if (this.procChance != this.gemstoneConverter.getField(2))
            {
                icontainerlistener.sendProgressBarUpdate(this, 2, this.gemstoneConverter.getField(2));
            }
        }
