...
public class TileEntityGemstoneConverter extends TileEntity implements ITickable {
    ...
    public boolean isOn;
    private String gemstoneConverterCustomName;
    
    public TileEntityGemstoneConverter() 
    {
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound compound)
    {
        ...
        {
            compound.setString("CustomName", this.gemstoneConverterCustomName);
        }
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.gemstoneConverterCustomName = compound.getString("CustomName");
        }
    }
    ...
    {
        return this.hasCustomName() ? this.gemstoneConverterCustomName : "gemstone_converter";
    }
    ...
    {
        return this.gemstoneConverterCustomName != null && !this.gemstoneConverterCustomName.isEmpty();
    }
    ...
    public int getGemProc(ItemStack stack)
    {
        ...
        else
        {
            ...
            if(item == Items.TOTEM) return 300;
