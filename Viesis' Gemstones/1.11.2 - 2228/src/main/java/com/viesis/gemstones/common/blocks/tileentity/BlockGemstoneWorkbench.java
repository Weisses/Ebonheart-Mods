...
public class BlockGemstoneWorkbench extends BlockBaseVG implements ITileEntityProvider {
	
	public BlockGemstoneWorkbench(String unlocalizedName) 
	{
	...
	{
		toolTip.add(TextFormatting.GREEN + I18n.translateToLocal("vg.item.tt.workbench.1"));
		toolTip.add(TextFormatting.GREEN + I18n.translateToLocal("vg.item.tt.workbench.2"));
	}
}
