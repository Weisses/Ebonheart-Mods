...
public class InitRecipesVD {
	...
	public static void initShapedRecipe()
	{
		...
		if(ViesisDismounterConfig.universal_dismounter)
		{
			GameRegistry.addShapedRecipe(new ItemStack(InitItemsVD.item_player_dismounter, 1), new Object[]{" FF", " DF", "L  ", 'L', Items.LEATHER, 'D', InitItemsVD.item_dismounter, 'F', Items.FEATHER});
		}
		/**
