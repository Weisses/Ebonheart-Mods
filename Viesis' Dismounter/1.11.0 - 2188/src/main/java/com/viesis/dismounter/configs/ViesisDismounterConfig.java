package com.viesis.dismounter.configs;
...
public class ViesisDismounterConfig {
	
	public static Configuration config;
	public static final String CATEGORY_VC = "Viesis' Dismounter Config";
	
	public static boolean universal_dismounter;
	
	public static final boolean PLAYERDISMOUNTER_DEFAULT = true;
	public static final String PLAYERDISMOUNTER_NAME = "Enable recipe for Universal Dismounter?";
	public static final String PLAYERDISMOUNTER_COMMENT = "Can players craft the Univeral Dismounter?";
	...
	*/
	...
	public static void syncConfig()
	{
		...
		universal_dismounter = config.getBoolean(TextFormatting.WHITE + PLAYERDISMOUNTER_NAME, category1, PLAYERDISMOUNTER_DEFAULT, PLAYERDISMOUNTER_COMMENT);
