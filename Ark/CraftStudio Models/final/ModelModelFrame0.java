...
public class ModelModelFrame0 extends ModelBase
{
    ...
    public ModelModelFrame0()
    {
        this( 0.0f );
    }

    public ModelModelFrame0( float par1 )
    {
        ...
        DisplayStand = new ModelRenderer( this, 0, 23 );
        DisplayStand.setTextureSize( 256, 128 );
        DisplayStand.addBox( -0.5F, -0.5F, -0.5F, 1, 1, 1);
        DisplayStand.setRotationPoint( -5F, 2F, -13F );
        DisplayStandTop = new ModelRenderer( this, 4, 21 );
        DisplayStandTop.setTextureSize( 256, 128 );
        DisplayStandTop.addBox( -1F, -1F, -1F, 2, 2, 2);
        DisplayStandTop.setRotationPoint( -5F, 3F, -13F );
    }
