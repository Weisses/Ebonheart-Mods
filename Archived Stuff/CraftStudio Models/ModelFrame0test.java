...
public class ModelFrame0test extends ModelBase
{
    ...
    ModelRenderer Engine_Base;
    ModelRenderer Engine_Pipe;
    ModelRenderer Engine_Smoke_Stack;
    ModelRenderer Engine_Pipe1;
    ...
    public ModelFrame0test()
    {
        this( 0.0f );
    }

    public ModelFrame0test( float par1 )
    {
        ...
        Engine_Base = new ModelRenderer( this, 54, 64 );
        Engine_Base.setTextureSize( 256, 128 );
        Engine_Base.addBox( 0F, 0F, 0F, 6, 6, 6);
        Engine_Base.setRotationPoint( -3F, -0.5F, 11F );
        Engine_Pipe = new ModelRenderer( this, 0, 60 );
        Engine_Pipe.setTextureSize( 256, 128 );
        Engine_Pipe.addBox( 0F, 0F, 0F, 12, 2, 2);
        Engine_Pipe.setRotationPoint( -6F, 2F, 14F );
        Engine_Smoke_Stack = new ModelRenderer( this, 1, 16 );
        Engine_Smoke_Stack.setTextureSize( 256, 128 );
        Engine_Smoke_Stack.addBox( 0F, 0F, 0F, 2, 4, 2);
        Engine_Smoke_Stack.setRotationPoint( -1F, -4F, 14F );
        Engine_Pipe1 = new ModelRenderer( this, 54, 95 );
        Engine_Pipe1.setTextureSize( 256, 128 );
        Engine_Pipe1.addBox( -3F, 0F, 0F, 10, 1, 1);
        Engine_Pipe1.setRotationPoint( -2F, 4F, 14F );
   ...
   public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7)
   {
        ...
        Engine_Base.rotateAngleX = 0F;
        Engine_Base.rotateAngleY = 0F;
        Engine_Base.rotateAngleZ = 0F;
        Engine_Base.renderWithRotation(par7);
        ...
        Engine_Smoke_Stack.rotateAngleX = 0F;
        Engine_Smoke_Stack.rotateAngleY = 0F;
        Engine_Smoke_Stack.rotateAngleZ = 0F;
        Engine_Smoke_Stack.renderWithRotation(par7);

        Engine_Pipe1.rotateAngleX = 0.7853982F;
        Engine_Pipe1.rotateAngleY = 0F;
        Engine_Pipe1.rotateAngleZ = 0F;
        Engine_Pipe1.renderWithRotation(par7);
