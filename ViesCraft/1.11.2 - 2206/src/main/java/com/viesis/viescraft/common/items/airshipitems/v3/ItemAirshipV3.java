...
public class ItemAirshipV3 extends ItemAirshipCoreOLD {
	
	private int metaFrameItem;
	
	public ItemAirshipV3(String unlocalizedName, int frameIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV3 entityairship = new EntityItemAirshipV3(worldIn, playerIn, this.metaFrameItem, this.getMetadata(itemstack));
