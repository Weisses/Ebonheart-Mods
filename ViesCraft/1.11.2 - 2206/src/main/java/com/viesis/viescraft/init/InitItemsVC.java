...
import com.viesis.viescraft.common.items.airshipitems.v1.old.ItemAirshipV1OLD;
...
public class InitItemsVC extends ItemsVC {
	...
	public static void registerItem()
	{
		...
		//item_v1_airship_oak = registerItem(new ItemAirshipOakV1("v1/item_v1_airship_oak"));
		
		//V1
		if(ViesCraftConfig.v1AirshipEnabled)
		{
			item_airship_v1 = registerItem(new ItemAirshipV1("v1/item_v1_airship"));
		}
