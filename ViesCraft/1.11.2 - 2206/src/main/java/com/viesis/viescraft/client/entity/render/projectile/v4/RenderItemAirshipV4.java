...
public class RenderItemAirshipV4 extends Render<EntityItemAirshipV4> {
	
	private Item itemModel = InitItemsVC.item_entity_airship;
	private float scale;
    
    public RenderItemAirshipV4(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4 entity)
    {
