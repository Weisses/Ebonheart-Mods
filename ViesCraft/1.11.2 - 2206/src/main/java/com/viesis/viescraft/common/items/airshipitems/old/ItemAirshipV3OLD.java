...
public class ItemAirshipV3OLD extends ItemAirshipCoreOLD {
	
	private int metaFrameItem;
	
	public ItemAirshipV3OLD(String unlocalizedName, int frameIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV3 entityairship = new EntityItemAirshipV3(worldIn, playerIn, this.metaFrameItem, 0, 210, 180, 140);
