...
public class ItemAirshipV2 extends ItemAirshipCoreOLD {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV2 entityairship = new EntityItemAirshipV2(worldIn, playerIn, this.metaFrameItem, this.getMetadata(itemstack));
