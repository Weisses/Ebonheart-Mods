...
public class EntityItemAirshipV3 extends EntityItemAirshipCore {
    ...
    public EntityItemAirshipV3(World worldIn, EntityLivingBase entity, int frameIn, float colorRed, float colorGreen, float colorBlue)
    {
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.world.isRemote)
        {
        	...
        	this.world.spawnEntity(new EntityAirshipV3Core(this.world, this.posX, this.posY + 0.5F, this.posZ, this.metaFrameItem, this.metaColorRedItem, this.metaColorGreenItem, this.metaColorBlueItem));
