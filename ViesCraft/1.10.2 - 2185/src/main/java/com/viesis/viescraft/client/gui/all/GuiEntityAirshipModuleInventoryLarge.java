...
public class GuiEntityAirshipModuleInventoryLarge extends GuiContainer {
	...
	public GuiEntityAirshipModuleInventoryLarge(IInventory playerInv, EntityAirshipBaseVC airshipIn)
	{
