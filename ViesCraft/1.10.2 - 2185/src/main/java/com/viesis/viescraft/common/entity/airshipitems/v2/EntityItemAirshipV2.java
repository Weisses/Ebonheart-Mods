...
public class EntityItemAirshipV2 extends EntityItemAirshipCore {
    ...
    public EntityItemAirshipV2(World worldIn, EntityLivingBase entity, int frameIn, int balloonIn, int colorRed, int colorGreen, int colorBlue, int frameVisualIn, boolean frameVisualActive)
    {
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipV2Core(this.worldObj, this.posX, this.posY + 0.5F, this.posZ, this.metaFrameItem, this.metaBalloonItem, this.metaColorRedItem, this.metaColorGreenItem, this.metaColorBlueItem, this.metaFrameVisualItem, this.frameVisualActiveItem));
