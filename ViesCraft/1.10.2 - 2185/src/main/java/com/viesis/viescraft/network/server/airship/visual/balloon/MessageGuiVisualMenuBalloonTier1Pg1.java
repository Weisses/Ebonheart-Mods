...
public class MessageGuiVisualMenuBalloonTier1Pg1 extends MessageBase<MessageGuiVisualMenuBalloonTier1Pg1> {
	...
	{
		player.openGui(ViesCraft.instance, GuiHandler.GUI_APPEARANCE_MENU_BALLOON_TIER1_PG1, player.worldObj, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
