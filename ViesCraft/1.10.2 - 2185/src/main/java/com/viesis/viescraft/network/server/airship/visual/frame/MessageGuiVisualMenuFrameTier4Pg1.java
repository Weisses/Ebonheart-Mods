...
public class MessageGuiVisualMenuFrameTier4Pg1 extends MessageBase<MessageGuiVisualMenuFrameTier4Pg1> {
	...
	{
		player.openGui(ViesCraft.instance, GuiHandler.GUI_APPEARANCE_MENU_FRAME_TIER4_PG1, player.worldObj, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
