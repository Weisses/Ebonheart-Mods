...
public class ItemAirshipV1 extends ItemAirshipCore {
	...
	public ItemAirshipV1(String unlocalizedName, int frameIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV1 entityairship = new EntityItemAirshipV1(worldIn, playerIn, this.metaFrameItem, this.getMetadata(itemStackIn));
