...
public class ItemAirshipV2LapisLazuli extends ItemAirshipCore {
	
	public ItemAirshipV2LapisLazuli(String unlocalizedName) 
	{
		this.setHasSubtypes(true);
        this.setMaxDamage(0);
        
        ItemHelper.setItemName(this, "v2/lapislazuli/item_airship_v2");
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV2 entityairship = new EntityItemAirshipV2(worldIn, playerIn, EntityAirshipBaseVC.Frame.LAPISLAZULI.ordinal(), this.getMetadata(itemStackIn));
