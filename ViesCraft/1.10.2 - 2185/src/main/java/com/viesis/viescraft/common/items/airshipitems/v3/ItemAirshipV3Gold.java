...
public class ItemAirshipV3Gold extends ItemAirshipCore {
	
	public ItemAirshipV3Gold(String unlocalizedName) 
	{
		this.setHasSubtypes(true);
        this.setMaxDamage(0);
        
        ItemHelper.setItemName(this, "v3/gold/item_airship_v3");
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV3 entityairship = new EntityItemAirshipV3(worldIn, playerIn, EntityAirshipBaseVC.Frame.GOLD.ordinal(), this.getMetadata(itemStackIn));
