...
public class EntityAirshipV1Core extends EntityAirshipBaseVC {
    ...
    public EntityAirshipV1Core(World worldObjIn, double x, double y, double z, int frameIn, int balloonIn, int metaColorRedItem, int metaColorGreenItem, int metaColorBlueItem)
    {
        this(worldObjIn);
