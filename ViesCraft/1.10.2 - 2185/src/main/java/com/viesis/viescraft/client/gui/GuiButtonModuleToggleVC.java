...
public class GuiButtonModuleToggleVC extends GuiButton {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY)
	{
		if (this.visible)
        {
            ...
            this.drawTexturedModalRect(this.xPosition, this.yPosition, 0, (54 * this.buttonLocationY) + 0 + i * 20, this.width / 2, this.height);
            //Second half of the button
            this.drawTexturedModalRect(this.xPosition + this.width / 2, this.yPosition, 200 - this.width / 2, 0 + i * 20 + (54 * this.buttonLocationY), this.width / 2, this.height);
            //Test overlay
