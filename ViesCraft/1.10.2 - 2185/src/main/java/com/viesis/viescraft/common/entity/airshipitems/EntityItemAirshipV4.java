...
public class EntityItemAirshipV4 extends EntityItemAirshipCore {
    ...
    public EntityItemAirshipV4(World worldIn, EntityLivingBase entity,
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipV4Core(this.worldObj, this.posX, this.posY + 0.5F, this.posZ, 
