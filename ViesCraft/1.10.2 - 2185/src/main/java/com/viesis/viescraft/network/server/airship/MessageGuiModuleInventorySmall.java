...
public class MessageGuiModuleInventorySmall extends MessageBase<MessageGuiModuleInventorySmall> {
	...
	{
		player.openGui(ViesCraft.instance, GuiHandler.GUI_MODULE_INVENTORY_SMALL, player.worldObj, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
