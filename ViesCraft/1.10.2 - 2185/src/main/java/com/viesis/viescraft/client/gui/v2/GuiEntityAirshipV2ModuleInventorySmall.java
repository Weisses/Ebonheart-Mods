...
public class GuiEntityAirshipV2ModuleInventorySmall extends GuiContainer {
	...
	public GuiEntityAirshipV2ModuleInventorySmall(IInventory thePlayerInv, EntityAirshipV2Core airshipV2)
	{
		super(new ContainerAirshipV2ModuleInvSmall(thePlayerInv, airshipV2));
