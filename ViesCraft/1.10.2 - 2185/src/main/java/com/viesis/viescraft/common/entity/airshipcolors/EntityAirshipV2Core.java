...
public class EntityAirshipV2Core extends EntityAirshipBaseVC {
    ...
    public EntityAirshipV2Core(World worldObjIn, double x, double y, double z, int frameIn, int balloonIn, int metaColorRedItem, int metaColorGreenItem, int metaColorBlueItem)
    {
        this(worldObjIn);
