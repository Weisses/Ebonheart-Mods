...
public class EntityItemAirshipV1 extends EntityItemAirshipCore {
    ...
    public EntityItemAirshipV1(World worldIn, EntityLivingBase entity,
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipV1Core(this.worldObj, this.posX, this.posY + 0.5F, this.posZ, 
