...
public class ItemAirshipV2Obsidian extends ItemAirshipCore {
	
	public ItemAirshipV2Obsidian(String unlocalizedName) 
	{
		this.setHasSubtypes(true);
        this.setMaxDamage(0);
        
        ItemHelper.setItemName(this, "v2/obsidian/item_airship_v2");
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV2 entityairship = new EntityItemAirshipV2(worldIn, playerIn, EntityAirshipBaseVC.Frame.OBSIDIAN.ordinal(), this.getMetadata(itemStackIn));
