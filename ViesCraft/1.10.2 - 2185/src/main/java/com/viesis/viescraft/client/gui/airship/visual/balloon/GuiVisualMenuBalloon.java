...
public class GuiVisualMenuBalloon extends GuiContainer {
    ...
    protected void actionPerformed(GuiButton parButton) 
    {
		...
		if (parButton.id == 11)
	    {
			NetworkHandler.sendToServer(new MessageGuiVisualMenuBalloonTier1Pg1());
	    }
		if (parButton.id == 12)
	    {
			NetworkHandler.sendToServer(new MessageGuiVisualMenuBalloonTier2Pg1());
	    }
		if (parButton.id == 13)
	    {
			NetworkHandler.sendToServer(new MessageGuiVisualMenuBalloonTier3Pg1());
	    }
		if (parButton.id == 14)
	    {
			NetworkHandler.sendToServer(new MessageGuiVisualMenuBalloonTier4Pg1());
	    }
		if (parButton.id == 15)
	    {
			NetworkHandler.sendToServer(new MessageGuiVisualMenuBalloonTier5Pg1());
	    }
	...
	{
		GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
		this.fontRendererObj.drawString("Balloon", 73, 18, 11111111);
