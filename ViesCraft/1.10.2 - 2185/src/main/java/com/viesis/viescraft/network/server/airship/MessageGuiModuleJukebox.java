...
public class MessageGuiModuleJukebox extends MessageBase<MessageGuiModuleJukebox> {
	...
	{
		player.openGui(ViesCraft.instance, GuiHandler.GUI_MODULE_JUKEBOX, player.worldObj, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
