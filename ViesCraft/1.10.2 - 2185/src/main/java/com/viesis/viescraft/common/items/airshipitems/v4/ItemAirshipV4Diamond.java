...
public class ItemAirshipV4Diamond extends ItemAirshipCore {
	
	public ItemAirshipV4Diamond(String unlocalizedName) 
	{
		this.setHasSubtypes(true);
        this.setMaxDamage(0);
        
        ItemHelper.setItemName(this, "v4/diamond/item_airship_v4");
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV4 entityairship = new EntityItemAirshipV4(worldIn, playerIn, EntityAirshipBaseVC.Frame.DIAMOND.ordinal(), this.getMetadata(itemStackIn));
