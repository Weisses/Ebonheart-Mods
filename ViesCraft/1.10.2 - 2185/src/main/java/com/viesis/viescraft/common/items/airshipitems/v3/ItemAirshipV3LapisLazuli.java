...
public class ItemAirshipV3LapisLazuli extends ItemAirshipCore {
	
	public ItemAirshipV3LapisLazuli(String unlocalizedName) 
	{
		this.setHasSubtypes(true);
        this.setMaxDamage(0);
        
        ItemHelper.setItemName(this, "v3/lapislazuli/item_airship_v3");
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV3 entityairship = new EntityItemAirshipV3(worldIn, playerIn, EntityAirshipBaseVC.Frame.LAPISLAZULI.ordinal(), this.getMetadata(itemStackIn));
