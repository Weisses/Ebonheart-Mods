...
public class ItemAirshipV4Emerald extends ItemAirshipCore {
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV4 entityairship = new EntityItemAirshipV4(worldIn, playerIn, EntityAirshipBaseVC.Frame.EMERALD.ordinal(), this.getMetadata(itemStackIn));
    ...
    {
        return (EntityAirshipBaseVC.Frame.EMERALD.getName() + " " 
