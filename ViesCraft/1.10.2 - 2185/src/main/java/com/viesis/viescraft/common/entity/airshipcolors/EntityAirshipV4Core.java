...
public class EntityAirshipV4Core extends EntityAirshipBaseVC {
    ...
    float finalAirshipSpeedTurn = 0.18F * (ViesCraftConfig.v4AirshipSpeed / 100);
    float finalAirshipSpeedForward = (0.01F * (ViesCraftConfig.v4AirshipSpeed / 100));
    float finalAirshipSpeedUp = 0.004F * (ViesCraftConfig.v4AirshipSpeed / 100);
    float finalAirshipSpeedDown = 0.004F * (ViesCraftConfig.v4AirshipSpeed / 100);
