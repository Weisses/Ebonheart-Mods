...
public class EntityAirshipV4Core extends EntityAirshipBaseVC {
    ...
    {
    	ItemStack stack = new ItemStack(InitItemsVC.item_v4_airship, 1, this.metaTierFrame);
	...
	public String getName() 
	{
		...
		return this.hasCustomName() ? this.customName : 
			this.getNameColor() + ViesCraftConfig.v4AirshipName + " " + TextFormatting.GRAY + "(" + tier_name + TextFormatting.GRAY +")";
	}
