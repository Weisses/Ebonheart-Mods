...
public class GuiEntityAirshipV4ModuleInventoryLarge extends GuiContainer {
	...
	public GuiEntityAirshipV4ModuleInventoryLarge(IInventory thePlayerInv, EntityAirshipV4Core airshipV4)
	{
		super(new ContainerAirshipV4ModuleInvLarge(thePlayerInv, airshipV4));
