...
public class GuiVisualMenuFrameTier5Pg1 extends GuiContainer {
	
	private IInventory playerInv;
	private EntityAirshipBaseVC airship;
	public static int metaInfo;
	
	public GuiVisualMenuFrameTier5Pg1(IInventory playerInv, EntityAirshipBaseVC airshipIn)
	{
    ...
    protected void actionPerformed(GuiButton parButton) 
    {
	    ...
	    {
			this.metaInfo = 0;
			NetworkHandler.sendToServer(new MessageHelperGuiVisualMenuFrameTier5Pg1());
	    }
		if (parButton.id == 505)
	    {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
        ...
        this.drawItemStack(new ItemStack(InitItemsVC.upgrade_frame, 1, 5), 46, 8, "");
    }
