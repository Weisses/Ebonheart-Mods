...
public class OLDItemAirshipV3 extends OLDItemAirshipBase {
	
	public OLDItemAirshipV3(String unlocalizedName) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV3 entityairship = new EntityItemAirshipV3(worldIn, playerIn, this.getMetadata(itemstack), balloon, colorRed, colorGreen, colorBlue, frameVisual, frameVisualActive);
