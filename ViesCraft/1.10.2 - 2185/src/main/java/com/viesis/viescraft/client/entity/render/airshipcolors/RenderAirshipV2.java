...
public class RenderAirshipV2 extends Render<EntityAirshipV2Core> {
    ...
    public RenderAirshipV2(RenderManager renderManagerIn)
    {
    ...
    @Override
    public void doRender(EntityAirshipV2Core entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if(entity.getFrameVisualColor())
        {
	        ...
	        if(entity.getPowered() > 0)
	        {
	        	...
	        	{
	        		this.bindTexture(new ResourceLocation(References.MOD_ID, "textures/models/frames/v2/airship_visualframe_" + EnumsVC.AirshipTierFrame.byId(entity.getMetaTierFrame()).getName() +".png"));
	        	}
	        	else
	        	{
	            	this.bindTexture(new ResourceLocation(References.MOD_ID, "textures/models/frames/v2/airship_visualframe_" + EnumsVC.VisualFrame.byId(entity.getFrameVisual()).getName() +".png"));
	            }
    	...
    	if(entity.getBalloonVisualColor())
        {
	    	...
	    	this.modelAirshipV2Color.render(entity, partialTicks, 0.0F, 0F, 0.0F, 0.0F, 0.0625F);
    ...
    public void setupRotation(EntityAirshipV2Core entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2Core entity)
    {
        return null;
    }
}
