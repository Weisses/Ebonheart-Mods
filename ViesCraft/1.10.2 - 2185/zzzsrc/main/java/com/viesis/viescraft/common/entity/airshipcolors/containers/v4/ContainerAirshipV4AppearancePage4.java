...
public class ContainerAirshipV4AppearancePage4 extends ContainerVC {
	
	private EntityAirshipV4Core airship;
	private int airshipBurnTime;
    
	public ContainerAirshipV4AppearancePage4(IInventory playerInv, EntityAirshipV4Core entityAirshipV4Core) 
	{
