...
public class ContainerAirshipV2AppearancePage4 extends ContainerVC {
	
	private EntityAirshipV2Core airship;
	private int airshipBurnTime;
    
	public ContainerAirshipV2AppearancePage4(IInventory playerInv, EntityAirshipV2Core entityAirshipV2Core) 
	{
