...
public class ContainerAirshipV2AppearancePage2 extends ContainerVC {
	
	private EntityAirshipV2Core airship;
	private int airshipBurnTime;
    
	public ContainerAirshipV2AppearancePage2(IInventory playerInv, EntityAirshipV2Core entityAirshipV2Core) 
	{
