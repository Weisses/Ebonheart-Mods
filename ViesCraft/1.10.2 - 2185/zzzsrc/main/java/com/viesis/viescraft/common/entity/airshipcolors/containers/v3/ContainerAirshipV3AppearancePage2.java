...
public class ContainerAirshipV3AppearancePage2 extends ContainerVC {
	
	private EntityAirshipV3Core airship;
	private int airshipBurnTime;
    
	public ContainerAirshipV3AppearancePage2(IInventory playerInv, EntityAirshipV3Core entityAirshipV3Core) 
	{
