package com.viesis.viescraft.client.entity.render.old;
...
import com.viesis.viescraft.client.entity.model.old.ModelAirshipFurnace;
import com.viesis.viescraft.common.entity.old.EntityAirshipBase;
import com.viesis.viescraft.common.entity.old.EntityAirshipFurnace;

@SideOnly(Side.CLIENT)
public class RenderAirshipFurnace extends Render<EntityAirshipFurnace>
{
	
	public static final ResourceLocation ENTITY_TEXTURE = new ResourceLocation(Reference.MOD_ID, "textures/models/airship_furnace.png");
	...
	protected ModelBase modelTest = new ModelAirshipFurnace();
	

    public RenderAirshipFurnace(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipFurnace entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipFurnace p_188311_1_, float p_188311_2_, float p_188311_3_)
    {
        GlStateManager.rotate(180.0F - p_188311_2_, 0.0F, 1.0F, 0.0F);
        float f = 1;//(float)p_188311_1_.getTimeSinceHit() - p_188311_3_;
        float f1 = 1;//p_188311_1_.getDamageTaken() - p_188311_3_;
        ...
        if (f > 0.0F)
        {
            GlStateManager.rotate(MathHelper.sin(f) * f * f1 / 10.0F *  1
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipFurnace entity)
    {
