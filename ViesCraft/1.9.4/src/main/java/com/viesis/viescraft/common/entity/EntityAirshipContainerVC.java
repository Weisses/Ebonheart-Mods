...
public class EntityAirshipContainerVC extends EntityMinecart implements ILockableContainer, ILootContainer
{
    ...
    public EntityAirshipContainerVC(World worldIn)
    {
        super(worldIn);
    }

    public EntityAirshipContainerVC(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
