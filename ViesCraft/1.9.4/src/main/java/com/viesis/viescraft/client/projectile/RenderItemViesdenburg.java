...
public class RenderItemViesdenburg extends Render<EntityItemViesdenburg>
{
    ...
    public RenderItemViesdenburg(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemViesdenburg entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemViesdenburg entity)
    {
