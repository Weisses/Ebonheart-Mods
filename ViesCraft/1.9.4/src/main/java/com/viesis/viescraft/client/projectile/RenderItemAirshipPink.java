...
public class RenderItemAirshipPink extends Render<EntityItemAirshipPink>
{
     ...
     */
    public void doRender(EntityItemAirshipPink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipPink entity)
    {
