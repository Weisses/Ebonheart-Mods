...
public class ItemAirshipFurnace extends Item {
	
	public ItemAirshipFurnace() 
	{
		ItemHelper.setItemName(this, "item_airship_furnace");
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipFurnace entityenchantedebonheart = new EntityItemAirshipFurnace(worldIn, playerIn);
