...
public class RecipesCraftingVC
{
    /**
     * Adds the crafting recipes to the CraftingManager.
     */
    public void addRecipes(CraftingManagerVC manager)
    {
        ...
        manager.addRecipe(new ItemStack(Items.LAVA_BUCKET, 1, 0), new Object[] {"##", "##", '#', Items.MAGMA_CREAM});
