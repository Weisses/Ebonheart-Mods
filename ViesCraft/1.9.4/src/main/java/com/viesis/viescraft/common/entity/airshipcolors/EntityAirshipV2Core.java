...
public class EntityAirshipV2Core extends EntityVC implements IInventory {
	...
	//private static final DataParameter<Boolean> MODULE_FUEL_EFFICIENCY = EntityDataManager.<Boolean>createKey(EntityAirshipV2Core.class, DataSerializers.BOOLEAN);
	...
	public void fuelFlight()
    {
        ...
        if (this.isClientAirshipBurning())
        {
        	...
        	else if(EventHandlerCreativeNoFuel.creativeBurn2)
        	{
        		if(this.getEntityId() == EventHandlerCreativeNoFuel.test2)
        		{
	        		if(this.getControllingPassenger() == null)
	            	{
    ...
    /**
     * Sets the ---- boolean to pass from server to client.
     */
    ...
    /**
     * Gets the ---- boolean to pass from server to client.
     */
