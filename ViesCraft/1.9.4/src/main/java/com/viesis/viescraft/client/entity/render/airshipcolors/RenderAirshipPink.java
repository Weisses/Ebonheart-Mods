...
public class RenderAirshipPink extends Render<EntityAirshipPink>
{
     ...
     */
    public void doRender(EntityAirshipPink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipPink p_188311_1_, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipPink entity)
    {
