...
public class EntityItemAirshipLightGray extends EntityItemAirshipCore {
	
    public EntityItemAirshipLightGray(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipLightGray(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipLightGray(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipLightGray(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
