...
public class ItemAirshipCyan extends ItemAirshipCore {
	
	public ItemAirshipCyan() 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipCyan entityairship = new EntityItemAirshipCyan(worldIn, playerIn);
