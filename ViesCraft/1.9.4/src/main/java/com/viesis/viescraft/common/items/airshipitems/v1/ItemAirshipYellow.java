...
public class ItemAirshipYellow extends ItemAirshipCore {
	
	public ItemAirshipYellow() 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipYellow entityairship = new EntityItemAirshipYellow(worldIn, playerIn);
