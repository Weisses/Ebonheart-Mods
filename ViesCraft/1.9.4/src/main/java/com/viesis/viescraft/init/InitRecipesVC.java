...
public class InitRecipesVC {
	...
	public static void initShapedRecipe()
	{
    	...
    	GameRegistry.addRecipe(new ItemStack(InitItemsVC.airship_ignition, 1), new Object[]{"IBI", "D#D", "IGI", 'I', Items.IRON_INGOT, 'G', Items.GOLD_INGOT, 'D', Items.DIAMOND, 'B', Blocks.IRON_BARS, '#', Items.LAVA_BUCKET});
