...
public class ItemAirshipMagenta extends ItemAirshipCore {
	
	public ItemAirshipMagenta() 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipMagenta entityairship = new EntityItemAirshipMagenta(worldIn, playerIn);
