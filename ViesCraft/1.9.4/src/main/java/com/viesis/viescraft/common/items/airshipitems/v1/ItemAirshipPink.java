...
public class ItemAirshipPink extends ItemAirshipCore {
	
	public ItemAirshipPink() 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipPink entityairship = new EntityItemAirshipPink(worldIn, playerIn);
