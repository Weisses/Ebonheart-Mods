...
public class CraftingManagerVC
{
    ...
    private CraftingManagerVC()
    {
        ...
        (new RecipesIngotsVC()).addRecipes(this);
        (new RecipesFoodVC()).addRecipes(this);
        (new RecipesCraftingVC()).addRecipes(this);
        (new RecipesArmorVC()).addRecipes(this);
        (new RecipesDyesVC()).addRecipes(this);
        ...
        (new RecipesBannersVC()).addRecipes(this);
        (new ShieldRecipesVC()).addRecipes(this);
