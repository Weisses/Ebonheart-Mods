...
public class RenderAirshipBase extends Render<EntityAirshipBase>
{
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] {new ResourceLocation(Reference.MOD_ID, "textures/models/airship_base.png"), new ResourceLocation(Reference.MOD_ID, "textures/models/airship_base_oak.png")};//, new ResourceLocation("textures/entity/boat/boat_birch.png"), new ResourceLocation("textures/entity/boat/boat_jungle.png"), new ResourceLocation("textures/entity/boat/boat_acacia.png"), new ResourceLocation("textures/entity/boat/boat_darkoak.png")};
