...
public class EntityAirshipV2Black extends EntityAirshipCore {
	
	public EntityAirshipV2Black(World worldIn)
    {
        super(worldIn);
    ...
    public EntityAirshipV2Black(World worldIn, double x, double y, double z)
    {
        this(worldIn);
