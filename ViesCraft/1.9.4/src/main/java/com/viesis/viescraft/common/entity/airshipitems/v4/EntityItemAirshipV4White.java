...
public class EntityItemAirshipV4White extends EntityItemAirshipCore {
	
    public EntityItemAirshipV4White(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipV4White(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipV4White(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipV4White(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
