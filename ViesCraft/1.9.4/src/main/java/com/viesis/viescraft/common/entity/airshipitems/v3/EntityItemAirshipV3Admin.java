...
public class EntityItemAirshipV3Admin extends EntityItemAirshipCore {
	
    public EntityItemAirshipV3Admin(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipV3Admin(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipV3Admin(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipV3Admin(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
