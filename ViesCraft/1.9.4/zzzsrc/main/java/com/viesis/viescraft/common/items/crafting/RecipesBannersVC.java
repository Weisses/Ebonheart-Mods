...
public class RecipesBannersVC
{
     ...
     */
    void addRecipes(CraftingManagerVC manager)
    {
        ...
        manager.addRecipe(new RecipesBannersVC.RecipeDuplicatePattern());
        manager.addRecipe(new RecipesBannersVC.RecipeAddPattern());
    }
