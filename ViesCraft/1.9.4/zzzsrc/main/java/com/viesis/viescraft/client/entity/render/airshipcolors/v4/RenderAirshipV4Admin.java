...
public class RenderAirshipV4Admin extends Render<EntityAirshipV4Admin> {
	
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		new ResourceLocation(Reference.MOD_ID, "textures/models/v4/airship_v4_admin.png")//,
	};
    ...
    public RenderAirshipV4Admin(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4Admin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Admin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4Admin entity)
    {
