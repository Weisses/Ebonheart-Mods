...
public class RenderItemAirshipV1 extends Render<EntityItemAirshipV1> {
    ...
    public RenderItemAirshipV1(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV1 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV1 entity)
    {
