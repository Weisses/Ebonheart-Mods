...
public class ItemCreativeAirshipV3 extends ItemCreativeAirshipBase {
	
	public ItemCreativeAirshipV3(String unlocalizedName) 
	{
    ...
    {
		String colorName = TextFormatting.GOLD + "" + TextFormatting.BOLD +  ViesCraftConfig.v3AirshipName;
