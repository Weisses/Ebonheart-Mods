...
public class ViesCraftConfig {
	...
	public static final boolean RECIPEBOOKADDALL_DEFAULT = false;
	public static final String RECIPEBOOKADDALL_NAME = "Add mod recipes to Recipe Book?";
	public static final String RECIPEBOOKADDALL_COMMENT = "Should all mod recipes be auto learned in the Recipe Book?";
	...
	public static void syncConfig()
	{
		...
		recipeBookAddAll = config.getBoolean(TextFormatting.WHITE + RECIPEBOOKADDALL_NAME, category1, RECIPEBOOKADDALL_DEFAULT, RECIPEBOOKADDALL_COMMENT);
