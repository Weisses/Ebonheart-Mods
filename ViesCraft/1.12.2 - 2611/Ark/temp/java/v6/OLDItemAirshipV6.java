package com.viesis.viescraft.common.items.airshipitems.v6;
...
public class OLDItemAirshipV6 extends OLDItemAirshipBase {
	
	public OLDItemAirshipV6(String unlocalizedName) 
	{
		this.setHasSubtypes(true);
        this.setMaxDamage(0);
        
        ItemHelper.setItemName(this, unlocalizedName);
		//this.setCreativeTab(ViesCraft.tabViesCraftAirshipsV6);
	}
	/**
	@Override
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV6 entityairship = new EntityItemAirshipV6(worldIn, playerIn, this.getMetadata(itemstack), balloon, colorRed, colorGreen, colorBlue, frameVisual, frameVisualActive);
