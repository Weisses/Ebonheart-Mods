...
public class EntityItemBombSmall extends EntityThrowable {
    ...
    public EntityItemBombSmall(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemBombSmall(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemBombSmall(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
