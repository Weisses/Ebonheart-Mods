...
public class GuiMainMenuStorageLesser extends GuiContainerVC {
	
	private IInventory playerInv;
	private EntityAirshipBaseVC airship;
	private ResourceLocation texture = new ResourceLocation(References.MOD_ID + ":" + "textures/gui/container_gui_main_menu_storage_lesser.png");
	
	public GuiMainMenuStorageLesser(IInventory playerInv, EntityAirshipBaseVC airshipIn)
	{
		super(new ContainerMainMenuStorageLesser(playerInv, airshipIn));
