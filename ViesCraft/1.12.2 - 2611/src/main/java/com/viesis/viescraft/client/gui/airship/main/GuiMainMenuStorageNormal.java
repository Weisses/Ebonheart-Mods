...
public class GuiMainMenuStorageNormal extends GuiContainerVC {
	
	private IInventory playerInv;
	private EntityAirshipBaseVC airship;
	private ResourceLocation texture = new ResourceLocation(References.MOD_ID + ":" + "textures/gui/container_gui_main_menu_storage_normal.png");
	
	public GuiMainMenuStorageNormal(IInventory playerInv, EntityAirshipBaseVC airshipIn)
	{
		super(new ContainerMainMenuStorageNormal(playerInv, airshipIn));
