...
public class ContainerMainMenuStorageNormal extends ContainerVC {
	 ...
	 */
	public ContainerMainMenuStorageNormal(IInventory playerInv, EntityAirshipBaseVC airshipIn) 
	{
