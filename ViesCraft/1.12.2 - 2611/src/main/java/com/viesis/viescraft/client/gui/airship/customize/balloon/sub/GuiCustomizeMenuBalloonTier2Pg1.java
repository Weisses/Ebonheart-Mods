...
public class GuiCustomizeMenuBalloonTier2Pg1 extends GuiContainerVC {
	
	private IInventory playerInv;
	private EntityAirshipBaseVC airship;
	
	public GuiCustomizeMenuBalloonTier2Pg1(IInventory playerInv, EntityAirshipBaseVC airshipIn)
	{
    ...
    public void initGui() 
    {
    	...
    	GuiVC.buttonB19 = new GuiButtonGeneralVC(19, this.guiLeft + 15, this.guiTop + startPlace + (14 * 0), 76, 14, References.localNameVC("vc.enum.visualballoon.19"), 0);
		GuiVC.buttonB20 = new GuiButtonGeneralVC(20, this.guiLeft + 15, this.guiTop + startPlace + (14 * 1), 76, 14, References.localNameVC("vc.enum.visualballoon.20"), 0);
		GuiVC.buttonB21 = new GuiButtonGeneralVC(21, this.guiLeft + 15, this.guiTop + startPlace + (14 * 2), 76, 14, References.localNameVC("vc.enum.visualballoon.21"), 0);
		GuiVC.buttonB22 = new GuiButtonGeneralVC(22, this.guiLeft + 15, this.guiTop + startPlace + (14 * 3), 76, 14, References.localNameVC("vc.enum.visualballoon.22"), 0);
		GuiVC.buttonB23 = new GuiButtonGeneralVC(23, this.guiLeft + 15, this.guiTop + startPlace + (14 * 4), 76, 14, References.localNameVC("vc.enum.visualballoon.23"), 0);
		GuiVC.buttonB24 = new GuiButtonGeneralVC(24, this.guiLeft + 15, this.guiTop + startPlace + (14 * 5), 76, 14, References.localNameVC("vc.enum.visualballoon.24"), 0);
		
		GuiVC.buttonB25 = new GuiButtonGeneralVC(25, this.guiLeft + 15, this.guiTop + startPlace + (14 * 6), 76, 14, References.localNameVC("vc.enum.visualballoon.25"), 0);
		GuiVC.buttonB26 = new GuiButtonGeneralVC(26, this.guiLeft + 15, this.guiTop + startPlace + (14 * 7), 76, 14, References.localNameVC("vc.enum.visualballoon.26"), 0);
		GuiVC.buttonB27 = new GuiButtonGeneralVC(27, this.guiLeft + 15, this.guiTop + startPlace + (14 * 8), 76, 14, References.localNameVC("vc.enum.visualballoon.27"), 0);
		GuiVC.buttonB28 = new GuiButtonGeneralVC(28, this.guiLeft + 15, this.guiTop + startPlace + (14 * 9), 76, 14, References.localNameVC("vc.enum.visualballoon.28"), 0);
		GuiVC.buttonB29 = new GuiButtonGeneralVC(29, this.guiLeft + 15, this.guiTop + startPlace + (14 * 10), 76, 14, References.localNameVC("vc.enum.visualballoon.29"), 0);
		GuiVC.buttonB30 = new GuiButtonGeneralVC(30, this.guiLeft + 15, this.guiTop + startPlace + (14 * 11), 76, 14, References.localNameVC("vc.enum.visualballoon.30"), 0);
    ...
    protected void actionPerformed(GuiButton parButton) 
    {
	    ...
	    {
			this.metaInfo = 0;
			NetworkHandler.sendToServer(new MessageHelperGuiCustomizeMenuBalloonTier2Pg1());
	    }
		if (parButton.id == 505)
	    {
