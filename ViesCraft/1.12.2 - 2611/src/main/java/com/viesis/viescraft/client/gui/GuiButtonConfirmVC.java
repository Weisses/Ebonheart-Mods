...
public class GuiButtonConfirmVC extends GuiButton {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
	{
		if (this.visible)
        {
            ...
            this.drawTexturedModalRect(this.x, this.y, 0, 54 + i * 20, this.width / 2, this.height);
            //Second half of the button
            this.drawTexturedModalRect(this.x + this.width / 2, this.y, 200 - this.width / 2, 54 + i * 20, this.width / 2, this.height);
            //Test overlay
