package com.viesis.viescraft.client.gui.airship.visual;
...
public class GuiVisualMenuOLD extends GuiContainerVC {
	...
	public GuiVisualMenuOLD(IInventory playerInv, EntityAirshipBaseVC airshipIn)
	{
    ...
    protected void actionPerformed(GuiButton parButton) 
    {
		...
		this.metaFrameTransparentInfo = this.airship.getFrameSkinVisualTransparent();
		//this.metaEngineTransparentInfo = this.airship.getEngineVisualTransparent();
		this.metaBalloonTransparentInfo = this.airship.getBalloonPatternVisualTransparent();
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) 
	{
		...
		if(this.airship.getCoreModelVisualFrame() > 0)
		{
		...
		if(this.airship.getFrameSkinVisualTransparent())
		{
		...
		if(this.airship.getFrameSkinVisual() > 0)
		{
		...
		if(this.airship.getBalloonPatternVisualTransparent())
		{
		...
		if(this.airship.getBalloonPatternVisual() > 0)
		{
