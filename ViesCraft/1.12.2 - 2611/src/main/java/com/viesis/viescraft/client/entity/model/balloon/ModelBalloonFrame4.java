...
public class ModelBalloonFrame4 extends ModelBase
{
    ...
    public ModelBalloonFrame4( float par1 )
    {
        ...
        EnginePipe_L1c = new ModelRenderer( this, 68, 77 );
        EnginePipe_L1c.setTextureSize( 256, 128 );
        ...
        Anchor_1a = new ModelRenderer( this, 0, 4 );
        ...
        Rope_1c1 = new ModelRenderer( this, 84, 0 );
        Rope_1c1.setTextureSize( 256, 128 );
