...
public class GuiMainMenuBomb extends GuiContainerVC {
	
	private IInventory playerInv;
	private EntityAirshipBaseVC airship;
	private ResourceLocation texture = new ResourceLocation(References.MOD_ID + ":" + "textures/gui/container_gui_main_menu_bomb.png");
	
	public GuiMainMenuBomb(IInventory playerInv, EntityAirshipBaseVC airshipIn)
	{
		super(new ContainerMainMenuBomb(playerInv, airshipIn));
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) 
	{
		...
		{
			this.drawTexturedModalRect(this.guiLeft + 70, this.guiTop + 88, 79, 88, 18, 18);
			this.drawTexturedModalRect(this.guiLeft + 70 + (18 * 1), this.guiTop + 88, 79, 88, 18, 18);
		}
		else if(this.airship.selectedModuleBomb == 3)
		{
			this.drawTexturedModalRect(this.guiLeft + 61 + (18 * 0), this.guiTop + 88, 79, 88, 18, 18);
			this.drawTexturedModalRect(this.guiLeft + 61 + (18 * 1), this.guiTop + 88, 79, 88, 18, 18);
			this.drawTexturedModalRect(this.guiLeft + 61 + (18 * 2), this.guiTop + 88, 79, 88, 18, 18);
		}
