...
public class ContainerMainMenuStorageLesser extends ContainerVC {
	 ...
	 */
	public ContainerMainMenuStorageLesser(IInventory playerInv, EntityAirshipBaseVC airshipIn) 
	{
