...
public class GuiCustomizeMenuBalloonTier4Pg1 extends GuiContainerVC {
	
	private IInventory playerInv;
	private EntityAirshipBaseVC airship;
	
	public GuiCustomizeMenuBalloonTier4Pg1(IInventory playerInv, EntityAirshipBaseVC airshipIn)
	{
    ...
    public void initGui() 
    {
    	...
    	GuiVC.buttonB43 = new GuiButtonGeneralVC(43, this.guiLeft + 15, this.guiTop + startPlace + (14 * 0), 76, 14, References.localNameVC("vc.enum.visualballoon.43"), 0);
		GuiVC.buttonB44 = new GuiButtonGeneralVC(44, this.guiLeft + 15, this.guiTop + startPlace + (14 * 1), 76, 14, References.localNameVC("vc.enum.visualballoon.44"), 0);
		GuiVC.buttonB45 = new GuiButtonGeneralVC(45, this.guiLeft + 15, this.guiTop + startPlace + (14 * 2), 76, 14, References.localNameVC("vc.enum.visualballoon.45"), 0);
		GuiVC.buttonB46 = new GuiButtonGeneralVC(46, this.guiLeft + 15, this.guiTop + startPlace + (14 * 3), 76, 14, References.localNameVC("vc.enum.visualballoon.46"), 0);
		GuiVC.buttonB47 = new GuiButtonGeneralVC(47, this.guiLeft + 15, this.guiTop + startPlace + (14 * 4), 76, 14, References.localNameVC("vc.enum.visualballoon.47"), 0);
		GuiVC.buttonB48 = new GuiButtonGeneralVC(48, this.guiLeft + 15, this.guiTop + startPlace + (14 * 5), 76, 14, References.localNameVC("vc.enum.visualballoon.48"), 0);
		
		GuiVC.buttonB49 = new GuiButtonGeneralVC(49, this.guiLeft + 15, this.guiTop + startPlace + (14 * 6), 76, 14, References.localNameVC("vc.enum.visualballoon.49"), 0);
		GuiVC.buttonB50 = new GuiButtonGeneralVC(50, this.guiLeft + 15, this.guiTop + startPlace + (14 * 7), 76, 14, References.localNameVC("vc.enum.visualballoon.50"), 0);
		GuiVC.buttonB51 = new GuiButtonGeneralVC(51, this.guiLeft + 15, this.guiTop + startPlace + (14 * 8), 76, 14, References.localNameVC("vc.enum.visualballoon.51"), 0);
		GuiVC.buttonB52 = new GuiButtonGeneralVC(52, this.guiLeft + 15, this.guiTop + startPlace + (14 * 9), 76, 14, References.localNameVC("vc.enum.visualballoon.52"), 0);
		GuiVC.buttonB53 = new GuiButtonGeneralVC(53, this.guiLeft + 15, this.guiTop + startPlace + (14 * 10), 76, 14, References.localNameVC("vc.enum.visualballoon.53"), 0);
		GuiVC.buttonB54 = new GuiButtonGeneralVC(54, this.guiLeft + 15, this.guiTop + startPlace + (14 * 11), 76, 14, References.localNameVC("vc.enum.visualballoon.54"), 0);
    ...
    protected void actionPerformed(GuiButton parButton) 
    {
	    ...
	    {
			this.metaInfo = 0;
			NetworkHandler.sendToServer(new MessageHelperGuiCustomizeMenuBalloonTier4Pg1());
	    }
		if (parButton.id == 505)
	    {
