    ...
    public void doRender(EntityAirshipV5Core entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if(entity.getFrameVisualColor())
        {
	        ...
	        if(entity.getPowered() > 0)
	        {
	        	...
	        	{
	        		this.bindTexture(new ResourceLocation(References.MOD_ID, "textures/models/frames/v5/airship_visualframe_" + EnumsVC.AirshipTierFrame.byId(entity.getMetaTierFrame()).getName() +".png"));
	        	}
	        	else
	        	{
	            	this.bindTexture(new ResourceLocation(References.MOD_ID, "textures/models/frames/v5/airship_visualframe_" + EnumsVC.VisualFrame.byId(entity.getFrameVisual()).getName() +".png"));
	            }
