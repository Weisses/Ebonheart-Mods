...
public class GuiCustomizeMenuBalloonTier5Pg1 extends GuiContainerVC {
	
	private IInventory playerInv;
	private EntityAirshipBaseVC airship;
	
	public GuiCustomizeMenuBalloonTier5Pg1(IInventory playerInv, EntityAirshipBaseVC airshipIn)
	{
    ...
    public void initGui() 
    {
    	...
    	GuiVC.buttonB55 = new GuiButtonGeneralVC(55, this.guiLeft + 15, this.guiTop + startPlace + (14 * 0), 76, 14, References.localNameVC("vc.enum.visualballoon.55"), 0);
		GuiVC.buttonB56 = new GuiButtonGeneralVC(56, this.guiLeft + 15, this.guiTop + startPlace + (14 * 1), 76, 14, References.localNameVC("vc.enum.visualballoon.56"), 0);
		GuiVC.buttonB57 = new GuiButtonGeneralVC(57, this.guiLeft + 15, this.guiTop + startPlace + (14 * 2), 76, 14, References.localNameVC("vc.enum.visualballoon.57"), 0);
		GuiVC.buttonB58 = new GuiButtonGeneralVC(58, this.guiLeft + 15, this.guiTop + startPlace + (14 * 3), 76, 14, References.localNameVC("vc.enum.visualballoon.58"), 0);
		GuiVC.buttonB59 = new GuiButtonGeneralVC(59, this.guiLeft + 15, this.guiTop + startPlace + (14 * 4), 76, 14, References.localNameVC("vc.enum.visualballoon.59"), 0);
		GuiVC.buttonB60 = new GuiButtonGeneralVC(60, this.guiLeft + 15, this.guiTop + startPlace + (14 * 5), 76, 14, References.localNameVC("vc.enum.visualballoon.60"), 0);
		
		GuiVC.buttonB61 = new GuiButtonGeneralVC(61, this.guiLeft + 15, this.guiTop + startPlace + (14 * 6), 76, 14, References.localNameVC("vc.enum.visualballoon.61"), 0);
		GuiVC.buttonB62 = new GuiButtonGeneralVC(62, this.guiLeft + 15, this.guiTop + startPlace + (14 * 7), 76, 14, References.localNameVC("vc.enum.visualballoon.62"), 0);
		GuiVC.buttonB63 = new GuiButtonGeneralVC(63, this.guiLeft + 15, this.guiTop + startPlace + (14 * 8), 76, 14, References.localNameVC("vc.enum.visualballoon.63"), 0);
		GuiVC.buttonB64 = new GuiButtonGeneralVC(64, this.guiLeft + 15, this.guiTop + startPlace + (14 * 9), 76, 14, References.localNameVC("vc.enum.visualballoon.64"), 0);
		GuiVC.buttonB65 = new GuiButtonGeneralVC(65, this.guiLeft + 15, this.guiTop + startPlace + (14 * 10), 76, 14, References.localNameVC("vc.enum.visualballoon.65"), 0);
		GuiVC.buttonB66 = new GuiButtonGeneralVC(66, this.guiLeft + 15, this.guiTop + startPlace + (14 * 11), 76, 14, References.localNameVC("vc.enum.visualballoon.66"), 0);
    ...
    protected void actionPerformed(GuiButton parButton) 
    {
	    ...
	    {
			this.metaInfo = 0;
			NetworkHandler.sendToServer(new MessageHelperGuiCustomizeMenuBalloonTier5Pg1());
	    }
		if (parButton.id == 505)
	    {
