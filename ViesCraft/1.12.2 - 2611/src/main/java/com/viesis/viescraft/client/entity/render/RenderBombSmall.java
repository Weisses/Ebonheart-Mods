...
public class RenderBombSmall extends Render<EntityBombSmall> {
	...
	protected ModelBase modelBombSmall = new ModelBombSmall();
	
    public RenderBombSmall(RenderManager renderManagerIn)
    {
    ...
    @Override
    public void doRender(EntityBombSmall entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        this.bindTexture(new ResourceLocation(References.MOD_ID, "textures/models/bombs/bomb_small.png"));
    ...
    public void setupRotation(EntityBombSmall entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityBombSmall entity)
    {
        return null;
    }
