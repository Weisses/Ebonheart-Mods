...
public class GuiCustomizeMenuEngineDisplayBlockVC extends GuiContainerVC {
	...
	public GuiCustomizeMenuEngineDisplayBlockVC(IInventory playerInv, EntityAirshipCore airshipIn)
	{
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) 
	{
		...
		this.drawRotatingItemStack(new ItemStack(
				Item.getItemById(metaInfo)
				//ItemsVC.ITEM_DISPLAY_SYMBOL
				, 1
				//, 
				//metaInfo
				), this.guiLeft + 134, this.guiTop + 70);
	}
