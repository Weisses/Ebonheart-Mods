...
public class GuiMainMenuStorageGreater extends GuiContainerVC {
	
	private IInventory playerInv;
	private EntityAirshipBaseVC airship;
	private ResourceLocation texture = new ResourceLocation(References.MOD_ID + ":" + "textures/gui/container_gui_main_menu_storage_greater.png");
	
	public GuiMainMenuStorageGreater(IInventory playerInv, EntityAirshipBaseVC airshipIn)
	{
		super(new ContainerMainMenuStorageGreater(playerInv, airshipIn));
