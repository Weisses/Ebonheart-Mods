...
public class GuiCustomizeMenuCoreMain extends GuiContainerVC {
	...
	public GuiCustomizeMenuCoreMain(IInventory playerInv, EntityAirshipBaseVC airshipIn)
	{
	...
	{
		GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
		this.fontRenderer.drawString(References.localNameVC("vc.main.core"), 75, 16, 11111111);
		...
		GlStateManager.pushMatrix();
		{
	        ...
	        this.drawCenteredString(fontRenderer, "Models", 0, 0, 1111111);
		}
		GlStateManager.popMatrix();
    }
}
