...
public class EntityAirshipV2Core extends EntityAirshipBaseVC {
    ...
    float finalAirshipSpeedTurn = 0.18F * (ViesCraftConfig.v2AirshipSpeed / 100);
    float finalAirshipSpeedForward = (0.01F * (ViesCraftConfig.v2AirshipSpeed / 100));
    float finalAirshipSpeedUp = 0.004F * (ViesCraftConfig.v2AirshipSpeed / 100);
    float finalAirshipSpeedDown = 0.004F * (ViesCraftConfig.v2AirshipSpeed / 100);
    ...
    {
    	ItemStack stack = new ItemStack(InitItemsVC.ITEM_V2_AIRSHIP, 1, this.metaTierFrame);
	...
	public String getName() 
	{
		...
		return this.hasCustomName() ? this.customName : 
			this.getNameColor() + ViesCraftConfig.v2AirshipName + " " + TextFormatting.GRAY + "(" + tier_name + TextFormatting.GRAY +")";
	}
