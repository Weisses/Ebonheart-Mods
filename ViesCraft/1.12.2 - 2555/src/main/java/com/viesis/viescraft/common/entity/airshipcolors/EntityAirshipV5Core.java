...
public class EntityAirshipV5Core extends EntityAirshipBaseVC {
    ...
    public EntityAirshipV5Core(World worldIn, double x, double y, double z, 
    ...
    {
    	ItemStack stack = new ItemStack(InitItemsVC.ITEM_V5_AIRSHIP, 1, this.metaTierFrame);
	...
	public String getName() 
	{
		...
		return this.hasCustomName() ? this.customName : 
			this.getNameColor() + ViesCraftConfig.v5AirshipName + " " + TextFormatting.GRAY + "(" + tier_name + TextFormatting.GRAY +")";
	}
