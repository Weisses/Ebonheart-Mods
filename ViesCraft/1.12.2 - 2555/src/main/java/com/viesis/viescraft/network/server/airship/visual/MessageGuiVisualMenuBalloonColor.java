...
public class MessageGuiVisualMenuBalloonColor extends MessageBase<MessageGuiVisualMenuBalloonColor> {
	...
	{
		player.openGui(ViesCraft.instance, GuiHandler.GUI_APPEARANCE_MENU_BALLOON_COLOR, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
