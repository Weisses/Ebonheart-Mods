...
public class ItemAirshipV2 extends ItemAirshipBase {
    ...
    {
		String colorName = TextFormatting.WHITE + ViesCraftConfig.v2AirshipName;
		
		switch(stack.getMetadata())
		{
			case 0:
				return colorName = TextFormatting.GRAY + "" + TextFormatting.BOLD + ViesCraftConfig.v2AirshipName;
			case 1:
				return colorName = TextFormatting.WHITE + "" + TextFormatting.BOLD + ViesCraftConfig.v2AirshipName;
			case 2:
				return colorName = TextFormatting.YELLOW + "" + TextFormatting.BOLD + ViesCraftConfig.v2AirshipName;
			case 3:
				return colorName = TextFormatting.AQUA + "" + TextFormatting.BOLD + ViesCraftConfig.v2AirshipName;
			case 4:
				return colorName = TextFormatting.LIGHT_PURPLE + "" + TextFormatting.BOLD + ViesCraftConfig.v2AirshipName;
			case 5:
				return colorName = TextFormatting.RED + "" + TextFormatting.BOLD +  ViesCraftConfig.v2AirshipName;
		}
		return colorName;
    }
}
