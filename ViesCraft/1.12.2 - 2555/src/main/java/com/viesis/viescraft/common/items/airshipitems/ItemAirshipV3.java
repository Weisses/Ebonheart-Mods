...
public class ItemAirshipV3 extends ItemAirshipBase {
	...
	public ItemAirshipV3(String unlocalizedName) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV3 entityairship = new EntityItemAirshipV3(worldIn, playerIn, 
    ...
    {
		String colorName = TextFormatting.WHITE + ViesCraftConfig.v3AirshipName;
		
		switch(stack.getMetadata())
		{
			case 0:
				return colorName = TextFormatting.GRAY + "" + TextFormatting.BOLD + ViesCraftConfig.v3AirshipName;
			case 1:
				return colorName = TextFormatting.WHITE + "" + TextFormatting.BOLD + ViesCraftConfig.v3AirshipName;
			case 2:
				return colorName = TextFormatting.YELLOW + "" + TextFormatting.BOLD + ViesCraftConfig.v3AirshipName;
			case 3:
				return colorName = TextFormatting.AQUA + "" + TextFormatting.BOLD + ViesCraftConfig.v3AirshipName;
			case 4:
				return colorName = TextFormatting.LIGHT_PURPLE + "" + TextFormatting.BOLD + ViesCraftConfig.v3AirshipName;
			case 5:
				return colorName = TextFormatting.RED + "" + TextFormatting.BOLD +  ViesCraftConfig.v3AirshipName;
		}
		return colorName;
    }
}
