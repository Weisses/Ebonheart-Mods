...
public class MessageGuiAirshipMenuStorageLesser extends MessageBase<MessageGuiAirshipMenuStorageLesser> {
	...
	{
		player.openGui(ViesCraft.instance, GuiHandler.GUI_AIRSHIP_MENU_STORAGE_LESSER, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
