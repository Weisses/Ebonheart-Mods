package com.viesis.viescraft.client.entity.render.projectile.v6;
...
public class RenderItemAirshipV6 extends Render<EntityItemAirshipV6> {
	
	private Item itemModel = InitItemsVC.ITEM_ENTITY_AIRSHIP;
	private float scale;
    
    public RenderItemAirshipV6(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV6 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV6 entity)
    {
