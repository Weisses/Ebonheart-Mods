package com.viesis.viescraft.client.entity.render.airshipcolors.v6;
...
public class RenderAirshipV6 extends Render<EntityAirshipV6Core> {
	...
	{
		//Common
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_wood0.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_wood1.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_wood2.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_wood3.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_wood4.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_wood5.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_sandstone.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_brick.png"),
		
		//Uncommon
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_bone.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_iron.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_redstone.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_gold.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_lapislazuli.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_slime.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_mycelium.png"),
		
		//Rare
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_netherbrick.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_soulsand.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_quartz.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_ice.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_glowstone.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_obsidian.png"),
		
		//Epic
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_diamond.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_emerald.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_prismarine.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_purpur.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_netherstar.png"),
		
		//Mythic
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_mythic.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_water.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_lava.png"),
		new ResourceLocation(Reference.MOD_ID, "textures/models/v6/airship_v6_frame_ender.png")
	};
