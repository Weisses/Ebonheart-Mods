...
public class GuiItemBalloonColorizer extends GuiScreen {
	...
	public void initGui()
    {
        ...
        this.textRed = new GuiTextField(1, this.fontRenderer, this.guiLeft + 76, this.guiTop + 36, 28, 20);
        textRed.setMaxStringLength(3);
        textRed.setText(String.valueOf(this.textRedNumber));
    	this.textRed.setFocused(false);
    	
    	this.textGreen = new GuiTextField(2, this.fontRenderer, this.guiLeft + 76, this.guiTop + 80, 28, 20);
        textGreen.setMaxStringLength(3);
        textGreen.setText(String.valueOf(this.textGreenNumber));
    	this.textGreen.setFocused(false);
    	
    	this.textBlue = new GuiTextField(3, this.fontRenderer, this.guiLeft + 76, this.guiTop + 124, 28, 20);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
    	...
    	this.fontRenderer.drawString(title, this.guiLeft + 56, this.guiTop + 8, 4210752);
		
    	String stringRed = "Red";
    	this.fontRenderer.drawString(stringRed, this.guiLeft + 36, this.guiTop + 26, 16711680);
		
    	String stringGreen = "Green";
    	this.fontRenderer.drawString(stringGreen, this.guiLeft + 30, this.guiTop + 70, 32768);
		
    	String stringBlue = "Blue";
    	this.fontRenderer.drawString(stringBlue, this.guiLeft + 34, this.guiTop + 114, 255);
		
    	String max = "0-255";
    	this.fontRenderer.drawString(max, this.guiLeft + 75, this.guiTop + 26, 16777215);
    	this.fontRenderer.drawString(max, this.guiLeft + 75, this.guiTop + 70, 16777215);
    	this.fontRenderer.drawString(max, this.guiLeft + 75, this.guiTop + 114, 16777215);
