...
public class EntityAirshipV5Core extends EntityAirshipBaseVC {
	
    float finalAirshipSpeedTurn = 0.18F * (ViesCraftConfig.v5AirshipSpeed / 100);
    float finalAirshipSpeedForward = (0.01F * (ViesCraftConfig.v5AirshipSpeed / 100));
    float finalAirshipSpeedUp = 0.004F * (ViesCraftConfig.v5AirshipSpeed / 100);
    float finalAirshipSpeedDown = 0.004F * (ViesCraftConfig.v5AirshipSpeed / 100);
    
    ISound soundCacheIdle;
    ISound soundCacheMoving;
    
	public EntityAirshipV5Core(World worldIn)
    {
        super(worldIn);
    ...
    public EntityAirshipV5Core(World worldIn, double x, double y, double z, int frameIn, int balloonIn, int metaColorRedItem, int metaColorGreenItem, int metaColorBlueItem, int frameVisualIn, boolean frameVisualActive)
    {
        this(worldIn);
    ...
    {
    	ItemStack stack = new ItemStack(InitItemsVC.ITEM_AIRSHIP_V5, 1, this.metaFrameCore);
	...
	public String getName() 
	{
		...
		return this.hasCustomName() ? this.customName : 
			...
			+ " " + name + " " + ViesCraftConfig.v5AirshipName;
	}
