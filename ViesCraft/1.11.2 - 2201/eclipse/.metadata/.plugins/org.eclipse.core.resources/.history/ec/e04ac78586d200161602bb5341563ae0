...
public class ItemAirshipV2Iron extends ItemAirshipCore {
	
	public ItemAirshipV2Iron(String unlocalizedName) 
	{
		this.setHasSubtypes(true);
        this.setMaxDamage(0);
        
        ItemHelper.setItemName(this, "v2/iron/item_airship_v2");
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV2 entityairship = new EntityItemAirshipV2(worldIn, playerIn, EntityAirshipBaseVC.Frame.IRON.ordinal(), this.getMetadata(itemstack));
    ...
    {
        return (Reference.AIRSHIP_FRAME[EntityAirshipBaseVC.Frame.IRON.ordinal()] + " " 
