...
public class ItemAirshipV4 extends ItemAirshipCore {
	...
	public ItemAirshipV4(String unlocalizedName, int frameIn, int colorIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV4 entityairship = new EntityItemAirshipV4(worldIn, playerIn, this.metaFrameitem, metaColoritem);
    ...
    {
        return (Reference.AIRSHIP_FRAME[this.metaFrameitem] + " " + Reference.AIRSHIP_COLOR[this.metaColoritem] + " " + ViesCraftConfig.v4AirshipName).trim();
    }
}
