...
public class ItemAirshipV3Emerald extends ItemAirshipCore {
	
	public ItemAirshipV3Emerald(String unlocalizedName) 
	{
		this.setHasSubtypes(true);
        this.setMaxDamage(0);
        
        ItemHelper.setItemName(this, "v3/emerald/item_airship_v3");
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV3 entityairship = new EntityItemAirshipV3(worldIn, playerIn, EntityAirshipBaseVC.Frame.EMERALD.ordinal(), this.getMetadata(itemstack));
    ...
    {
        return (Reference.AIRSHIP_FRAME[EntityAirshipBaseVC.Frame.EMERALD.ordinal()] + " " 
