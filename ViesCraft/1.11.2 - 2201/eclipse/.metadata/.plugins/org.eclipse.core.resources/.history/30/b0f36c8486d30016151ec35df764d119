...
public class ItemAirshipV1 extends ItemAirshipCore {
	...
	public ItemAirshipV1(String unlocalizedName, int frameIn, int colorIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV1 entityairship = new EntityItemAirshipV1(worldIn, playerIn, this.metaFrameitem, metaColoritem);
	...
	public String getItemStackDisplayName(ItemStack stack)
    {
        return (//Reference.AIRSHIP_FRAME[this.metaFrameitem] + " " + Reference.AIRSHIP_COLOR[this.metaColoritem] + " " + 
        		"OLD " + ViesCraftConfig.v1AirshipName).trim();
    }
