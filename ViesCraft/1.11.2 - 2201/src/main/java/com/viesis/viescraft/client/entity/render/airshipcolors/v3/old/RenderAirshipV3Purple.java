...
public class RenderAirshipV3Purple extends Render<EntityAirshipV3Purple> {
    ...
    public RenderAirshipV3Purple(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3Purple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Purple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3Purple entity)
    {
