...
public class RenderItemAirshipV1Redstone extends Render<EntityItemV1Redstone> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV1Redstone(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV1Redstone entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV1Redstone entity)
    {
