...
public class RenderAirshipV2Lime extends Render<EntityAirshipV2Lime> {
    ...
    public RenderAirshipV2Lime(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV2Lime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Lime entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2Lime entity)
    {
