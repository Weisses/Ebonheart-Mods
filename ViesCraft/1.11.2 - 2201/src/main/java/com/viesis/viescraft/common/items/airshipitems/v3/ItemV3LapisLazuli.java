...
public class ItemV3LapisLazuli extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV3LapisLazuli(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV3LapisLazuli entityairship = new EntityItemV3LapisLazuli(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.LAPISLAZULI + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v3AirshipName)).trim();
    }
}
