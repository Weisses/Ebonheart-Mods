...
public class GuiTileEntityAirshipDisassembler extends GuiContainer {
	
	private InventoryPlayer playerInventory;
	private TileEntityAirshipDisassembler airship;
	private final World worldObj;
    
	public GuiTileEntityAirshipDisassembler(InventoryPlayer playerInventory, World worldIn, TileEntityAirshipDisassembler airship)
	{
		super(new ContainerAirshipDisassembler(playerInventory, worldIn, airship));
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) 
	{
		...
		this.mc.getTextureManager().bindTexture(new ResourceLocation(Reference.MOD_ID + ":" + "textures/gui/container_airship_disassembler.png"));
