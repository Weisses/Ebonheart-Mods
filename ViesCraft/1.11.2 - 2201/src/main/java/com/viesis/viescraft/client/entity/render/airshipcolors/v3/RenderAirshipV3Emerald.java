...
public class RenderAirshipV3Emerald extends Render<EntityV3Emerald> {
    ...
    public RenderAirshipV3Emerald(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV3Emerald entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV3Emerald entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV3Emerald entity)
    {
