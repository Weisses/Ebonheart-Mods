...
public class ItemV2Redstone extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV2Redstone(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV2Redstone entityairship = new EntityItemV2Redstone(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.REDSTONE + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v2AirshipName)).trim();
    }
}
