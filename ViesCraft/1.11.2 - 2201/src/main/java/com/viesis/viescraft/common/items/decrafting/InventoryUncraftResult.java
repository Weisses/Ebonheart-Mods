...
{
    private final NonNullList<ItemStack> stackResult = NonNullList.<ItemStack>func_191197_a(9, ItemStack.field_190927_a);
    ...
    {
        return (ItemStack)this.stackResult.get(index);
    }
