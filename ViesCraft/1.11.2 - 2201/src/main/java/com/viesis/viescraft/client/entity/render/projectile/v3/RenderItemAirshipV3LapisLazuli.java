...
public class RenderItemAirshipV3LapisLazuli extends Render<EntityItemV3LapisLazuli> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3LapisLazuli(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV3LapisLazuli entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV3LapisLazuli entity)
    {
