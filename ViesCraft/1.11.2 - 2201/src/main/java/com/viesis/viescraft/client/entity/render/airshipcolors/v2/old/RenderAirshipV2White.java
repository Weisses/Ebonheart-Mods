...
public class RenderAirshipV2White extends Render<EntityAirshipV2White> {
    ...
    public RenderAirshipV2White(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV2White entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2White entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2White entity)
    {
