...
public class ItemV4Redstone extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV4Redstone(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV4Redstone entityairship = new EntityItemV4Redstone(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.REDSTONE + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v4AirshipName)).trim();
    }
}
