...
public class EntityV1Redstone extends EntityAirshipV1Core {
	
	public EntityV1Redstone(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV1Redstone(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.REDSTONE + this.getBoatType().getName() + " " + ViesCraftConfig.v1AirshipName;
	}
