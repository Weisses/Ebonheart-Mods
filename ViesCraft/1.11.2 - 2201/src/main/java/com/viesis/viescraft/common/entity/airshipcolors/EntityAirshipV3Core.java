...
public class EntityAirshipV3Core extends EntityAirshipBaseVC {
	...
	/** Fuel */
	protected static final DataParameter<Integer> POWERED = EntityDataManager.<Integer>createKey(EntityAirshipV3Core.class, DataSerializers.VARINT);
	protected static final DataParameter<Integer> TOTALPOWERED = EntityDataManager.<Integer>createKey(EntityAirshipV3Core.class, DataSerializers.VARINT);
	protected static final DataParameter<Integer> ITEMFUELSTACKPOWERED = EntityDataManager.<Integer>createKey(EntityAirshipV3Core.class, DataSerializers.VARINT);
	protected static final DataParameter<Integer> ITEMFUELSTACKSIZEPOWERED = EntityDataManager.<Integer>createKey(EntityAirshipV3Core.class, DataSerializers.VARINT);
    
    /** Passive Modules */
	protected static final DataParameter<Boolean> MODULE_INVENTORY_SMALL = EntityDataManager.<Boolean>createKey(EntityAirshipV3Core.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> MODULE_INVENTORY_LARGE = EntityDataManager.<Boolean>createKey(EntityAirshipV3Core.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> MODULE_FUEL_INFINITE = EntityDataManager.<Boolean>createKey(EntityAirshipV3Core.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> MODULE_SPEED_MINOR = EntityDataManager.<Boolean>createKey(EntityAirshipV3Core.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> MODULE_SPEED_MAJOR = EntityDataManager.<Boolean>createKey(EntityAirshipV3Core.class, DataSerializers.BOOLEAN);
    ...
    public EntityAirshipV3Core(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	public void fuelFlight()
    {
        ...
        if (this.isClientAirshipBurning())
        {
        	...
        	else if(EventHandlerAirship.creativeBurnV3)
        	{
        		if(this.getEntityId() == EventHandlerAirship.playerRidingEntityV3)
        		{
	        		if(this.getControllingPassenger() == null)
	            	{
