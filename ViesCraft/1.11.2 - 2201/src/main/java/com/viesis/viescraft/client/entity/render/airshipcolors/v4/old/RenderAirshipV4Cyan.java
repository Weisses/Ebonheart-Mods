...
public class RenderAirshipV4Cyan extends Render<EntityAirshipV4Cyan> {
    ...
    public RenderAirshipV4Cyan(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4Cyan entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Cyan entity, float p_188311_2_, float p_188311_3_)
    {
