...
public class EntityItemV1Wood0 extends EntityItemAirshipCore {
	
	private int type;
	
    public EntityItemV1Wood0(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemV1Wood0(World worldIn, EntityLivingBase entity, int typeIn)
    {
        super(worldIn, entity);
        this.type = typeIn;
    }
    
    public EntityItemV1Wood0(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
