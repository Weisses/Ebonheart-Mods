...
public class RenderAirshipV2Yellow extends Render<EntityAirshipV2Yellow> {
    ...
    public RenderAirshipV2Yellow(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV2Yellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Yellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2Yellow entity)
    {
