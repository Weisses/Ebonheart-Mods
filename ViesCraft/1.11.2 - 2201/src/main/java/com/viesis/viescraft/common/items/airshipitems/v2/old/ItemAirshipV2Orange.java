...
public class ItemAirshipV2Orange extends ItemAirshipCore {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV2Orange entityairship = new EntityItemAirshipV2Orange(worldIn, playerIn);
    ...
    {
        return ("" + I18n.translateToLocal("Orange " + ViesCraftConfig.v2AirshipName)).trim();
    }
}
