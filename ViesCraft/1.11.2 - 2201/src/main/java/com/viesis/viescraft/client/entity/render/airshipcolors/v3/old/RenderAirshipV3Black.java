...
public class RenderAirshipV3Black extends Render<EntityAirshipV3Black> {
    ...
    public RenderAirshipV3Black(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3Black entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Black entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3Black entity)
    {
