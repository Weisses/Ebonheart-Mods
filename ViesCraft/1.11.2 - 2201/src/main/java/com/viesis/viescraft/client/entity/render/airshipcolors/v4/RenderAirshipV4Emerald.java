...
public class RenderAirshipV4Emerald extends Render<EntityV4Emerald> {
    ...
    public RenderAirshipV4Emerald(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV4Emerald entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV4Emerald entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV4Emerald entity)
    {
