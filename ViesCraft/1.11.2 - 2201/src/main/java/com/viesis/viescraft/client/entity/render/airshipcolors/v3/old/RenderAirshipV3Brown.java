...
public class RenderAirshipV3Brown extends Render<EntityAirshipV3Brown> {
    ...
    public RenderAirshipV3Brown(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3Brown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Brown entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3Brown entity)
    {
