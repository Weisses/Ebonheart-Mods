...
public class EntityV4LapisLazuli extends EntityAirshipV4Core {
	
	public EntityV4LapisLazuli(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV4LapisLazuli(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
    ...
    {
		return ITEM_LAPISLAZULI[this.metaColor];
    }
	...
	{
		return this.hasCustomName() ? this.customName : Reference.LAPISLAZULI + this.getBoatType().getName() + " " + ViesCraftConfig.v4AirshipName;
	}
