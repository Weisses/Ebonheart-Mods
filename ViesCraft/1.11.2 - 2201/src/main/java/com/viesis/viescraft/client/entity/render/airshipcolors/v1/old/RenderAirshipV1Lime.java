...
public class RenderAirshipV1Lime extends Render<EntityAirshipV1Lime> {
    ...
    public RenderAirshipV1Lime(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV1Lime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1Lime entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV1Lime entity)
    {
