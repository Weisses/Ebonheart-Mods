package com.viesis.viescraft.client.entity.render.airshipcolors.v1.old;
...
public class RenderAirshipV1LightGray extends Render<EntityAirshipV1LightGray> {
    ...
    public RenderAirshipV1LightGray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV1LightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1LightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV1LightGray entity)
    {
