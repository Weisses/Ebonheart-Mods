...
public class ItemV4LapisLazuli extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV4LapisLazuli(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV4LapisLazuli entityairship = new EntityItemV4LapisLazuli(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.LAPISLAZULI + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v4AirshipName)).trim();
    }
}
