...
public class ItemV3Emerald extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV3Emerald(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV3Emerald entityairship = new EntityItemV3Emerald(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.EMERALD + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v3AirshipName)).trim();
    }
}
