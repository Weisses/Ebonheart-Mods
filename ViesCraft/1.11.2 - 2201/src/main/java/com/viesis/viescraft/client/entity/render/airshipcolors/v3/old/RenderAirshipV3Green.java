...
public class RenderAirshipV3Green extends Render<EntityAirshipV3Green> {
    ...
    public RenderAirshipV3Green(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3Green entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Green entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3Green entity)
    {
