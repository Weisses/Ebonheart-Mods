...
public class RenderAirshipV4Gold extends Render<EntityV4Gold> {
    ...
    public RenderAirshipV4Gold(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV4Gold entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV4Gold entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV4Gold entity)
    {
