...
public class RenderItemAirshipV3Diamond extends Render<EntityItemV3Diamond> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3Diamond(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV3Diamond entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV3Diamond entity)
    {
