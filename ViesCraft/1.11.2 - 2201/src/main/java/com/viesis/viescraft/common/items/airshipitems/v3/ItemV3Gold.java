...
public class ItemV3Gold extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV3Gold(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV3Gold entityairship = new EntityItemV3Gold(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.GOLD + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v3AirshipName)).trim();
    }
}
