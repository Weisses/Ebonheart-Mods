...
public class RenderAirshipV4Orange extends Render<EntityAirshipV4Orange> {
    ...
    public RenderAirshipV4Orange(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4Orange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Orange entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4Orange entity)
    {
