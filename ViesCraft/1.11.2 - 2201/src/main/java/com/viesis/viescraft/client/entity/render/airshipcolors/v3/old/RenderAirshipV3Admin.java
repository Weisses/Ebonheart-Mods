...
public class RenderAirshipV3Admin extends Render<EntityAirshipV3Admin> {
	
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		new ResourceLocation(Reference.MOD_ID, "textures/models/v3/airship_v3_admin.png")//,
	};
    ...
    public RenderAirshipV3Admin(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3Admin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Admin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3Admin entity)
    {
