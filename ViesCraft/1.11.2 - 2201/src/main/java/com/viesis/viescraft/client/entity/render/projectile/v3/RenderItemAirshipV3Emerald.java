...
public class RenderItemAirshipV3Emerald extends Render<EntityItemV3Emerald> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3Emerald(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV3Emerald entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV3Emerald entity)
    {
