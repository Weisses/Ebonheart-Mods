...
public class RenderAirshipV2Pink extends Render<EntityAirshipV2Pink> {
    ...
    public RenderAirshipV2Pink(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV2Pink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Pink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2Pink entity)
    {
