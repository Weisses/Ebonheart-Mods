...
public class RenderAirshipV2Obsidian extends Render<EntityV2Obsidian> {
    ...
    public RenderAirshipV2Obsidian(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV2Obsidian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV2Obsidian entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV2Obsidian entity)
    {
