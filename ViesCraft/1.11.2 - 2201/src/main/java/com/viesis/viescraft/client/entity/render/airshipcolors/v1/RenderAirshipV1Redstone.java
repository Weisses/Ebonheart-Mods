...
public class RenderAirshipV1Redstone extends Render<EntityV1Redstone> {
    ...
    public RenderAirshipV1Redstone(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV1Redstone entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV1Redstone entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV1Redstone entity)
    {
