...
public class RenderAirshipV1LapisLazuli extends Render<EntityV1LapisLazuli> {
    ...
    public RenderAirshipV1LapisLazuli(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV1LapisLazuli entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV1LapisLazuli entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV1LapisLazuli entity)
    {
