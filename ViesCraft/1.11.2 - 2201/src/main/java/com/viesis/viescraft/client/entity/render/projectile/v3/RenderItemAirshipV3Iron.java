...
public class RenderItemAirshipV3Iron extends Render<EntityItemV3Iron> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3Iron(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV3Iron entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV3Iron entity)
    {
