...
public class RenderItemAirshipV4Iron extends Render<EntityItemV4Iron> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4Iron(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV4Iron entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV4Iron entity)
    {
