...
public class MessageGuiAppearancePage1 extends MessageBase<MessageGuiAppearancePage1> {
	...
	{
		player.openGui(ViesCraft.instance, GuiHandler.GUI_APPEARANCE_PAGE1, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
