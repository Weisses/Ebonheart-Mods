...
public class EntityAirshipBaseVC extends Entity {
    ...
    protected int size = 25;// Fuel=0 Module=1 Inventory=2-19 Gem=20
    ...
    public static enum FrameCore
    {
        ...
        WOOD5(5, "darkoak", I18n.translateToLocal("vc.item.enum.frame.5"), 0F, 75),
        ...
        LAPISLAZULI(12, "lapislazuli", I18n.translateToLocal("vc.item.enum.frame.12"), 0.007F, 140),
        ...
        //Rare - 6 items
        NETHERBRICK(15, "netherbrick", I18n.translateToLocal("vc.item.enum.frame.15"), 0.010F, 170),
        SOULSAND(16, "soulsand", I18n.translateToLocal("vc.item.enum.frame.16"), 0.011F, 180),
    	...
    	NETHERSTAR(25, "netherstar", I18n.translateToLocal("vc.item.enum.frame.25"), 0.020F, 500),
    ...
    {
        PLAIN(0, "normalplain", I18n.translateToLocal("vc.item.enum.balloon.0")),
        ...
        CHECKER(3, "normalchecker", I18n.translateToLocal("vc.item.enum.balloon.3")),
        ...
        POLKADOT(6, "normalpolkadot", I18n.translateToLocal("vc.item.enum.balloon.6")),
        ...
        ZIGZAG(9, "normalzigzag", I18n.translateToLocal("vc.item.enum.balloon.9")),
    	...
    	CREEPER(12, "normalcreeper", I18n.translateToLocal("vc.item.enum.balloon.12")),
    	...
    	WATER(15, "normalwater", I18n.translateToLocal("vc.item.enum.balloon.15")),
    	...
    	LAVA(18, "normallava", I18n.translateToLocal("vc.item.enum.balloon.18")),
    	...
    	ENDER(21, "normalender", I18n.translateToLocal("vc.item.enum.balloon.21")),
    	...
    	TOOLS(24, "normaltools", I18n.translateToLocal("vc.item.enum.balloon.24")),
    ...
    public static enum Module
    {
        ...
        MINORSPEED(1, "minorspeed", I18n.translateToLocal("vc.item.enum.module.1")),
        MAJORSPEED(2, "majorspeed", I18n.translateToLocal("vc.item.enum.module.2")),
        SMALLINVENTORY(3, "smallinventory", I18n.translateToLocal("vc.item.enum.module.3")),
        LARGEINVENTORY(4, "largeinventory", I18n.translateToLocal("vc.item.enum.module.4")),
        INFINITEFUEL(5, "infinitefuel", I18n.translateToLocal("vc.item.enum.module.5")),
    	WATERLANDING(6, "waterlanding", I18n.translateToLocal("vc.item.enum.module.6")),
    	MAXALTITUDE(7, "maxaltitude", I18n.translateToLocal("vc.item.enum.module.7")),
    	MINOREFFICIENCY(8, "minorefficiency", I18n.translateToLocal("vc.item.enum.module.8")),
    	MAJOREFFICIENCY(9, "majorefficiency", I18n.translateToLocal("vc.item.enum.module.9")),
    	JUKEBOX(10, "jukebox", I18n.translateToLocal("vc.item.enum.module.10")),
    	CRUISECONTROL(11, "cruisecontrol", I18n.translateToLocal("vc.item.enum.module.11"));
