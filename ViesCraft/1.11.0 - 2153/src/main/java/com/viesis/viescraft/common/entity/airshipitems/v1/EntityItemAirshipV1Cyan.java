...
public class EntityItemAirshipV1Cyan extends EntityItemAirshipCore {
	
    public EntityItemAirshipV1Cyan(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipV1Cyan(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipV1Cyan(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipV1Cyan(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
