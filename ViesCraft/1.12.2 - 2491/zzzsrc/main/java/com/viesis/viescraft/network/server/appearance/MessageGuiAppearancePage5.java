...
public class MessageGuiAppearancePage5 extends MessageBase<MessageGuiAppearancePage5> {
	...
	{
		player.openGui(ViesCraft.instance, GuiHandler.GUI_APPEARANCE_PAGE5, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
