...
public class MessageGuiAppearancePage4 extends MessageBase<MessageGuiAppearancePage4> {
	...
	{
		player.openGui(ViesCraft.instance, GuiHandler.GUI_APPEARANCE_PAGE4, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
