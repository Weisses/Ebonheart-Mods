...
public class GuiButtonModuleVC extends GuiButton {
	
	protected static final ResourceLocation BUTTON_TEXTURES = new ResourceLocation(References.MOD_ID_COLON + "textures/gui/widgets_module.png");
    
	public GuiButtonModuleVC(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) 
	{
