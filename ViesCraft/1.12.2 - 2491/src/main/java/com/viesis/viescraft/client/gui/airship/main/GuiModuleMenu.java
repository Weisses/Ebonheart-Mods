...
public class GuiModuleMenu extends GuiContainer {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) 
	{
		...
		if(this.airship.getModuleVariantSlot1() > 0)
		{
			...
			GlStateManager.pushMatrix();
			{
				...
				this.drawCenteredString(fontRendererObj, I18n.format(TextFormatting.LIGHT_PURPLE + "" + TextFormatting.UNDERLINE + "" + TextFormatting.BOLD + nameIn, new Object[0]), 0, 0, 0);
			}
			...
			GlStateManager.pushMatrix();
			{
				...
				this.drawCenteredString(fontRendererObj, TextFormatting.GREEN + I18n.format("vc.item.tt.moduletype.#." + this.airship.getModuleVariantSlot1() + ".pros1", new Object[0]), 0, 0, 0);
			}
			GlStateManager.popMatrix();
			//Pros2
			GlStateManager.pushMatrix();
			{
				...
				this.drawCenteredString(fontRendererObj, TextFormatting.GREEN + I18n.format("vc.item.tt.moduletype.#." + this.airship.getModuleVariantSlot1() + ".pros2", new Object[0]), 0, 0, 0);
			}
			GlStateManager.popMatrix();
			...
			GlStateManager.pushMatrix();
			{
				...
				this.drawCenteredString(fontRendererObj, TextFormatting.RED + I18n.format("vc.item.tt.moduletype.#." + this.airship.getModuleVariantSlot1() + ".cons1", new Object[0]), 0, 0, 0);
			}
			GlStateManager.popMatrix();
			//Cons2
			GlStateManager.pushMatrix();
			{
				...
				this.drawCenteredString(fontRendererObj, TextFormatting.RED + I18n.format("vc.item.tt.moduletype.#." + this.airship.getModuleVariantSlot1() + ".cons2", new Object[0]), 0, 0, 0);
			}
			GlStateManager.popMatrix();
		}
	...
	{
		this.fontRendererObj.drawString("Module Menu", 58, -10, 65535);
