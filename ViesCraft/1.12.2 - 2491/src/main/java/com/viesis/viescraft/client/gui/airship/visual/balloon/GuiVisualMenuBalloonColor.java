...
public class GuiVisualMenuBalloonColor extends GuiContainer {
	...
	public GuiVisualMenuBalloonColor(IInventory playerInv, EntityAirshipBaseVC airshipIn)
	{
    ...
    public void initGui() 
    {
        ...
        this.textRed = new GuiTextField(11, this.fontRendererObj, this.guiLeft + 63, this.guiTop + 66, 28, 20);
        textRed.setMaxStringLength(3);
        textRed.setText(String.valueOf(this.textRedNumber));
    	this.textRed.setFocused(false);
    	
    	this.textGreen = new GuiTextField(12, this.fontRendererObj, this.guiLeft + 63, this.guiTop + 110, 28, 20);
        textGreen.setMaxStringLength(3);
        textGreen.setText(String.valueOf(this.textGreenNumber));
    	this.textGreen.setFocused(false);
    	
    	this.textBlue = new GuiTextField(13, this.fontRendererObj, this.guiLeft + 63, this.guiTop + 154, 28, 20);
    ...
    protected void actionPerformed(GuiButton parButton) 
    {
		...
		if (parButton.id == 11)
	    {
			...
			this.isColored = true;
			NetworkHandler.sendToServer(new MessageHelperGuiVisualMenuBalloonColor());
	    }
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) 
	{
        ...
        //Color name of the Color Box made from the r/g/b values
  		GlStateManager.pushMatrix();
  		{
  			...
  			{
  				this.fontRendererObj.drawString("- " + ColorHelperVC.getColorNameFromRgb(this.textRedNumber, this.textGreenNumber, this.textBlueNumber), 0, 0, 16777215);
  			}
  			else
  			{
  				this.fontRendererObj.drawString("- None", 0, 0, 16777215);
  			}
		}
		GlStateManager.popMatrix();
        
    	this.fontRendererObj.drawString("Red", this.guiLeft + 23, this.guiTop + 55, 16711680);
		this.fontRendererObj.drawString("Green", this.guiLeft + 17, this.guiTop + 99, 32768);
		this.fontRendererObj.drawString("Blue", this.guiLeft + 21, this.guiTop + 143, 255);
		
    	this.fontRendererObj.drawString("0-255", this.guiLeft + 62, this.guiTop + 55, 16777215);
    	this.fontRendererObj.drawString("0-255", this.guiLeft + 62, this.guiTop + 99, 16777215);
    	this.fontRendererObj.drawString("0-255", this.guiLeft + 62, this.guiTop + 143, 16777215);
	...
	{
		GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
		this.fontRendererObj.drawString("Balloon Color", 55, 18, 11111111);
