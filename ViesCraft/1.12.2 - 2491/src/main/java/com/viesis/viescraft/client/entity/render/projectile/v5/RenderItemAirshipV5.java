package com.viesis.viescraft.client.entity.render.projectile.v5;
...
public class RenderItemAirshipV5 extends Render<EntityItemAirshipV5> {
	
	private Item itemModel = InitItemsVC.ITEM_ENTITY_AIRSHIP;
	private float scale;
    
    public RenderItemAirshipV5(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV5 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV5 entity)
    {
