...
public class EntityItemAirshipV6 extends EntityItemAirshipCore {
    ...
    public EntityItemAirshipV6(World worldIn, EntityLivingBase entity,
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipV6Core(this.worldObj, this.posX, this.posY + 0.5F, this.posZ, 
