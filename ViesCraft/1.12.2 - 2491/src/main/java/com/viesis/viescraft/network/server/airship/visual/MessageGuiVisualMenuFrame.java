...
public class MessageGuiVisualMenuFrame extends MessageBase<MessageGuiVisualMenuFrame> {
	...
	{
		player.openGui(ViesCraft.instance, GuiHandler.GUI_APPEARANCE_MENU_FRAME, player.worldObj, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
