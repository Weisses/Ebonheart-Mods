...
public class MessageGuiVisualMenuBalloon extends MessageBase<MessageGuiVisualMenuBalloon> {
	...
	{
		player.openGui(ViesCraft.instance, GuiHandler.GUI_APPEARANCE_MENU_BALLOON, player.worldObj, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
