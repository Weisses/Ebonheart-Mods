...
public class EntityAirshipV3Core extends EntityAirshipBaseVC {
	...
	protected static final DataParameter<Boolean> MODULE_WATER_LANDING = EntityDataManager.<Boolean>createKey(EntityAirshipV3Core.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> MODULE_MAX_ALTITUDE = EntityDataManager.<Boolean>createKey(EntityAirshipV3Core.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> MODULE_MINOR_EFFICIENCY = EntityDataManager.<Boolean>createKey(EntityAirshipV3Core.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> MODULE_MAJOR_EFFICIENCY = EntityDataManager.<Boolean>createKey(EntityAirshipV3Core.class, DataSerializers.BOOLEAN);
    ...
    public EntityAirshipV3Core(World worldIn, double x, double y, double z, int frameIn, int balloonIn, int metaColorRedItem, int metaColorGreenItem, int metaColorBlueItem, int frameVisualIn, boolean frameVisualActive)
    {
        this(worldIn);
    ...
    {
    	ItemStack stack = new ItemStack(InitItemsVC.item_airship_v3, 1, this.metaFrameCore);
	...
	public String getName() 
	{
		...
		return this.hasCustomName() ? this.customName : 
			...
			+ " " + name + " " + ViesCraftConfig.v3AirshipName;
	}
