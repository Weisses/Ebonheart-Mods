...
public class ContainerAirshipV2AppearancePage1 extends ContainerVC {
	
	private EntityAirshipV2Core airship;
	private int airshipBurnTime;
    
	public ContainerAirshipV2AppearancePage1(IInventory playerInv, EntityAirshipV2Core entityAirshipV2Core) 
	{
