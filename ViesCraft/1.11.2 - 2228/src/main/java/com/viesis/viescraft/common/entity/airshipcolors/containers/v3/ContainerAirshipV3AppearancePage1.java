...
public class ContainerAirshipV3AppearancePage1 extends ContainerVC {
	
	private EntityAirshipV3Core airship;
	private int airshipBurnTime;
    
	public ContainerAirshipV3AppearancePage1(IInventory playerInv, EntityAirshipV3Core entityAirshipV3Core) 
	{
