...
public class EntityItemAirshipV3 extends EntityItemAirshipCore {
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.world.isRemote)
        {
        	...
        	this.world.spawnEntity(new EntityAirshipV3Core(this.world, this.posX, this.posY + 0.5F, this.posZ, this.metaFrameItem, this.metaBalloonItem, this.metaColorRedItem, this.metaColorGreenItem, this.metaColorBlueItem, this.metaFrameVisualItem, this.frameVisualActiveItem));
