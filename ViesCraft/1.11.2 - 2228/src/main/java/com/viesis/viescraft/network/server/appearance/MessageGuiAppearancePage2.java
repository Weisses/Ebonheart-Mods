...
public class MessageGuiAppearancePage2 extends MessageBase<MessageGuiAppearancePage2> {
	...
	{
		player.openGui(ViesCraft.instance, GuiHandler.GUI_APPEARANCE_PAGE2, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
