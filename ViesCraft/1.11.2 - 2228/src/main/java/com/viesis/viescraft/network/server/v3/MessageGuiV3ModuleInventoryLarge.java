...
public class MessageGuiV3ModuleInventoryLarge extends MessageBase<MessageGuiV3ModuleInventoryLarge> {
	...
	{
		player.openGui(ViesCraft.instance, GuiHandler.GUI_V3_MODULE_INVENTORY_LARGE, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
