...
public class ContainerAirshipV3AppearancePage3 extends ContainerVC {
	
	private EntityAirshipV3Core airship;
	private int airshipBurnTime;
    
	public ContainerAirshipV3AppearancePage3(IInventory playerInv, EntityAirshipV3Core entityAirshipV3Core) 
	{
