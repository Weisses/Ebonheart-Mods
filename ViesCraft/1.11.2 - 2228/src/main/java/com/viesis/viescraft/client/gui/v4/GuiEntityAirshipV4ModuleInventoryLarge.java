...
public class GuiEntityAirshipV4ModuleInventoryLarge extends GuiContainer {
	...
	public GuiEntityAirshipV4ModuleInventoryLarge(IInventory playerInv, EntityAirshipV4Core airshipV4)
	{
		super(new ContainerAirshipV4ModuleInvLarge(playerInv, airshipV4));
