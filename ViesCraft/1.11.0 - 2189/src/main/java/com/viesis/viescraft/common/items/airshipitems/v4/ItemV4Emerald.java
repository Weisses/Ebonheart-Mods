...
public class ItemV4Emerald extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV4Emerald(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV4Emerald entityairship = new EntityItemV4Emerald(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.EMERALD + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v4AirshipName)).trim();
    }
}
