...
public class EntityV3Diamond extends EntityAirshipV3Core {
	
	public EntityV3Diamond(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV3Diamond(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.DIAMOND + this.getBoatType().getName() + " " + ViesCraftConfig.v3AirshipName;
	}
