...
public class RenderAirshipV1EmeraldWhite extends Render<EntityAirshipV1EmeraldWhite> {
    ...
    public RenderAirshipV1EmeraldWhite(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1EmeraldWhite entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1EmeraldWhite entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1EmeraldWhite entity)
    {
