...
public class RenderAirshipV3Gray extends Render<EntityAirshipV3Gray> {
    ...
    public RenderAirshipV3Gray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3Gray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Gray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3Gray entity)
    {
