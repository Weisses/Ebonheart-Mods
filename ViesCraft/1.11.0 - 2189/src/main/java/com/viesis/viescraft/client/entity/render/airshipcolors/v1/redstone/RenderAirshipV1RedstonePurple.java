...
public class RenderAirshipV1RedstonePurple extends Render<EntityAirshipV1RedstonePurple> {
    ...
    public RenderAirshipV1RedstonePurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1RedstonePurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1RedstonePurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1RedstonePurple entity)
    {
