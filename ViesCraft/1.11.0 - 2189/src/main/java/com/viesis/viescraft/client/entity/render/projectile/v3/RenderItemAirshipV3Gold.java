...
public class RenderItemAirshipV3Gold extends Render<EntityItemV3Gold> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3Gold(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV3Gold entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV3Gold entity)
    {
