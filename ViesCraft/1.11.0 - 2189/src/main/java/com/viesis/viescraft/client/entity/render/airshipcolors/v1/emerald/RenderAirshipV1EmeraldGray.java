...
public class RenderAirshipV1EmeraldGray extends Render<EntityAirshipV1EmeraldGray> {
    ...
    public RenderAirshipV1EmeraldGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1EmeraldGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1EmeraldGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1EmeraldGray entity)
    {
