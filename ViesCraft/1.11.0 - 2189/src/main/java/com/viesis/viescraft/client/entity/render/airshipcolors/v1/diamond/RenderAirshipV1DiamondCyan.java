...
public class RenderAirshipV1DiamondCyan extends Render<EntityAirshipV1DiamondCyan> {
    ...
    public RenderAirshipV1DiamondCyan(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1DiamondCyan entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1DiamondCyan entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1DiamondCyan entity)
    {
