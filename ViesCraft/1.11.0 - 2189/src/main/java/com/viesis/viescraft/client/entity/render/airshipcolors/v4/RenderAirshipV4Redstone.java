...
public class RenderAirshipV4Redstone extends Render<EntityV4Redstone> {
    ...
    public RenderAirshipV4Redstone(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV4Redstone entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV4Redstone entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV4Redstone entity)
    {
