...
public class RenderItemAirshipV4Redstone extends Render<EntityItemV4Redstone> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4Redstone(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV4Redstone entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV4Redstone entity)
    {
