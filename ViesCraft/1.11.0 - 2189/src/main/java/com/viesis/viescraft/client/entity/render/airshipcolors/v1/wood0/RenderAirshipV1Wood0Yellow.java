...
public class RenderAirshipV1Wood0Yellow extends Render<EntityAirshipV1Wood0Yellow> {
    ...
    public RenderAirshipV1Wood0Yellow(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1Wood0Yellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1Wood0Yellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1Wood0Yellow entity)
    {
