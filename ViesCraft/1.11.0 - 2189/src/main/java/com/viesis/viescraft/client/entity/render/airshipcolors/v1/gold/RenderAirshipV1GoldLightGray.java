...
public class RenderAirshipV1GoldLightGray extends Render<EntityAirshipV1GoldLightGray> {
    ...
    public RenderAirshipV1GoldLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1GoldLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1GoldLightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1GoldLightGray entity)
    {
