...
public class EntityV2Redstone extends EntityAirshipV2Core {
	...
	public EntityV2Redstone(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV2Redstone(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.REDSTONE + this.getBoatType().getName() + " " + ViesCraftConfig.v2AirshipName;
	}
