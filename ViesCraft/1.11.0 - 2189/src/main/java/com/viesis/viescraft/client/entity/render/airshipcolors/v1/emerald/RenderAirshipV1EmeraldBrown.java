...
public class RenderAirshipV1EmeraldBrown extends Render<EntityAirshipV1EmeraldBrown> {
    ...
    public RenderAirshipV1EmeraldBrown(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1EmeraldBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1EmeraldBrown entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1EmeraldBrown entity)
    {
