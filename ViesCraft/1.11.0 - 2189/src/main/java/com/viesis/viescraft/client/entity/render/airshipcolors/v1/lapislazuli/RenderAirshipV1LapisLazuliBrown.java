...
public class RenderAirshipV1LapisLazuliBrown extends Render<EntityAirshipV1LapisLazuliBrown> {
    ...
    public RenderAirshipV1LapisLazuliBrown(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1LapisLazuliBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1LapisLazuliBrown entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1LapisLazuliBrown entity)
    {
