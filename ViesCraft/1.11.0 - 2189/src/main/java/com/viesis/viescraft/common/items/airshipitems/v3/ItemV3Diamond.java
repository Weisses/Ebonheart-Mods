...
public class ItemV3Diamond extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV3Diamond(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV3Diamond entityairship = new EntityItemV3Diamond(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.DIAMOND + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v3AirshipName)).trim();
    }
}
