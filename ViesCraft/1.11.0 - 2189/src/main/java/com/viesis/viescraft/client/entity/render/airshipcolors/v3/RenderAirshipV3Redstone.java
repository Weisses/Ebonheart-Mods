...
public class RenderAirshipV3Redstone extends Render<EntityV3Redstone> {
    ...
    public RenderAirshipV3Redstone(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV3Redstone entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV3Redstone entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV3Redstone entity)
    {
