...
public class RenderItemAirshipV2Green extends Render<EntityItemAirshipV2Green> {
    ...
    public RenderItemAirshipV2Green(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2Green entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        TextureAtlasSprite textureatlassprite = Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(InitItemsVC.item_airship_v2_green);
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2Green entity)
    {
