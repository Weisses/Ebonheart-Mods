...
public class ItemV4Diamond extends ItemAirshipCore {
	...
	public ItemV4Diamond(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV4Diamond entityairship = new EntityItemV4Diamond(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.DIAMOND + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v4AirshipName)).trim();
    }
}
