...
public class EntityV1Emerald extends EntityAirshipV1Core {
	
	public EntityV1Emerald(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV1Emerald(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.EMERALD + this.getBoatType().getName() + " " + ViesCraftConfig.v1AirshipName;
	}
