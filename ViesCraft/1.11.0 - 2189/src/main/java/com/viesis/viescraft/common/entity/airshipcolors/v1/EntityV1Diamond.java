...
public class EntityV1Diamond extends EntityAirshipV1Core {
	
	public EntityV1Diamond(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV1Diamond(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.DIAMOND + this.getBoatType().getName() + " " + ViesCraftConfig.v1AirshipName;
	}
