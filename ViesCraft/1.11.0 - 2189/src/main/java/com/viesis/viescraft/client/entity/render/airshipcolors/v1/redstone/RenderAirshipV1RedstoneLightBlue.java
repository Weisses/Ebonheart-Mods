package com.viesis.viescraft.client.entity.render.airshipcolors.v1.redstone;
...
public class RenderAirshipV1RedstoneLightBlue extends Render<EntityAirshipV1RedstoneLightBlue> {
    ...
    public RenderAirshipV1RedstoneLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1RedstoneLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1RedstoneLightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1RedstoneLightBlue entity)
    {
