...
public class RenderAirshipV1LapisLazuliBlack extends Render<EntityAirshipV1LapisLazuliBlack> {
    ...
    public RenderAirshipV1LapisLazuliBlack(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1LapisLazuliBlack entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1LapisLazuliBlack entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1LapisLazuliBlack entity)
    {
