...
public class RenderAirshipV1LapisLazuliLightGray extends Render<EntityAirshipV1LapisLazuliLightGray> {
    ...
    public RenderAirshipV1LapisLazuliLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1LapisLazuliLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1LapisLazuliLightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1LapisLazuliLightGray entity)
    {
