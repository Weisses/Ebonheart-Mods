...
public class EntityV1Gold extends EntityAirshipV1Core {
	
	public EntityV1Gold(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV1Gold(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.GOLD + this.getBoatType().getName() + " " + ViesCraftConfig.v1AirshipName;
	}
