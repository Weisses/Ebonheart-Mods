...
public class RenderAirshipV1EmeraldPink extends Render<EntityAirshipV1EmeraldPink> {
    ...
    public RenderAirshipV1EmeraldPink(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1EmeraldPink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1EmeraldPink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1EmeraldPink entity)
    {
