...
public class RenderAirshipV3Obsidian extends Render<EntityV3Obsidian> {
    ...
    public RenderAirshipV3Obsidian(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV3Obsidian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV3Obsidian entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV3Obsidian entity)
    {
