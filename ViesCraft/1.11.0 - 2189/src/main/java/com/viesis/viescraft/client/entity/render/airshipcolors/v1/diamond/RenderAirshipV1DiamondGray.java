...
public class RenderAirshipV1DiamondGray extends Render<EntityAirshipV1DiamondGray> {
    ...
    public RenderAirshipV1DiamondGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1DiamondGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1DiamondGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1DiamondGray entity)
    {
