...
public class RenderAirshipV1Admin extends Render<EntityAirshipV1Admin> {
    ...
    public RenderAirshipV1Admin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1Admin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1Admin entity)
    {
