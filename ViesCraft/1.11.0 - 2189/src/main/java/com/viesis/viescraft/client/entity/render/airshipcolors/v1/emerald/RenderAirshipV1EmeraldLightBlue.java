package com.viesis.viescraft.client.entity.render.airshipcolors.v1.emerald;
...
public class RenderAirshipV1EmeraldLightBlue extends Render<EntityAirshipV1EmeraldLightBlue> {
    ...
    public RenderAirshipV1EmeraldLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1EmeraldLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1EmeraldLightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1EmeraldLightBlue entity)
    {
