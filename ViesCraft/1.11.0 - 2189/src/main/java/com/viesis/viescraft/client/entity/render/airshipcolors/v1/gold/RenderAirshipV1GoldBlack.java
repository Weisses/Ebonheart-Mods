...
public class RenderAirshipV1GoldBlack extends Render<EntityAirshipV1GoldBlack> {
    ...
    public RenderAirshipV1GoldBlack(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1GoldBlack entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1GoldBlack entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1GoldBlack entity)
    {
