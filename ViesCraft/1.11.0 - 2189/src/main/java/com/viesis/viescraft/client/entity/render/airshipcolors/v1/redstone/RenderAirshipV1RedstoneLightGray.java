...
public class RenderAirshipV1RedstoneLightGray extends Render<EntityAirshipV1RedstoneLightGray> {
    ...
    public RenderAirshipV1RedstoneLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1RedstoneLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1RedstoneLightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1RedstoneLightGray entity)
    {
