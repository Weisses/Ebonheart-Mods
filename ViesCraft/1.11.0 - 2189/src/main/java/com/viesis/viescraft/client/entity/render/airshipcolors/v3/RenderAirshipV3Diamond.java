...
public class RenderAirshipV3Diamond extends Render<EntityV3Diamond> {
    ...
    public RenderAirshipV3Diamond(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV3Diamond entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV3Diamond entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV3Diamond entity)
    {
