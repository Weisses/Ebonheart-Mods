...
public class RenderAirshipV3Orange extends Render<EntityAirshipV3Orange> {
    ...
    public RenderAirshipV3Orange(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3Orange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Orange entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3Orange entity)
    {
