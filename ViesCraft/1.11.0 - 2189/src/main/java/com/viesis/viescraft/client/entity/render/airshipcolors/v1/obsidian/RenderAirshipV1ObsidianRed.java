...
public class RenderAirshipV1ObsidianRed extends Render<EntityAirshipV1ObsidianRed> {
    ...
    public RenderAirshipV1ObsidianRed(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1ObsidianRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1ObsidianRed entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1ObsidianRed entity)
    {
