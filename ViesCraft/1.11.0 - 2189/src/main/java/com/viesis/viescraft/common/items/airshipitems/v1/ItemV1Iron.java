...
public class ItemV1Iron extends ItemAirshipCore {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV1Iron entityairship = new EntityItemV1Iron(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.IRON + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v1AirshipName)).trim();
    }
}
