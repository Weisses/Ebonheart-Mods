...
public class RenderAirshipV3LapisLazuli extends Render<EntityV3LapisLazuli> {
    ...
    public RenderAirshipV3LapisLazuli(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV3LapisLazuli entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV3LapisLazuli entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV3LapisLazuli entity)
    {
