...
public class RenderAirshipV1Orange extends Render<EntityAirshipV1Orange> {
    ...
    public RenderAirshipV1Orange(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV1Orange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1Orange entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV1Orange entity)
    {
