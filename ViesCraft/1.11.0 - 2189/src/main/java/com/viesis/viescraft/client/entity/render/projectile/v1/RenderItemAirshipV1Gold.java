...
public class RenderItemAirshipV1Gold extends Render<EntityItemV1Gold> {
     ...
     */
    public void doRender(EntityItemV1Gold entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV1Gold entity)
    {
