...
public class RenderItemAirshipV2Gold extends Render<EntityItemV2Gold> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2Gold(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV2Gold entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV2Gold entity)
    {
