...
public class RenderAirshipV1RedstoneGreen extends Render<EntityAirshipV1RedstoneGreen> {
    ...
    public RenderAirshipV1RedstoneGreen(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1RedstoneGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1RedstoneGreen entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1RedstoneGreen entity)
    {
