...
public class ItemV1Gold extends ItemAirshipCore {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV1Gold entityairship = new EntityItemV1Gold(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.GOLD + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v1AirshipName)).trim();
    }
}
