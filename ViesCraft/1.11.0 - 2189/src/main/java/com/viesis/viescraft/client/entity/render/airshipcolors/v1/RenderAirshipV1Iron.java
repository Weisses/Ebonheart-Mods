...
public class RenderAirshipV1Iron extends Render<EntityV1Iron> {
     ...
     */
    @Override
    public void doRender(EntityV1Iron entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV1Iron entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV1Iron entity)
    {
