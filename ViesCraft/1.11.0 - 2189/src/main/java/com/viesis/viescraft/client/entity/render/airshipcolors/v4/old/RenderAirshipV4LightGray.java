...
public class RenderAirshipV4LightGray extends Render<EntityAirshipV4LightGray> {
    ...
    public RenderAirshipV4LightGray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4LightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4LightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4LightGray entity)
    {
