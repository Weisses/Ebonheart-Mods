package com.viesis.viescraft.client.entity.render.airshipcolors.v1.obsidian;
...
public class RenderAirshipV1ObsidianLightGray extends Render<EntityAirshipV1ObsidianLightGray> {
	
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		new ResourceLocation(Reference.MOD_ID, "textures/models/v1/airship_v1_color_lightgray.png"),
    ...
    public RenderAirshipV1ObsidianLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1ObsidianLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1ObsidianLightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1ObsidianLightGray entity)
    {
