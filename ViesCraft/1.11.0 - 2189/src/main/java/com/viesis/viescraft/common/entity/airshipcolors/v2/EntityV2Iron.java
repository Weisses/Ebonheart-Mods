...
public class EntityV2Iron extends EntityAirshipV2Core {
	
	public EntityV2Iron(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV2Iron(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.IRON + this.getBoatType().getName() + " " + ViesCraftConfig.v2AirshipName;
	}
