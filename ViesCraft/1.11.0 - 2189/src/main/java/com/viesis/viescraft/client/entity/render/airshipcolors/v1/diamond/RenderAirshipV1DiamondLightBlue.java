package com.viesis.viescraft.client.entity.render.airshipcolors.v1.diamond;
...
public class RenderAirshipV1DiamondLightBlue extends Render<EntityAirshipV1DiamondLightBlue> {
    ...
    public RenderAirshipV1DiamondLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1DiamondLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1DiamondLightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1DiamondLightBlue entity)
    {
