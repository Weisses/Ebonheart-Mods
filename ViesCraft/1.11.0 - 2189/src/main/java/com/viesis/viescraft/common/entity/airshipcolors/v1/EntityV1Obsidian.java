...
public class EntityV1Obsidian extends EntityAirshipV1Core {
	
	public EntityV1Obsidian(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV1Obsidian(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.OBSIDIAN + this.getBoatType().getName() + " " + ViesCraftConfig.v1AirshipName;
	}
