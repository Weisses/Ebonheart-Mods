...
public class ItemV2Emerald extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV2Emerald(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV2Emerald entityairship = new EntityItemV2Emerald(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.EMERALD + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v2AirshipName)).trim();
    }
}
