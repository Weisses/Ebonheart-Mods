...
public class RenderItemAirshipV4Obsidian extends Render<EntityItemV4Obsidian> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4Obsidian(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV4Obsidian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV4Obsidian entity)
    {
