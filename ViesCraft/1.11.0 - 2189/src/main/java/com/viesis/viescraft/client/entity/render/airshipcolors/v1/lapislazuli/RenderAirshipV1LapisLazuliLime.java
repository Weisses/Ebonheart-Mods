...
public class RenderAirshipV1LapisLazuliLime extends Render<EntityAirshipV1LapisLazuliLime> {
    ...
    public RenderAirshipV1LapisLazuliLime(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1LapisLazuliLime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1LapisLazuliLime entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1LapisLazuliLime entity)
    {
