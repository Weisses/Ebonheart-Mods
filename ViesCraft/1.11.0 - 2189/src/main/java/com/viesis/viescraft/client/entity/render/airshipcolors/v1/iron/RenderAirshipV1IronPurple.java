...
public class RenderAirshipV1IronPurple extends Render<EntityAirshipV1IronPurple> {
    ...
    public RenderAirshipV1IronPurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1IronPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1IronPurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1IronPurple entity)
    {
