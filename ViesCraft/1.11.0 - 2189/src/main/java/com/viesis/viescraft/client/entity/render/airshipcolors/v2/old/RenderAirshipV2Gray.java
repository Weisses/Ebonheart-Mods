...
public class RenderAirshipV2Gray extends Render<EntityAirshipV2Gray> {
    ...
    public RenderAirshipV2Gray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV2Gray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Gray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2Gray entity)
    {
