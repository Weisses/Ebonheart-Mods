...
public class RenderAirshipV1GoldYellow extends Render<EntityAirshipV1GoldYellow> {
    ...
    public RenderAirshipV1GoldYellow(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1GoldYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1GoldYellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1GoldYellow entity)
    {
