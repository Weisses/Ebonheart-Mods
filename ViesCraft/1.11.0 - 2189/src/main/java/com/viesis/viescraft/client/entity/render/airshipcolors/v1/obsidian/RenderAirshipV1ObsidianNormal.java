...
public class RenderAirshipV1ObsidianNormal extends Render<EntityAirshipV1ObsidianNormal> {
	
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		new ResourceLocation(Reference.MOD_ID, "textures/models/v1/airship_v1_color_normal.png"),
    ...
    public RenderAirshipV1ObsidianNormal(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1ObsidianNormal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1ObsidianNormal entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1ObsidianNormal entity)
    {
