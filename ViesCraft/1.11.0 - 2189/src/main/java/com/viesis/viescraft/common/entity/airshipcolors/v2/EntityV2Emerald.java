...
public class EntityV2Emerald extends EntityAirshipV2Core {
	
	public EntityV2Emerald(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV2Emerald(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.EMERALD + this.getBoatType().getName() + " " + ViesCraftConfig.v2AirshipName;
	}
