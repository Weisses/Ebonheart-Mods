...
public class RenderAirshipV1LapisLazuliGreen extends Render<EntityAirshipV1LapisLazuliGreen> {
    ...
    public RenderAirshipV1LapisLazuliGreen(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1LapisLazuliGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1LapisLazuliGreen entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1LapisLazuliGreen entity)
    {
