...
public class RenderAirshipV1RedstoneWhite extends Render<EntityAirshipV1RedstoneWhite> {
    ...
    public RenderAirshipV1RedstoneWhite(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1RedstoneWhite entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1RedstoneWhite entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1RedstoneWhite entity)
    {
