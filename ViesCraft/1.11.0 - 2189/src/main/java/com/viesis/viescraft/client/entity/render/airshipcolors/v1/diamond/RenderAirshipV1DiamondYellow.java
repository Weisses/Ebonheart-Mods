...
public class RenderAirshipV1DiamondYellow extends Render<EntityAirshipV1DiamondYellow> {
    ...
    public RenderAirshipV1DiamondYellow(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1DiamondYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1DiamondYellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1DiamondYellow entity)
    {
