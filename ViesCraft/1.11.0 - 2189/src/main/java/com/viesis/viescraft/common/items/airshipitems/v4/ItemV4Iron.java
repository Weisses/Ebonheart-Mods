...
public class ItemV4Iron extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV4Iron(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV4Iron entityairship = new EntityItemV4Iron(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.IRON + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v4AirshipName)).trim();
    }
}
