...
public class EntityV3Obsidian extends EntityAirshipV3Core {
	
	public EntityV3Obsidian(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV3Obsidian(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.OBSIDIAN + this.getBoatType().getName() + " " + ViesCraftConfig.v3AirshipName;
	}
