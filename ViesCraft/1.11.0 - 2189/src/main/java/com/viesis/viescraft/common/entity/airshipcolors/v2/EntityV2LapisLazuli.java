...
public class EntityV2LapisLazuli extends EntityAirshipV2Core {
	
	public EntityV2LapisLazuli(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV2LapisLazuli(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.LAPISLAZULI + this.getBoatType().getName() + " " + ViesCraftConfig.v2AirshipName;
	}
