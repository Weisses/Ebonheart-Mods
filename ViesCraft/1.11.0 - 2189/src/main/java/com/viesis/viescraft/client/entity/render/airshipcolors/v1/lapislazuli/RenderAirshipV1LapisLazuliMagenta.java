...
public class RenderAirshipV1LapisLazuliMagenta extends Render<EntityAirshipV1LapisLazuliMagenta> {
    ...
    public RenderAirshipV1LapisLazuliMagenta(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1LapisLazuliMagenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1LapisLazuliMagenta entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1LapisLazuliMagenta entity)
    {
