...
public class RenderAirshipV3White extends Render<EntityAirshipV3White> {
    ...
    public RenderAirshipV3White(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3White entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3White entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3White entity)
    {
