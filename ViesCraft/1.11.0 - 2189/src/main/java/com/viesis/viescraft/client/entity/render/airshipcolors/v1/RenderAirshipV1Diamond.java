...
public class RenderAirshipV1Diamond extends Render<EntityV1Diamond> {
    ...
    public RenderAirshipV1Diamond(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV1Diamond entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV1Diamond entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV1Diamond entity)
    {
