...
public class EntityV4Obsidian extends EntityAirshipV4Core {
	
	public EntityV4Obsidian(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV4Obsidian(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.OBSIDIAN + this.getBoatType().getName() + " " + ViesCraftConfig.v4AirshipName;
	}
