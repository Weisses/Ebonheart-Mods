...
public class EntityV3Redstone extends EntityAirshipV3Core {
	
	public EntityV3Redstone(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV3Redstone(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.REDSTONE + this.getBoatType().getName() + " " + ViesCraftConfig.v3AirshipName;
	}
