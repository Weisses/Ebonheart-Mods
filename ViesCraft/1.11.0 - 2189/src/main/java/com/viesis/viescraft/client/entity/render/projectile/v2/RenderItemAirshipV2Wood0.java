...
public class RenderItemAirshipV2Wood0 extends Render<EntityItemV2Wood0> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2Wood0(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV2Wood0 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV2Wood0 entity)
    {
