...
public class RenderAirshipV1LapisLazuliLightBlue extends Render<EntityAirshipV1LapisLazuliLightBlue> {
    ...
    public RenderAirshipV1LapisLazuliLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1LapisLazuliLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1LapisLazuliLightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1LapisLazuliLightBlue entity)
    {
