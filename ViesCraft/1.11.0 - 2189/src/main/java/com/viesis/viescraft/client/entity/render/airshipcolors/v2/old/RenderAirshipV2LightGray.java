package com.viesis.viescraft.client.entity.render.airshipcolors.v2.old;
...
public class RenderAirshipV2LightGray extends Render<EntityAirshipV2LightGray> {
    ...
    public RenderAirshipV2LightGray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV2LightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2LightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2LightGray entity)
    {
