...
public class RenderAirshipV2Emerald extends Render<EntityV2Emerald> {
    ...
    public RenderAirshipV2Emerald(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV2Emerald entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV2Emerald entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV2Emerald entity)
    {
