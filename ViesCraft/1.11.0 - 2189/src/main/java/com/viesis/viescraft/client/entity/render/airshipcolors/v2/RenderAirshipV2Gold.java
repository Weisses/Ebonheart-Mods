...
public class RenderAirshipV2Gold extends Render<EntityV2Gold> {
    ...
    public RenderAirshipV2Gold(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV2Gold entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV2Gold entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV2Gold entity)
    {
