...
public class EntityV4Redstone extends EntityAirshipV4Core {
	
	public EntityV4Redstone(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV4Redstone(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.REDSTONE + this.getBoatType().getName() + " " + ViesCraftConfig.v4AirshipName;
	}
