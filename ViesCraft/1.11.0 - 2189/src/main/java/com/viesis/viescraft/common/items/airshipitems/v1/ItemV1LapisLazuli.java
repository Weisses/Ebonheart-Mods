...
public class ItemV1LapisLazuli extends ItemAirshipCore {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV1LapisLazuli entityairship = new EntityItemV1LapisLazuli(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.LAPISLAZULI + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v1AirshipName)).trim();
    }
}
