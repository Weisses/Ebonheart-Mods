...
public class EntityV1Wood0 extends EntityAirshipV1Core {
	
	public EntityV1Wood0(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV1Wood0(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.WOOD0 + this.getBoatType().getName() + " " + ViesCraftConfig.v1AirshipName;
	}
