...
public class EntityV2Obsidian extends EntityAirshipV2Core {
	
	public EntityV2Obsidian(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV2Obsidian(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.OBSIDIAN + this.getBoatType().getName() + " " + ViesCraftConfig.v2AirshipName;
	}
