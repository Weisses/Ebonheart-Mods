...
public class RenderAirshipV1Gold extends Render<EntityV1Gold> {
     ...
     */
    @Override
    public void doRender(EntityV1Gold entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV1Gold entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV1Gold entity)
    {
