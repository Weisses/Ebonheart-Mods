...
public class EntityV1LapisLazuli extends EntityAirshipV1Core {
	
	public EntityV1LapisLazuli(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV1LapisLazuli(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.LAPISLAZULI + this.getBoatType().getName() + " " + ViesCraftConfig.v1AirshipName;
	}
