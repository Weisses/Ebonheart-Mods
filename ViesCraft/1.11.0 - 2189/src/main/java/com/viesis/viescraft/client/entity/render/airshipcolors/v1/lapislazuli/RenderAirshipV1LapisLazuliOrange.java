...
public class RenderAirshipV1LapisLazuliOrange extends Render<EntityAirshipV1LapisLazuliOrange> {
    ...
    public RenderAirshipV1LapisLazuliOrange(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1LapisLazuliOrange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1LapisLazuliOrange entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1LapisLazuliOrange entity)
    {
