...
public class RenderAirshipV2Purple extends Render<EntityAirshipV2Purple> {
    ...
    public RenderAirshipV2Purple(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV2Purple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Purple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2Purple entity)
    {
