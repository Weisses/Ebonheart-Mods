...
public class RenderAirshipV1DiamondPurple extends Render<EntityAirshipV1DiamondPurple> {
    ...
    public RenderAirshipV1DiamondPurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1DiamondPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1DiamondPurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1DiamondPurple entity)
    {
