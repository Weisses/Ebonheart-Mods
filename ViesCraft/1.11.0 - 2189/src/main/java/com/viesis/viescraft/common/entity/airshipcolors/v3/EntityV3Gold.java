...
public class EntityV3Gold extends EntityAirshipV3Core {
	
	public EntityV3Gold(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV3Gold(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.GOLD + this.getBoatType().getName() + " " + ViesCraftConfig.v3AirshipName;
	}
