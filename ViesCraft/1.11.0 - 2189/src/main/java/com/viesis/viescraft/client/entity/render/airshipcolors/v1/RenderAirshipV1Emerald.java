...
public class RenderAirshipV1Emerald extends Render<EntityV1Emerald> {
    ...
    public RenderAirshipV1Emerald(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV1Emerald entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV1Emerald entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV1Emerald entity)
    {
