...
public class RenderAirshipV2Iron extends Render<EntityV2Iron> {
    ...
    public RenderAirshipV2Iron(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV2Iron entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV2Iron entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV2Iron entity)
    {
