package com.viesis.viescraft.client.entity.render.airshipcolors.v1.gold;
...
public class RenderAirshipV1GoldLightBlue extends Render<EntityAirshipV1GoldLightBlue> {
    ...
    public RenderAirshipV1GoldLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1GoldLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1GoldLightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1GoldLightBlue entity)
    {
