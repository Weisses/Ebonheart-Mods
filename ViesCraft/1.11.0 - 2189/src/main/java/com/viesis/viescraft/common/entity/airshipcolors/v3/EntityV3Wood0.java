...
public class EntityV3Wood0 extends EntityAirshipV3Core {
	
	public EntityV3Wood0(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV3Wood0(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.WOOD0 + this.getBoatType().getName() + " " + ViesCraftConfig.v3AirshipName;
	}
