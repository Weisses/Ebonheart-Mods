...
public class RenderAirshipV1Wood0Normal extends Render<EntityAirshipV1Wood0Normal> {
    ...
    public RenderAirshipV1Wood0Normal(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1Wood0Normal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1Wood0Normal entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1Wood0Normal entity)
    {
