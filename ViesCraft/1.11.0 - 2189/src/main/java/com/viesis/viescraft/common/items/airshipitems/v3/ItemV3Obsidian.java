...
public class ItemV3Obsidian extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV3Obsidian(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV3Obsidian entityairship = new EntityItemV3Obsidian(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.OBSIDIAN + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v3AirshipName)).trim();
    }
}
