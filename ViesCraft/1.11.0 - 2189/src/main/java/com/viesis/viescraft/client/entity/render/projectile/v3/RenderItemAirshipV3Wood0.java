...
public class RenderItemAirshipV3Wood0 extends Render<EntityItemV3Wood0> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3Wood0(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV3Wood0 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV3Wood0 entity)
    {
