...
public class RenderItemAirshipV4Emerald extends Render<EntityItemV4Emerald> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4Emerald(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV4Emerald entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV4Emerald entity)
    {
