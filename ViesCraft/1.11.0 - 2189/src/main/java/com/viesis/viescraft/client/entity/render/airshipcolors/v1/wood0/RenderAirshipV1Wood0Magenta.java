...
public class RenderAirshipV1Wood0Magenta extends Render<EntityAirshipV1Wood0Magenta> {
    ...
    public RenderAirshipV1Wood0Magenta(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1Wood0Magenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1Wood0Magenta entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1Wood0Magenta entity)
    {
