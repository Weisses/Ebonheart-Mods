...
public class RenderAirshipV1LapisLazuliPurple extends Render<EntityAirshipV1LapisLazuliPurple> {
    ...
    public RenderAirshipV1LapisLazuliPurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1LapisLazuliPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1LapisLazuliPurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1LapisLazuliPurple entity)
    {
