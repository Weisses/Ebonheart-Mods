...
public class RenderAirshipV1RedstoneGray extends Render<EntityAirshipV1RedstoneGray> {
    ...
    public RenderAirshipV1RedstoneGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1RedstoneGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1RedstoneGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1RedstoneGray entity)
    {
