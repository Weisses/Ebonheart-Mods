...
public class RenderAirshipV1Purple extends Render<EntityAirshipV1Purple> {
    ...
    public RenderAirshipV1Purple(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV1Purple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1Purple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV1Purple entity)
    {
