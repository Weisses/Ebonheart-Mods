...
public class RenderAirshipV4Black extends Render<EntityAirshipV4Black> {
    ...
    public RenderAirshipV4Black(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4Black entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Black entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4Black entity)
    {
