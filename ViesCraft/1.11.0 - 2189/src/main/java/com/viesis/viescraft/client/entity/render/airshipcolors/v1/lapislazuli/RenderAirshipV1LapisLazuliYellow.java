...
public class RenderAirshipV1LapisLazuliYellow extends Render<EntityAirshipV1LapisLazuliYellow> {
    ...
    public RenderAirshipV1LapisLazuliYellow(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1LapisLazuliYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1LapisLazuliYellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1LapisLazuliYellow entity)
    {
