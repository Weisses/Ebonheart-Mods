...
public class RenderAirshipV1Wood0Orange extends Render<EntityAirshipV1Wood0Orange> {
    ...
    public RenderAirshipV1Wood0Orange(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1Wood0Orange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1Wood0Orange entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1Wood0Orange entity)
    {
