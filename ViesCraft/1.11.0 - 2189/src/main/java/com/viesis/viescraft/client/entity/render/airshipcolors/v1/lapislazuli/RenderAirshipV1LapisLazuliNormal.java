...
public class RenderAirshipV1LapisLazuliNormal extends Render<EntityAirshipV1LapisLazuliNormal> {
    ...
    public RenderAirshipV1LapisLazuliNormal(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1LapisLazuliNormal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1LapisLazuliNormal entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1LapisLazuliNormal entity)
    {
