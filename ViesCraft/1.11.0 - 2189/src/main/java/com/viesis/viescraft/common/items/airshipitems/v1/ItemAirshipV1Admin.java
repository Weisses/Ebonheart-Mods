...
public class ItemAirshipV1Admin extends ItemAirshipCore {
	
	public ItemAirshipV1Admin() 
	{
		ItemHelper.setItemName(this, "item_airship_v1_admin");
    ...
    {
        return ("" + I18n.translateToLocal("Admin " + ViesCraftConfig.v1AirshipName)).trim();
    }
}
