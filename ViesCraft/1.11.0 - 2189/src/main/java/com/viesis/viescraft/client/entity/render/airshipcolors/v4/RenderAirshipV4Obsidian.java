...
public class RenderAirshipV4Obsidian extends Render<EntityV4Obsidian> {
    ...
    public RenderAirshipV4Obsidian(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV4Obsidian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV4Obsidian entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV4Obsidian entity)
    {
