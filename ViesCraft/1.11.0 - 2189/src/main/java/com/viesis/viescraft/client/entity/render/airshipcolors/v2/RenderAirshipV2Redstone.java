...
public class RenderAirshipV2Redstone extends Render<EntityV2Redstone> {
    ...
    public RenderAirshipV2Redstone(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV2Redstone entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV2Redstone entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV2Redstone entity)
    {
