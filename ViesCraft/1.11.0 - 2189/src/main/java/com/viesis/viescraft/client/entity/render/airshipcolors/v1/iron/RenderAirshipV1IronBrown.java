...
public class RenderAirshipV1IronBrown extends Render<EntityAirshipV1IronBrown> {
    ...
    public RenderAirshipV1IronBrown(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1IronBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1IronBrown entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1IronBrown entity)
    {
