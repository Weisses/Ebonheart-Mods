...
public class RenderAirshipV3Blue extends Render<EntityAirshipV3Blue> {
    ...
    public RenderAirshipV3Blue(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3Blue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Blue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3Blue entity)
    {
