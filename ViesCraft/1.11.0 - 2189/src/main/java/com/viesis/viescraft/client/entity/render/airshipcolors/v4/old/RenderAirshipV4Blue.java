...
public class RenderAirshipV4Blue extends Render<EntityAirshipV4Blue> {
    ...
    public RenderAirshipV4Blue(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4Blue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Blue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4Blue entity)
    {
