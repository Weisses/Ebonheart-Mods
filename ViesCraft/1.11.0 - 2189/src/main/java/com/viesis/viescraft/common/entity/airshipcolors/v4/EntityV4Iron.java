...
public class EntityV4Iron extends EntityAirshipV4Core {
	
	public EntityV4Iron(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV4Iron(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
    ...
    {
		return ITEM_IRON[this.metaColor];
    }
	...
	{
		return this.hasCustomName() ? this.customName : Reference.IRON + this.getBoatType().getName() + " " + ViesCraftConfig.v4AirshipName;
	}
