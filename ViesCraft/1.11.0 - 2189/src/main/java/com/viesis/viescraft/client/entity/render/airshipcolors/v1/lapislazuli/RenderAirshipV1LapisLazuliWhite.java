...
public class RenderAirshipV1LapisLazuliWhite extends Render<EntityAirshipV1LapisLazuliWhite> {
    ...
    public RenderAirshipV1LapisLazuliWhite(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1LapisLazuliWhite entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1LapisLazuliWhite entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1LapisLazuliWhite entity)
    {
