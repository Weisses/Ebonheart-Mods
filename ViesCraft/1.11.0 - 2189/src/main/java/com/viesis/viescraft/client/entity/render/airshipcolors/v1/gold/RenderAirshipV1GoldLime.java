...
public class RenderAirshipV1GoldLime extends Render<EntityAirshipV1GoldLime> {
    ...
    public RenderAirshipV1GoldLime(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1GoldLime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1GoldLime entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1GoldLime entity)
    {
