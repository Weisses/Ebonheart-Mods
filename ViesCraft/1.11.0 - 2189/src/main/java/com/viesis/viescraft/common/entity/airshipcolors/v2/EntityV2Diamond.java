...
public class EntityV2Diamond extends EntityAirshipV2Core {
	
	public EntityV2Diamond(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV2Diamond(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.DIAMOND + this.getBoatType().getName() + " " + ViesCraftConfig.v2AirshipName;
	}
