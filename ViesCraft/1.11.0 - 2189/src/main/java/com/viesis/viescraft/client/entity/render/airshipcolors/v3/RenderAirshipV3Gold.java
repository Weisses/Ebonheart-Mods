...
public class RenderAirshipV3Gold extends Render<EntityV3Gold> {
    ...
    public RenderAirshipV3Gold(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV3Gold entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV3Gold entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV3Gold entity)
    {
