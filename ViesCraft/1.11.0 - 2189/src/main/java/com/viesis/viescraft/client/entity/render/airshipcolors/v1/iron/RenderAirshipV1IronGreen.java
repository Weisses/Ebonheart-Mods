...
public class RenderAirshipV1IronGreen extends Render<EntityAirshipV1IronGreen> {
    ...
    public RenderAirshipV1IronGreen(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1IronGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1IronGreen entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1IronGreen entity)
    {
