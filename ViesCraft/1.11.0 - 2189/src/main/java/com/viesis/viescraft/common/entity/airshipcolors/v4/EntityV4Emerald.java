...
public class EntityV4Emerald extends EntityAirshipV4Core {
	
	public EntityV4Emerald(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV4Emerald(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.EMERALD + this.getBoatType().getName() + " " + ViesCraftConfig.v4AirshipName;
	}
