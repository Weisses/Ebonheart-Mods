package com.viesis.viescraft.client.entity.render.airshipcolors.v1.wood0;
...
public class RenderAirshipV1Wood0LightGray extends Render<EntityAirshipV1Wood0LightGray> {
    ...
    public RenderAirshipV1Wood0LightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1Wood0LightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1Wood0LightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1Wood0LightGray entity)
    {
