package com.viesis.viescraft.client.entity.render.airshipcolors.v1.iron;
...
public class RenderAirshipV1IronLightGray extends Render<EntityAirshipV1IronLightGray> {
    ...
    public RenderAirshipV1IronLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1IronLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1IronLightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1IronLightGray entity)
    {
