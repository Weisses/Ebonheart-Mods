...
public class RenderAirshipV3Magenta extends Render<EntityAirshipV3Magenta> {
    ...
    public RenderAirshipV3Magenta(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3Magenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Magenta entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3Magenta entity)
    {
