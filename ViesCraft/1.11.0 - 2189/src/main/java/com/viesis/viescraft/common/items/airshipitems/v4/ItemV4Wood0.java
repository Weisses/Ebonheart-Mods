...
public class ItemV4Wood0 extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV4Wood0(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV4Wood0 entityairship = new EntityItemV4Wood0(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.WOOD0 + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v4AirshipName)).trim();
    }
}
