...
public class RenderAirshipV4Iron extends Render<EntityV4Iron> {
    ...
    public RenderAirshipV4Iron(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV4Iron entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV4Iron entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV4Iron entity)
    {
