...
public class RenderAirshipV4Lime extends Render<EntityAirshipV4Lime> {
    ...
    public RenderAirshipV4Lime(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4Lime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Lime entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4Lime entity)
    {
