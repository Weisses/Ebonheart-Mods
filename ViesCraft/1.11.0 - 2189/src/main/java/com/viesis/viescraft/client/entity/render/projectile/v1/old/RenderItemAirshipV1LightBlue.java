...
import com.viesis.viescraft.common.entity.airshipitems.v1.old.EntityItemAirshipV1LightBlue;
import com.viesis.viescraft.init.InitItemsVC;

@SideOnly(Side.CLIENT)
public class RenderItemAirshipV1LightBlue extends Render<EntityItemAirshipV1LightBlue> {
    ...
    public RenderItemAirshipV1LightBlue(RenderManager renderManagerIn)
    {
    ...
    public void doRender(EntityItemAirshipV1LightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        TextureAtlasSprite textureatlassprite = Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(InitItemsVC.item_airship_v1_lightblue);
