...
public class ItemV4Gold extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV4Gold(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV4Gold entityairship = new EntityItemV4Gold(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.GOLD + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v4AirshipName)).trim();
    }
}
