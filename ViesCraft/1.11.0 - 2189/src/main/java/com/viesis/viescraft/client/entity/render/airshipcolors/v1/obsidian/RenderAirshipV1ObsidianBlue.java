...
public class RenderAirshipV1ObsidianBlue extends Render<EntityAirshipV1ObsidianBlue> {
    ...
    public RenderAirshipV1ObsidianBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1ObsidianBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1ObsidianBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1ObsidianBlue entity)
    {
