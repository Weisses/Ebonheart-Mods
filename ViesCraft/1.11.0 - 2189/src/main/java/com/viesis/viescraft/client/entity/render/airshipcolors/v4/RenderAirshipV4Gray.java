...
public class RenderAirshipV4Gray extends Render<EntityAirshipV4Gray> {
    ...
    public RenderAirshipV4Gray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4Gray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Gray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4Gray entity)
    {
