...
public class RenderItemAirshipV2Admin extends Render<EntityItemAirshipV2Admin> {
    ...
    public RenderItemAirshipV2Admin(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2Admin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2Admin entity)
    {
