...
public class RenderItemAirshipV3Obsidian extends Render<EntityItemV3Obsidian> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3Obsidian(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV3Obsidian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV3Obsidian entity)
    {
