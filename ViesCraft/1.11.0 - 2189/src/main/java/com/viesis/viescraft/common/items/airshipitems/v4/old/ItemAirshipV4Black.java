...
public class ItemAirshipV4Black extends ItemAirshipCore {
	
	public ItemAirshipV4Black() 
	{
		ItemHelper.setItemName(this, "item_airship_v4_black");
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV4Black entityairship = new EntityItemAirshipV4Black(worldIn, playerIn);
    ...
    {
        return ("" + I18n.translateToLocal("Black " + ViesCraftConfig.v4AirshipName)).trim();
    }
