...
public class RenderAirshipV3Wood0Magenta extends Render<EntityAirshipV3Wood0Magenta> {
    ...
    public RenderAirshipV3Wood0Magenta(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3Wood0Magenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Wood0Magenta entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3Wood0Magenta entity)
    {
