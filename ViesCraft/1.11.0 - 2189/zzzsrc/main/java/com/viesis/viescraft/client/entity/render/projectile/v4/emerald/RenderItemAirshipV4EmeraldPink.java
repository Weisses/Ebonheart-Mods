...
public class RenderItemAirshipV4EmeraldPink extends Render<EntityItemAirshipV4EmeraldPink> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4EmeraldPink(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4EmeraldPink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4EmeraldPink entity)
    {
