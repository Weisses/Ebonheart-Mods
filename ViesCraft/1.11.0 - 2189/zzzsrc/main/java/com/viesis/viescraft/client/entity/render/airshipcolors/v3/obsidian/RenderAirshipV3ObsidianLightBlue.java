...
public class RenderAirshipV3ObsidianLightBlue extends Render<EntityAirshipV3ObsidianLightBlue> {
    ...
    public RenderAirshipV3ObsidianLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3ObsidianLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3ObsidianLightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3ObsidianLightBlue entity)
    {
