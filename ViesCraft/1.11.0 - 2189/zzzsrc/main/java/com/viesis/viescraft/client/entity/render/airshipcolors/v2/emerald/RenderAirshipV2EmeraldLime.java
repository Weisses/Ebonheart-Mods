...
public class RenderAirshipV2EmeraldLime extends Render<EntityAirshipV2EmeraldLime> {
    ...
    public RenderAirshipV2EmeraldLime(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2EmeraldLime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2EmeraldLime entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2EmeraldLime entity)
    {
