...
public class RenderItemAirshipV4RedstoneYellow extends Render<EntityItemAirshipV4RedstoneYellow> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4RedstoneYellow(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4RedstoneYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4RedstoneYellow entity)
    {
