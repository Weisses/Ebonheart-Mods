...
public class RenderAirshipV1ObsidianAdmin extends Render<EntityAirshipV1ObsidianAdmin> {
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		...
		new ResourceLocation(Reference.MOD_ID, "textures/models/v1/airship_v1_frame_admin_obsidian.png")
	};
    ...
    public RenderAirshipV1ObsidianAdmin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV1ObsidianAdmin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1ObsidianAdmin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV1ObsidianAdmin entity)
    {
