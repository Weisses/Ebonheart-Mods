...
public class RenderAirshipV4IronPurple extends Render<EntityAirshipV4IronPurple> {
    ...
    public RenderAirshipV4IronPurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4IronPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4IronPurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4IronPurple entity)
    {
