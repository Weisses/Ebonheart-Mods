...
public class RenderAirshipV4LapisLazuliBlue extends Render<EntityAirshipV4LapisLazuliBlue> {
    ...
    public RenderAirshipV4LapisLazuliBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4LapisLazuliBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4LapisLazuliBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4LapisLazuliBlue entity)
    {
