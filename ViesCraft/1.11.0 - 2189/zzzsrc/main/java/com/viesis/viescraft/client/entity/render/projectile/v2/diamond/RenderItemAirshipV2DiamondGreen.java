...
public class RenderItemAirshipV2DiamondGreen extends Render<EntityItemAirshipV2DiamondGreen> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2DiamondGreen(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2DiamondGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2DiamondGreen entity)
    {
