...
public class RenderAirshipV4DiamondCyan extends Render<EntityAirshipV4DiamondCyan> {
    ...
    public RenderAirshipV4DiamondCyan(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4DiamondCyan entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4DiamondCyan entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4DiamondCyan entity)
    {
