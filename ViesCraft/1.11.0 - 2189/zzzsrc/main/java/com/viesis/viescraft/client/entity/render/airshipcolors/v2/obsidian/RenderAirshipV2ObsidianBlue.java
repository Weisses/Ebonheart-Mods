...
public class RenderAirshipV2ObsidianBlue extends Render<EntityAirshipV2ObsidianBlue> {
    ...
    public RenderAirshipV2ObsidianBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2ObsidianBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2ObsidianBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2ObsidianBlue entity)
    {
