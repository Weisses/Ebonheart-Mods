...
public class RenderAirshipV3DiamondYellow extends Render<EntityAirshipV3DiamondYellow> {
    ...
    public RenderAirshipV3DiamondYellow(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3DiamondYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3DiamondYellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3DiamondYellow entity)
    {
