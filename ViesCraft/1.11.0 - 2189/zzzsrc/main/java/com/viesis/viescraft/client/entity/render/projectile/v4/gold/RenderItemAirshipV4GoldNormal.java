...
public class RenderItemAirshipV4GoldNormal extends Render<EntityItemAirshipV4GoldNormal> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4GoldNormal(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4GoldNormal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4GoldNormal entity)
    {
