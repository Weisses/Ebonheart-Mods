...
public class RenderAirshipV3GoldYellow extends Render<EntityAirshipV3GoldYellow> {
    ...
    public RenderAirshipV3GoldYellow(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3GoldYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3GoldYellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3GoldYellow entity)
    {
