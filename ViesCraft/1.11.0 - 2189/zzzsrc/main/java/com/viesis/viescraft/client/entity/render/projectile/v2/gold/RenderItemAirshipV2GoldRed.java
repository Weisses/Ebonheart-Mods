...
public class RenderItemAirshipV2GoldRed extends Render<EntityItemAirshipV2GoldRed> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2GoldRed(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2GoldRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2GoldRed entity)
    {
