...
public class RenderAirshipV2EmeraldNormal extends Render<EntityAirshipV2EmeraldNormal> {
    ...
    public RenderAirshipV2EmeraldNormal(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2EmeraldNormal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2EmeraldNormal entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2EmeraldNormal entity)
    {
