...
public class RenderAirshipV2GoldCyan extends Render<EntityAirshipV2GoldCyan> {
    ...
    public RenderAirshipV2GoldCyan(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2GoldCyan entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2GoldCyan entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2GoldCyan entity)
    {
