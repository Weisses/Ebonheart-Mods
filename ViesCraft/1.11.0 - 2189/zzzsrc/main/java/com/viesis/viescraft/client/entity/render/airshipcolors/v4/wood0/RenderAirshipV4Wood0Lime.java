...
public class RenderAirshipV4Wood0Lime extends Render<EntityAirshipV4Wood0Lime> {
    ...
    public RenderAirshipV4Wood0Lime(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4Wood0Lime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Wood0Lime entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4Wood0Lime entity)
    {
