...
public class SlotDecraftingVC extends Slot
{
    ...
    public SlotDecraftingVC(EntityPlayer player, InventoryCrafting craftingInventory, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition)
    {
    ...
    public ItemStack func_190901_a(EntityPlayer p_190901_1_, ItemStack p_190901_2_)
    {
        ...
        NonNullList<ItemStack> nonnulllist = DeCraftingManagerVC.getInstance().getRemainingItems(this.craftMatrix, p_190901_1_.worldObj);
