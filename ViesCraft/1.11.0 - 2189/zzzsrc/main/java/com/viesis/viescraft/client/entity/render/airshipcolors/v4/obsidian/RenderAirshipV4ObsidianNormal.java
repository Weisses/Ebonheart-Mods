...
public class RenderAirshipV4ObsidianNormal extends Render<EntityAirshipV4ObsidianNormal> {
    ...
    public RenderAirshipV4ObsidianNormal(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4ObsidianNormal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4ObsidianNormal entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4ObsidianNormal entity)
    {
