package com.viesis.viescraft.client.entity.render.airshipcolors.v3.diamond;
...
public class RenderAirshipV3DiamondAdmin extends Render<EntityAirshipV3DiamondAdmin> {
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		...
		new ResourceLocation(Reference.MOD_ID, "textures/models/v3/airship_v3_frame_admin_diamond.png")
	};
    ...
    public RenderAirshipV3DiamondAdmin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3DiamondAdmin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3DiamondAdmin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3DiamondAdmin entity)
    {
