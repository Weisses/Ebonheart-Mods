package com.viesis.viescraft.client.entity.render.projectile.v4.iron;
...
public class RenderItemAirshipV4IronLightBlue extends Render<EntityItemAirshipV4IronLightBlue> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4IronLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4IronLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4IronLightBlue entity)
    {
