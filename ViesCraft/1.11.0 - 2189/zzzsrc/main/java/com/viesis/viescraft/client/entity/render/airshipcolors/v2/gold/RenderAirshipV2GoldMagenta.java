...
public class RenderAirshipV2GoldMagenta extends Render<EntityAirshipV2GoldMagenta> {
    ...
    public RenderAirshipV2GoldMagenta(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2GoldMagenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2GoldMagenta entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2GoldMagenta entity)
    {
