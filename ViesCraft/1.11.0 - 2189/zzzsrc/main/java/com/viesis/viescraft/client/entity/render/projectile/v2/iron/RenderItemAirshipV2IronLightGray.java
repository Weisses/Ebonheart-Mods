package com.viesis.viescraft.client.entity.render.projectile.v2.iron;
...
public class RenderItemAirshipV2IronLightGray extends Render<EntityItemAirshipV2IronLightGray> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2IronLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2IronLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2IronLightGray entity)
    {
