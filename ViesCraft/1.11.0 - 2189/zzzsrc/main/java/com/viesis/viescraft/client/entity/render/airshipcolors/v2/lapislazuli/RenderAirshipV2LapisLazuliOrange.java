...
public class RenderAirshipV2LapisLazuliOrange extends Render<EntityAirshipV2LapisLazuliOrange> {
    ...
    public RenderAirshipV2LapisLazuliOrange(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2LapisLazuliOrange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2LapisLazuliOrange entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2LapisLazuliOrange entity)
    {
