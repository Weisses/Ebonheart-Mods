...
public class RenderItemAirshipV3Wood0Gray extends Render<EntityItemAirshipV3Wood0Gray> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3Wood0Gray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3Wood0Gray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3Wood0Gray entity)
    {
