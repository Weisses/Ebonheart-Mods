...
public class RenderAirshipV3LapisLazuliBlack extends Render<EntityAirshipV3LapisLazuliBlack> {
    ...
    public RenderAirshipV3LapisLazuliBlack(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3LapisLazuliBlack entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LapisLazuliBlack entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3LapisLazuliBlack entity)
    {
