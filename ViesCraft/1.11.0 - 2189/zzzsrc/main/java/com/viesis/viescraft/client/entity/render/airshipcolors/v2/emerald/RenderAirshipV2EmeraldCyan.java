...
public class RenderAirshipV2EmeraldCyan extends Render<EntityAirshipV2EmeraldCyan> {
    ...
    public RenderAirshipV2EmeraldCyan(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2EmeraldCyan entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2EmeraldCyan entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2EmeraldCyan entity)
    {
