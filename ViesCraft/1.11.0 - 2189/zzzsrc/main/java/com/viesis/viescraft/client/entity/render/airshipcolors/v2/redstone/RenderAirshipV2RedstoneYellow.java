...
public class RenderAirshipV2RedstoneYellow extends Render<EntityAirshipV2RedstoneYellow> {
    ...
    public RenderAirshipV2RedstoneYellow(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2RedstoneYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2RedstoneYellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2RedstoneYellow entity)
    {
