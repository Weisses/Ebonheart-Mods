...
public class RenderAirshipV4DiamondNormal extends Render<EntityAirshipV4DiamondNormal> {
    ...
    public RenderAirshipV4DiamondNormal(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4DiamondNormal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4DiamondNormal entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4DiamondNormal entity)
    {
