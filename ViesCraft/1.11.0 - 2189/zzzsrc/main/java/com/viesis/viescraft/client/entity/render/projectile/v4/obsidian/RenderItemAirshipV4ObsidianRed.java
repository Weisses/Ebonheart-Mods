...
public class RenderItemAirshipV4ObsidianRed extends Render<EntityItemAirshipV4ObsidianRed> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4ObsidianRed(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4ObsidianRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4ObsidianRed entity)
    {
