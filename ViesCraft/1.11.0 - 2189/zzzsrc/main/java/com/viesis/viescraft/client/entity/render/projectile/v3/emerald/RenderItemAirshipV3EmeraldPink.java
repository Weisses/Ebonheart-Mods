...
public class RenderItemAirshipV3EmeraldPink extends Render<EntityItemAirshipV3EmeraldPink> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3EmeraldPink(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3EmeraldPink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3EmeraldPink entity)
    {
