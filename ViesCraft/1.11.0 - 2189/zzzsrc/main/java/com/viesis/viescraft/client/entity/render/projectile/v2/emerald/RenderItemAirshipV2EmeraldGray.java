...
public class RenderItemAirshipV2EmeraldGray extends Render<EntityItemAirshipV2EmeraldGray> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2EmeraldGray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2EmeraldGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2EmeraldGray entity)
    {
