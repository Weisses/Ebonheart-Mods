...
public class RenderAirshipV3ObsidianRed extends Render<EntityAirshipV3ObsidianRed> {
    ...
    public RenderAirshipV3ObsidianRed(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3ObsidianRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3ObsidianRed entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3ObsidianRed entity)
    {
