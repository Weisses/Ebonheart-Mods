...
public class RenderAirshipV3ObsidianPink extends Render<EntityAirshipV3ObsidianPink> {
    ...
    public RenderAirshipV3ObsidianPink(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3ObsidianPink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3ObsidianPink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3ObsidianPink entity)
    {
