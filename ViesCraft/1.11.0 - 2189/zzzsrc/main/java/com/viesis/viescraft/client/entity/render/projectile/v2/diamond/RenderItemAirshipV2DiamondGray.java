...
public class RenderItemAirshipV2DiamondGray extends Render<EntityItemAirshipV2DiamondGray> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2DiamondGray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2DiamondGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2DiamondGray entity)
    {
