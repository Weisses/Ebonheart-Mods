...
public class RenderAirshipV4GoldLime extends Render<EntityAirshipV4GoldLime> {
    ...
    public RenderAirshipV4GoldLime(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4GoldLime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4GoldLime entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4GoldLime entity)
    {
