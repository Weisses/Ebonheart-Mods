package com.viesis.viescraft.client.entity.render.airshipcolors.v4.diamond;
...
public class RenderAirshipV4DiamondAdmin extends Render<EntityAirshipV4DiamondAdmin> {
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		...
		new ResourceLocation(Reference.MOD_ID, "textures/models/v4/airship_v4_frame_admin_diamond.png")
	};
    ...
    public RenderAirshipV4DiamondAdmin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4DiamondAdmin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4DiamondAdmin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4DiamondAdmin entity)
    {
