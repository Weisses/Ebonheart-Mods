...
public class ItemV1LapisLazuli extends ItemAirshipCore {
	
	private static final String[] ITEM_COLOR = new String[] 
	{
		"Plain",
		"Black",
		"Blue",
	...
	public ItemV1LapisLazuli(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV1Wood0 entityairship = new EntityItemV1Wood0(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return ("Oak " + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v1AirshipName)).trim();
    }
}
