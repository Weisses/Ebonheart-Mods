...
public class RenderAirshipV2RedstonePurple extends Render<EntityAirshipV2RedstonePurple> {
    ...
    public RenderAirshipV2RedstonePurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2RedstonePurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2RedstonePurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2RedstonePurple entity)
    {
