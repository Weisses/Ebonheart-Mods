...
public class RenderAirshipV2RedstoneLightBlue extends Render<EntityAirshipV2RedstoneLightBlue> {
    ...
    public RenderAirshipV2RedstoneLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2RedstoneLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2RedstoneLightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2RedstoneLightBlue entity)
    {
