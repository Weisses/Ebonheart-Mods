...
public class RenderAirshipV4LapisLazuliPink extends Render<EntityAirshipV4LapisLazuliPink> {
    ...
    public RenderAirshipV4LapisLazuliPink(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4LapisLazuliPink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4LapisLazuliPink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4LapisLazuliPink entity)
    {
