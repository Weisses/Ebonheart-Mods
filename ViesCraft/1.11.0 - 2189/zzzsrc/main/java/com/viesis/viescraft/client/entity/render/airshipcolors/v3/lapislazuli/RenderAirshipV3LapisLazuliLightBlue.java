...
public class RenderAirshipV3LapisLazuliLightBlue extends Render<EntityAirshipV3LapisLazuliLightBlue> {
    ...
    public RenderAirshipV3LapisLazuliLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3LapisLazuliLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LapisLazuliLightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3LapisLazuliLightBlue entity)
    {
