...
public class RenderAirshipV2IronPurple extends Render<EntityAirshipV2IronPurple> {
    ...
    public RenderAirshipV2IronPurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2IronPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2IronPurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2IronPurple entity)
    {
