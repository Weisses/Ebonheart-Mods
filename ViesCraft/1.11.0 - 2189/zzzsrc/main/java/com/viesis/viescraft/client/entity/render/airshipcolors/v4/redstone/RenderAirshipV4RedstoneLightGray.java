package com.viesis.viescraft.client.entity.render.airshipcolors.v4.redstone;
...
public class RenderAirshipV4RedstoneLightGray extends Render<EntityAirshipV4RedstoneLightGray> {
    ...
    public RenderAirshipV4RedstoneLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4RedstoneLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4RedstoneLightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4RedstoneLightGray entity)
    {
