...
public class RenderItemAirshipV2Wood0Admin extends Render<EntityItemAirshipV2Wood0Admin> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2Wood0Admin(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2Wood0Admin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2Wood0Admin entity)
    {
