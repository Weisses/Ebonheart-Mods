...
public class RenderItemAirshipV2IronBlack extends Render<EntityItemAirshipV2IronBlack> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2IronBlack(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2IronBlack entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2IronBlack entity)
    {
