...
public class RenderAirshipV4IronYellow extends Render<EntityAirshipV4IronYellow> {
    ...
    public RenderAirshipV4IronYellow(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4IronYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4IronYellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4IronYellow entity)
    {
