...
public class RenderAirshipV2GoldPurple extends Render<EntityAirshipV2GoldPurple> {
    ...
    public RenderAirshipV2GoldPurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2GoldPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2GoldPurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2GoldPurple entity)
    {
