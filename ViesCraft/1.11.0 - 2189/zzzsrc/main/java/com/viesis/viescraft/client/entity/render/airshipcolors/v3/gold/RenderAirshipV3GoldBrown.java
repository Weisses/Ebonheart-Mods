...
public class RenderAirshipV3GoldBrown extends Render<EntityAirshipV3GoldBrown> {
    ...
    public RenderAirshipV3GoldBrown(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3GoldBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3GoldBrown entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3GoldBrown entity)
    {
