...
public class RenderItemAirshipV4IronLightGray extends Render<EntityItemAirshipV4IronLightGray> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4IronLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4IronLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4IronLightGray entity)
    {
