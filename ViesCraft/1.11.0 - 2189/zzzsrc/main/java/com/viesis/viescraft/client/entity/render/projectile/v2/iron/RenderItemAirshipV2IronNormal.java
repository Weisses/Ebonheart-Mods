...
public class RenderItemAirshipV2IronNormal extends Render<EntityItemAirshipV2IronNormal> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2IronNormal(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2IronNormal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2IronNormal entity)
    {
