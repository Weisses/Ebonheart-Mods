...
public class RenderAirshipV3RedstonePurple extends Render<EntityAirshipV3RedstonePurple> {
    ...
    public RenderAirshipV3RedstonePurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3RedstonePurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3RedstonePurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3RedstonePurple entity)
    {
