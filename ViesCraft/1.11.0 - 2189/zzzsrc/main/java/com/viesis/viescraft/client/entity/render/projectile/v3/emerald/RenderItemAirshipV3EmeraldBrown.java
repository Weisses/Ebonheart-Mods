...
public class RenderItemAirshipV3EmeraldBrown extends Render<EntityItemAirshipV3EmeraldBrown> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3EmeraldBrown(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3EmeraldBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3EmeraldBrown entity)
    {
