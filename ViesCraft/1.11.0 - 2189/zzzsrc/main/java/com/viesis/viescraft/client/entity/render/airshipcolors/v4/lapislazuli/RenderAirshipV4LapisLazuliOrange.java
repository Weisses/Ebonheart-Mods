...
public class RenderAirshipV4LapisLazuliOrange extends Render<EntityAirshipV4LapisLazuliOrange> {
    ...
    public RenderAirshipV4LapisLazuliOrange(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4LapisLazuliOrange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4LapisLazuliOrange entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4LapisLazuliOrange entity)
    {
