...
public class RenderItemAirshipV2Wood0White extends Render<EntityItemAirshipV2Wood0White> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2Wood0White(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2Wood0White entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2Wood0White entity)
    {
