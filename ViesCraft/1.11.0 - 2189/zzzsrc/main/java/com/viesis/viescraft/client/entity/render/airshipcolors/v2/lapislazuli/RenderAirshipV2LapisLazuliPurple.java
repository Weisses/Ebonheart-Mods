...
public class RenderAirshipV2LapisLazuliPurple extends Render<EntityAirshipV2LapisLazuliPurple> {
    ...
    public RenderAirshipV2LapisLazuliPurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2LapisLazuliPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2LapisLazuliPurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2LapisLazuliPurple entity)
    {
