...
public class ItemAirshipV1Wood0Admin extends ItemAirshipCoreV1 {
	
	public ItemAirshipV1Wood0Admin() 
	{
		ItemHelper.setItemName(this, "v1/wood0/item_airship_v1_wood0_admin");
	}
    ...
    {
        return ("" + I18n.translateToLocal(Wood0 + Admin + ViesCraftConfig.v1AirshipName)).trim();
    }
}
