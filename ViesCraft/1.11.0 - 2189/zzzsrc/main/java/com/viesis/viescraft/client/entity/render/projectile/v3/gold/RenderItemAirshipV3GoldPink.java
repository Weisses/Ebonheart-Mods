...
public class RenderItemAirshipV3GoldPink extends Render<EntityItemAirshipV3GoldPink> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3GoldPink(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3GoldPink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3GoldPink entity)
    {
