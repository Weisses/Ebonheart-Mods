...
public class RenderAirshipV3LapisLazuliWhite extends Render<EntityAirshipV3LapisLazuliWhite> {
    ...
    public RenderAirshipV3LapisLazuliWhite(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3LapisLazuliWhite entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LapisLazuliWhite entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3LapisLazuliWhite entity)
    {
