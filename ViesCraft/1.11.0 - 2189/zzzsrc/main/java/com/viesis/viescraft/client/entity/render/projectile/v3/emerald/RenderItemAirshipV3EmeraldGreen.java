...
public class RenderItemAirshipV3EmeraldGreen extends Render<EntityItemAirshipV3EmeraldGreen> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3EmeraldGreen(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3EmeraldGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3EmeraldGreen entity)
    {
