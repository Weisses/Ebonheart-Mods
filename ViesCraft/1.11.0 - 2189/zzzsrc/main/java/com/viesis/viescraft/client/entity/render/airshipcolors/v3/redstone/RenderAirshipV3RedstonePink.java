...
public class RenderAirshipV3RedstonePink extends Render<EntityAirshipV3RedstonePink> {
    ...
    public RenderAirshipV3RedstonePink(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3RedstonePink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3RedstonePink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3RedstonePink entity)
    {
