...
public class RenderItemAirshipV3IronLightGray extends Render<EntityItemAirshipV3IronLightGray> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3IronLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3IronLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3IronLightGray entity)
    {
