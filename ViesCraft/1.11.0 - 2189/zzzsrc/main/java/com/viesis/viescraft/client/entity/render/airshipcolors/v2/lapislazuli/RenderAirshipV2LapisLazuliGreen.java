...
public class RenderAirshipV2LapisLazuliGreen extends Render<EntityAirshipV2LapisLazuliGreen> {
    ...
    public RenderAirshipV2LapisLazuliGreen(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2LapisLazuliGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2LapisLazuliGreen entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2LapisLazuliGreen entity)
    {
