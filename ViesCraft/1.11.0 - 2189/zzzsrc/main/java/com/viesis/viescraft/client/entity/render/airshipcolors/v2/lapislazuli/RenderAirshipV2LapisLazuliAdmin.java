package com.viesis.viescraft.client.entity.render.airshipcolors.v2.lapislazuli;
...
public class RenderAirshipV2LapisLazuliAdmin extends Render<EntityAirshipV2LapisLazuliAdmin> {
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		...
		new ResourceLocation(Reference.MOD_ID, "textures/models/v2/airship_v2_frame_admin_lapislazuli.png")
	};
    ...
    public RenderAirshipV2LapisLazuliAdmin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2LapisLazuliAdmin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2LapisLazuliAdmin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2LapisLazuliAdmin entity)
    {
