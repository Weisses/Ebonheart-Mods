...
public class RenderAirshipV4EmeraldRed extends Render<EntityAirshipV4EmeraldRed> {
    ...
    public RenderAirshipV4EmeraldRed(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4EmeraldRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4EmeraldRed entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4EmeraldRed entity)
    {
