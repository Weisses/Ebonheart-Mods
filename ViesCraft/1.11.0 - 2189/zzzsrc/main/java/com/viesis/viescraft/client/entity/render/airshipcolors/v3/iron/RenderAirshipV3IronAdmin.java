package com.viesis.viescraft.client.entity.render.airshipcolors.v3.iron;
...
public class RenderAirshipV3IronAdmin extends Render<EntityAirshipV3IronAdmin> {
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		...
		new ResourceLocation(Reference.MOD_ID, "textures/models/v3/airship_v3_frame_admin_iron.png")
	};
    ...
    public RenderAirshipV3IronAdmin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3IronAdmin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3IronAdmin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3IronAdmin entity)
    {
