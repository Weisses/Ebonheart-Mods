...
public class RenderAirshipV3IronOrange extends Render<EntityAirshipV3IronOrange> {
    ...
    public RenderAirshipV3IronOrange(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3IronOrange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3IronOrange entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3IronOrange entity)
    {
