...
public class RenderItemAirshipV2IronCyan extends Render<EntityItemAirshipV2IronCyan> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2IronCyan(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2IronCyan entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2IronCyan entity)
    {
