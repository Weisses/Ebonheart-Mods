...
public class RenderAirshipV2LapisLazuliLime extends Render<EntityAirshipV2LapisLazuliLime> {
    ...
    public RenderAirshipV2LapisLazuliLime(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2LapisLazuliLime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2LapisLazuliLime entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2LapisLazuliLime entity)
    {
