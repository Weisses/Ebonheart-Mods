...
public class RenderAirshipV4RedstoneGray extends Render<EntityAirshipV4RedstoneGray> {
    ...
    public RenderAirshipV4RedstoneGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4RedstoneGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4RedstoneGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4RedstoneGray entity)
    {
