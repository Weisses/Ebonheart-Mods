...
public class RenderAirshipV3EmeraldRed extends Render<EntityAirshipV3EmeraldRed> {
    ...
    public RenderAirshipV3EmeraldRed(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3EmeraldRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3EmeraldRed entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3EmeraldRed entity)
    {
