...
public class RenderAirshipV4IronBrown extends Render<EntityAirshipV4IronBrown> {
    ...
    public RenderAirshipV4IronBrown(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4IronBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4IronBrown entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4IronBrown entity)
    {
