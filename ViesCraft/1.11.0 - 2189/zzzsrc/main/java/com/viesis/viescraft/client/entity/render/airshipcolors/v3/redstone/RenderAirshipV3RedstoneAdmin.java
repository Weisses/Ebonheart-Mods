package com.viesis.viescraft.client.entity.render.airshipcolors.v3.redstone;
...
public class RenderAirshipV3RedstoneAdmin extends Render<EntityAirshipV3RedstoneAdmin> {
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		...
		new ResourceLocation(Reference.MOD_ID, "textures/models/v3/airship_v3_frame_admin_redstone.png")
	};
    ...
    public RenderAirshipV3RedstoneAdmin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3RedstoneAdmin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3RedstoneAdmin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3RedstoneAdmin entity)
    {
