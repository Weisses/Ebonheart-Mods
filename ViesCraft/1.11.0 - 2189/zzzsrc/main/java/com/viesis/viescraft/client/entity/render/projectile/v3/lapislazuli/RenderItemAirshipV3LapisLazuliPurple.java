...
public class RenderItemAirshipV3LapisLazuliPurple extends Render<EntityItemAirshipV3LapisLazuliPurple> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3LapisLazuliPurple(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3LapisLazuliPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3LapisLazuliPurple entity)
    {
