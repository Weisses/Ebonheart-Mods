...
public class RenderItemAirshipV2EmeraldCyan extends Render<EntityItemAirshipV2EmeraldCyan> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2EmeraldCyan(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2EmeraldCyan entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2EmeraldCyan entity)
    {
