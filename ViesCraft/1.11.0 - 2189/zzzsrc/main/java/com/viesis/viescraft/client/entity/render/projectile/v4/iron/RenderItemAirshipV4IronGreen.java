...
public class RenderItemAirshipV4IronGreen extends Render<EntityItemAirshipV4IronGreen> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4IronGreen(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4IronGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4IronGreen entity)
    {
