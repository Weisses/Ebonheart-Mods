...
public class RenderItemAirshipV2EmeraldBlack extends Render<EntityItemAirshipV2EmeraldBlack> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2EmeraldBlack(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2EmeraldBlack entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2EmeraldBlack entity)
    {
