...
public class EntityV1Iron extends EntityAirshipV1Core {
	
	public EntityV1Iron(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV1Iron(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
