...
public class RenderAirshipV2ObsidianMagenta extends Render<EntityAirshipV2ObsidianMagenta> {
    ...
    public RenderAirshipV2ObsidianMagenta(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2ObsidianMagenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2ObsidianMagenta entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2ObsidianMagenta entity)
    {
