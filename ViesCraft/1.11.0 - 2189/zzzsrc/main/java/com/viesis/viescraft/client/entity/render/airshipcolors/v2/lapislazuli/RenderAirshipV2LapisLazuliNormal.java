...
public class RenderAirshipV2LapisLazuliNormal extends Render<EntityAirshipV2LapisLazuliNormal> {
    ...
    public RenderAirshipV2LapisLazuliNormal(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2LapisLazuliNormal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2LapisLazuliNormal entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2LapisLazuliNormal entity)
    {
