package com.viesis.viescraft.client.entity.render.airshipcolors.v4.obsidian;
...
public class RenderAirshipV4ObsidianLightBlue extends Render<EntityAirshipV4ObsidianLightBlue> {
    ...
    public RenderAirshipV4ObsidianLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4ObsidianLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4ObsidianLightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4ObsidianLightBlue entity)
    {
