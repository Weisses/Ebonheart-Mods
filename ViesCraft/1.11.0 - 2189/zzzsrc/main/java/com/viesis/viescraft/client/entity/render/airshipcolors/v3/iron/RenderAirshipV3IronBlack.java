...
public class RenderAirshipV3IronBlack extends Render<EntityAirshipV3IronBlack> {
    ...
    public RenderAirshipV3IronBlack(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3IronBlack entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3IronBlack entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3IronBlack entity)
    {
