package com.viesis.viescraft.client.entity.render.airshipcolors.v2.wood0;
...
public class RenderAirshipV2Wood0Admin extends Render<EntityAirshipV2Wood0Admin> {
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		...
		new ResourceLocation(Reference.MOD_ID, "textures/models/v2/airship_v2_frame_admin_wood0.png")
	};
    ...
    public RenderAirshipV2Wood0Admin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2Wood0Admin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Wood0Admin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2Wood0Admin entity)
    {
