...
public class RenderAirshipV4GoldBlue extends Render<EntityAirshipV4GoldBlue> {
    ...
    public RenderAirshipV4GoldBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4GoldBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4GoldBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4GoldBlue entity)
    {
