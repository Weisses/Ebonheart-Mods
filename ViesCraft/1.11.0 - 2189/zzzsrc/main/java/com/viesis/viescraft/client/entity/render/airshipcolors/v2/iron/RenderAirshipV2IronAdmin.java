package com.viesis.viescraft.client.entity.render.airshipcolors.v2.iron;
...
public class RenderAirshipV2IronAdmin extends Render<EntityAirshipV2IronAdmin> {
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		...
		new ResourceLocation(Reference.MOD_ID, "textures/models/v2/airship_v2_frame_admin_iron.png")
	};
    ...
    public RenderAirshipV2IronAdmin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2IronAdmin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2IronAdmin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2IronAdmin entity)
    {
