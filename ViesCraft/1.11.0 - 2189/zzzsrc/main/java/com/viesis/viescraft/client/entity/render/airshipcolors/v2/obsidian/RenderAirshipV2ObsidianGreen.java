...
public class RenderAirshipV2ObsidianGreen extends Render<EntityAirshipV2ObsidianGreen> {
    ...
    public RenderAirshipV2ObsidianGreen(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2ObsidianGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2ObsidianGreen entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2ObsidianGreen entity)
    {
