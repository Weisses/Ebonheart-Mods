...
public class RenderAirshipV4GoldPurple extends Render<EntityAirshipV4GoldPurple> {
    ...
    public RenderAirshipV4GoldPurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4GoldPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4GoldPurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4GoldPurple entity)
    {
