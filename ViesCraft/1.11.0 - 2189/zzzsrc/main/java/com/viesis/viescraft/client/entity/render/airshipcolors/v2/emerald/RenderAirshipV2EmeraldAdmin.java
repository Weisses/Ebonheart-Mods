package com.viesis.viescraft.client.entity.render.airshipcolors.v2.emerald;
...
public class RenderAirshipV2EmeraldAdmin extends Render<EntityAirshipV2EmeraldAdmin> {
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		...
		new ResourceLocation(Reference.MOD_ID, "textures/models/v2/airship_v2_frame_admin_emerald.png")
	};
    ...
    public RenderAirshipV2EmeraldAdmin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2EmeraldAdmin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2EmeraldAdmin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2EmeraldAdmin entity)
    {
