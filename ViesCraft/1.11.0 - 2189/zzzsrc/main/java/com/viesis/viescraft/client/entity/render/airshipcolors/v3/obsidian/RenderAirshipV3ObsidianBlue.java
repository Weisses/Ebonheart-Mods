...
public class RenderAirshipV3ObsidianBlue extends Render<EntityAirshipV3ObsidianBlue> {
    ...
    public RenderAirshipV3ObsidianBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3ObsidianBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3ObsidianBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3ObsidianBlue entity)
    {
