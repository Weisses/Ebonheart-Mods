...
public class RenderItemAirshipV2GoldOrange extends Render<EntityItemAirshipV2GoldOrange> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2GoldOrange(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2GoldOrange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2GoldOrange entity)
    {
