...
public class RenderAirshipV3GoldOrange extends Render<EntityAirshipV3GoldOrange> {
    ...
    public RenderAirshipV3GoldOrange(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3GoldOrange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3GoldOrange entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3GoldOrange entity)
    {
