...
public class RenderItemAirshipV4DiamondLime extends Render<EntityItemAirshipV4DiamondLime> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4DiamondLime(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4DiamondLime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4DiamondLime entity)
    {
