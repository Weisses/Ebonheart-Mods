...
public class RenderAirshipV4LapisLazuliMagenta extends Render<EntityAirshipV4LapisLazuliMagenta> {
    ...
    public RenderAirshipV4LapisLazuliMagenta(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4LapisLazuliMagenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4LapisLazuliMagenta entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4LapisLazuliMagenta entity)
    {
