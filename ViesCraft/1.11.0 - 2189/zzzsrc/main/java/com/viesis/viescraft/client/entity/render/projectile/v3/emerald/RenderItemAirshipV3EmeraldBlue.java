...
public class RenderItemAirshipV3EmeraldBlue extends Render<EntityItemAirshipV3EmeraldBlue> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3EmeraldBlue(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3EmeraldBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3EmeraldBlue entity)
    {
