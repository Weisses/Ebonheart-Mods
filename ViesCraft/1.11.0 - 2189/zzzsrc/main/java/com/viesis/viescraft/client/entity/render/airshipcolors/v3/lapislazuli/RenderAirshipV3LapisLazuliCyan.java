...
public class RenderAirshipV3LapisLazuliCyan extends Render<EntityAirshipV3LapisLazuliCyan> {
    ...
    public RenderAirshipV3LapisLazuliCyan(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3LapisLazuliCyan entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LapisLazuliCyan entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3LapisLazuliCyan entity)
    {
