...
public class RenderItemAirshipV4IronRed extends Render<EntityItemAirshipV4IronRed> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4IronRed(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4IronRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4IronRed entity)
    {
