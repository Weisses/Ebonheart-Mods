...
public class RenderAirshipV3DiamondLime extends Render<EntityAirshipV3DiamondLime> {
    ...
    public RenderAirshipV3DiamondLime(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3DiamondLime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3DiamondLime entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3DiamondLime entity)
    {
