...
public class RenderAirshipV3LapisLazuliBlue extends Render<EntityAirshipV3LapisLazuliBlue> {
    ...
    public RenderAirshipV3LapisLazuliBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3LapisLazuliBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LapisLazuliBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3LapisLazuliBlue entity)
    {
