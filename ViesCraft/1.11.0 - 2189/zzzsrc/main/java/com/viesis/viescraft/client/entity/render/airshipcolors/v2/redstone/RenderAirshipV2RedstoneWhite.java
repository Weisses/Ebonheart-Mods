...
public class RenderAirshipV2RedstoneWhite extends Render<EntityAirshipV2RedstoneWhite> {
    ...
    public RenderAirshipV2RedstoneWhite(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2RedstoneWhite entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2RedstoneWhite entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2RedstoneWhite entity)
    {
