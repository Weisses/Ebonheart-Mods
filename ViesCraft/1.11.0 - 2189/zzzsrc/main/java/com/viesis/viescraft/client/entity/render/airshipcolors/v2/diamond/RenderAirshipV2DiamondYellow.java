...
public class RenderAirshipV2DiamondYellow extends Render<EntityAirshipV2DiamondYellow> {
    ...
    public RenderAirshipV2DiamondYellow(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2DiamondYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2DiamondYellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2DiamondYellow entity)
    {
