...
public class RenderAirshipV2RedstoneBrown extends Render<EntityAirshipV2RedstoneBrown> {
    ...
    public RenderAirshipV2RedstoneBrown(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2RedstoneBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2RedstoneBrown entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2RedstoneBrown entity)
    {
