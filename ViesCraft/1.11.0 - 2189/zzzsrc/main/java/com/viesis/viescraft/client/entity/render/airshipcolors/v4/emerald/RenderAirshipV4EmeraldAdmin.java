package com.viesis.viescraft.client.entity.render.airshipcolors.v4.emerald;
...
public class RenderAirshipV4EmeraldAdmin extends Render<EntityAirshipV4EmeraldAdmin> {
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		...
		new ResourceLocation(Reference.MOD_ID, "textures/models/v4/airship_v4_frame_admin_emerald.png")
	};
    ...
    public RenderAirshipV4EmeraldAdmin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4EmeraldAdmin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4EmeraldAdmin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4EmeraldAdmin entity)
    {
