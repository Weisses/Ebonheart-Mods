...
public class RenderAirshipV3LapisLazuliNormal extends Render<EntityAirshipV3LapisLazuliNormal> {
    ...
    public RenderAirshipV3LapisLazuliNormal(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3LapisLazuliNormal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LapisLazuliNormal entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3LapisLazuliNormal entity)
    {
