...
public class RenderItemAirshipV3DiamondRed extends Render<EntityItemAirshipV3DiamondRed> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3DiamondRed(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3DiamondRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3DiamondRed entity)
    {
