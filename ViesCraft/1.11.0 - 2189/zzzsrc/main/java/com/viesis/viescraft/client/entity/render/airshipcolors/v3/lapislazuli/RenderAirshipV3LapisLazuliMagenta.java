...
public class RenderAirshipV3LapisLazuliMagenta extends Render<EntityAirshipV3LapisLazuliMagenta> {
    ...
    public RenderAirshipV3LapisLazuliMagenta(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3LapisLazuliMagenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LapisLazuliMagenta entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3LapisLazuliMagenta entity)
    {
