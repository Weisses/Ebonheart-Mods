...
public class RenderAirshipV2LapisLazuliBrown extends Render<EntityAirshipV2LapisLazuliBrown> {
    ...
    public RenderAirshipV2LapisLazuliBrown(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2LapisLazuliBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2LapisLazuliBrown entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2LapisLazuliBrown entity)
    {
