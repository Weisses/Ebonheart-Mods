package com.viesis.viescraft.client.entity.render.projectile.v3.gold;
...
public class RenderItemAirshipV3GoldLightBlue extends Render<EntityItemAirshipV3GoldLightBlue> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3GoldLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3GoldLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3GoldLightBlue entity)
    {
