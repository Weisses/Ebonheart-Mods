...
public class RenderAirshipV4RedstonePink extends Render<EntityAirshipV4RedstonePink> {
    ...
    public RenderAirshipV4RedstonePink(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4RedstonePink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4RedstonePink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4RedstonePink entity)
    {
