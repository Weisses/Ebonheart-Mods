...
public class RenderAirshipV2EmeraldLightBlue extends Render<EntityAirshipV2EmeraldLightBlue> {
    ...
    public RenderAirshipV2EmeraldLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2EmeraldLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2EmeraldLightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2EmeraldLightBlue entity)
    {
