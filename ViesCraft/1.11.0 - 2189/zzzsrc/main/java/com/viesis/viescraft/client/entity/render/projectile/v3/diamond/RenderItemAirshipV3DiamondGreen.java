...
public class RenderItemAirshipV3DiamondGreen extends Render<EntityItemAirshipV3DiamondGreen> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3DiamondGreen(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3DiamondGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3DiamondGreen entity)
    {
