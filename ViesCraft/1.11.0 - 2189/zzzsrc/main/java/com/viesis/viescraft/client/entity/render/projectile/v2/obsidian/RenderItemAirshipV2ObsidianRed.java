...
public class RenderItemAirshipV2ObsidianRed extends Render<EntityItemAirshipV2ObsidianRed> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2ObsidianRed(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2ObsidianRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2ObsidianRed entity)
    {
