package com.viesis.viescraft.client.entity.render.airshipcolors.v3.lapislazuli;
...
public class RenderAirshipV3LapisLazuliLightGray extends Render<EntityAirshipV3LapisLazuliLightGray> {
    ...
    public RenderAirshipV3LapisLazuliLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3LapisLazuliLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LapisLazuliLightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3LapisLazuliLightGray entity)
    {
