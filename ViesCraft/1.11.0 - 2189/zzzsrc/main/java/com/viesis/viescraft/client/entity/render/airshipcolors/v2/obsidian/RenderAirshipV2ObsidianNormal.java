...
public class RenderAirshipV2ObsidianNormal extends Render<EntityAirshipV2ObsidianNormal> {
    ...
    public RenderAirshipV2ObsidianNormal(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2ObsidianNormal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2ObsidianNormal entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2ObsidianNormal entity)
    {
