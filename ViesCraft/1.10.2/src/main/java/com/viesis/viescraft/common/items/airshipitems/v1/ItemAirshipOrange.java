...
public class ItemAirshipOrange extends ItemAirshipCore {
	
	public ItemAirshipOrange() 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipOrange entityairship = new EntityItemAirshipOrange(worldIn, playerIn);
