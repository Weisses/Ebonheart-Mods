...
public class ItemAirshipPurple extends ItemAirshipCore {
	
	public ItemAirshipPurple() 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipPurple entityairship = new EntityItemAirshipPurple(worldIn, playerIn);
