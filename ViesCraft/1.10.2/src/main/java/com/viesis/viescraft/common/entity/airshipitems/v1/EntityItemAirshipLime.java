...
public class EntityItemAirshipLime extends EntityItemAirshipCore {
	
    public EntityItemAirshipLime(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipLime(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipLime(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipLime(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
