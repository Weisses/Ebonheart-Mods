...
public class RenderAirshipLightGray extends Render<EntityAirshipLightGray> {
     ...
     */
    public void doRender(EntityAirshipLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipLightGray p_188311_1_, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipLightGray entity)
    {
