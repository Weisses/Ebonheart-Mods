...
public class EntityItemAirshipBlue extends EntityItemAirshipCore {
	
    public EntityItemAirshipBlue(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipBlue(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipBlue(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipBlue(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
