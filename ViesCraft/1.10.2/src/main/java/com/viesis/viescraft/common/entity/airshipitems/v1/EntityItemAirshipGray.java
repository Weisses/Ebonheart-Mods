...
public class EntityItemAirshipGray extends EntityItemAirshipCore {
	
    public EntityItemAirshipGray(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipGray(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipGray(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipGray(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
