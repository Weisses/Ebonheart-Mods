...
public class EntityItemAirshipRed extends EntityItemAirshipCore {
	
    public EntityItemAirshipRed(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipRed(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipRed(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipRed(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
