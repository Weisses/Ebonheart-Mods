...
public class EntityItemAirshipYellow extends EntityItemAirshipCore {
	
    public EntityItemAirshipYellow(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipYellow(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipYellow(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipYellow(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
