...
public class ItemAirshipWhite extends ItemAirshipCore {
	
	public ItemAirshipWhite() 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipWhite entityairship = new EntityItemAirshipWhite(worldIn, playerIn);
