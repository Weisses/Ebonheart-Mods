...
public class ItemAirshipBrown extends ItemAirshipCore {
	
	public ItemAirshipBrown() 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipBrown entityairship = new EntityItemAirshipBrown(worldIn, playerIn);
