...
public class RenderAirshipGray extends Render<EntityAirshipGray> {
     ...
     */
    public void doRender(EntityAirshipGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipGray p_188311_1_, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipGray entity)
    {
