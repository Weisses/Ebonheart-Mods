...
public class RenderItemAirshipBrown extends Render<EntityItemAirshipBrown> {
     ...
     */
    public void doRender(EntityItemAirshipBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipBrown entity)
    {
