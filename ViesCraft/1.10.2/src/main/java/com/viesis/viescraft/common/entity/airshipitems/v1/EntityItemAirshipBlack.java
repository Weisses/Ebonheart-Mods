...
public class EntityItemAirshipBlack extends EntityItemAirshipCore {
	
    public EntityItemAirshipBlack(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipBlack(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipBlack(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipBlack(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
