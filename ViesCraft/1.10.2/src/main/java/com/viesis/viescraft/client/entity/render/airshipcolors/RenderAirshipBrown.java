...
public class RenderAirshipBrown extends Render<EntityAirshipBrown> {
     ...
     */
    public void doRender(EntityAirshipBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipBrown p_188311_1_, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipBrown entity)
    {
