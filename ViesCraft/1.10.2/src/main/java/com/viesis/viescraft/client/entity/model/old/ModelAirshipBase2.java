package com.viesis.viescraft.client.entity.model.old;
...
public class ModelAirshipBase2 extends ModelBase {
	...
	public ModelAirshipBase2()
	{
	    ...
	    Engine_R2b.setRotationPoint(10F, -4F, 3F);
	    ...
	    Engine_L2b.setRotationPoint(-12F, -4F, 3F);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
	{
		...
		EntityAirshipBase2 entityairship = (EntityAirshipBase2)entity;
		//String test = entityairship.getUniqueID().toString();
		//String test2 = player.getRidingEntity().getUniqueID().toString();
		//double airshipX = player.getRidingEntity().motionX;
		//double airshipY = player.getRidingEntity().motionY;
		//double airshipZ = player.getRidingEntity().motionZ;
		...
		if(ViesCraftConfig.modelAnimation)
		{
			...
			this.Propeller_1a.rotateAngleZ += (bladespin * entityairship.bladespeed);
        	this.Propeller_1b.rotateAngleZ += (bladespin * entityairship.bladespeed);
        	this.Propeller_1c.rotateAngleZ += (bladespin * entityairship.bladespeed);
        	this.Propeller_R1a.rotateAngleZ += (bladespin * entityairship.bladespeed);
        	this.Propeller_R1b.rotateAngleZ += (bladespin * entityairship.bladespeed);
        	this.Propeller_R1c.rotateAngleZ += (bladespin * entityairship.bladespeed);
        	this.Propeller_L1a.rotateAngleZ += (bladespin * entityairship.bladespeed);
        	this.Propeller_L1b.rotateAngleZ += (bladespin * entityairship.bladespeed);
        	this.Propeller_L1c.rotateAngleZ += (bladespin * entityairship.bladespeed);
			...
			if (//test == 
					...
					//.getUniqueID()
					//|| test != null
			//&& entityairship.isRidingOrBeingRiddenBy(player)
			//&& player.isRiding()
			
			//entityairship.forwardInputDown
			//|| entityairship.backInputDown
			//|| entityairship.leftInputDown
			//|| entityairship.rightInputDown
			//|| entityairship.upInputDown
			//|| entityairship.downInputDown
			//&&	
			//&& 
			player.getRidingEntity() == entityairship
			
					//player.isRidingOrBeingRiddenBy(entityairship)
					//player.getRidingEntity() == entityairship
			&&		entityairship.isRidingOrBeingRiddenBy(player)
					//&& 
					//player
	    	...
	    	{
	    		this.Propeller_1a.rotateAngleZ += (bladespin * .5);
	        	this.Propeller_1b.rotateAngleZ += (bladespin * .5);
	        	this.Propeller_1c.rotateAngleZ += (bladespin * .5);
	        	this.Propeller_R1a.rotateAngleZ += (bladespin * .5);
	        	this.Propeller_R1b.rotateAngleZ += (bladespin * .5);
	        	this.Propeller_R1c.rotateAngleZ += (bladespin * .5);
	        	this.Propeller_L1a.rotateAngleZ += (bladespin * .5);
	        	this.Propeller_L1b.rotateAngleZ += (bladespin * .5);
	        	this.Propeller_L1c.rotateAngleZ += (bladespin * .5);
	    	}
