...
public class ItemAirshipLightGray extends ItemAirshipCore {
	
	public ItemAirshipLightGray() 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipLightGray entityairship = new EntityItemAirshipLightGray(worldIn, playerIn);
