...
public class EntityItemAirshipLightBlue extends EntityItemAirshipCore {
	
    public EntityItemAirshipLightBlue(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipLightBlue(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipLightBlue(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipLightBlue(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
