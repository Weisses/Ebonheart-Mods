...
public class EntityAirshipBase extends EntityAirshipBaseVC implements IInventoryChangedListener, IJumpingMount
{
    ...
    private static final DataParameter<Byte> STATUS = EntityDataManager.<Byte>createKey(EntityAirshipBase.class, DataSerializers.BYTE);
    ...
    private static final DataParameter<Integer> HORSE_ARMOR = EntityDataManager.<Integer>createKey(EntityAirshipBase.class, DataSerializers.VARINT);
