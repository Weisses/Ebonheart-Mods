...
public class ItemAirshipBlue extends ItemAirshipCore {
	
	public ItemAirshipBlue() 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipBlue entityairship = new EntityItemAirshipBlue(worldIn, playerIn);
