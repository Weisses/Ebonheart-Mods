...
public class RenderAirshipWhite extends Render<EntityAirshipWhite> {
    ...
    public RenderAirshipWhite(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipWhite entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipWhite p_188311_1_, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipWhite entity)
    {
