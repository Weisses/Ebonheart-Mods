...
public class EntityItemAirshipNormal extends EntityItemAirshipCore {
	
    public EntityItemAirshipNormal(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipNormal(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipNormal(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
