...
public class EntityItemAirshipWhite extends EntityItemAirshipCore {
	
    public EntityItemAirshipWhite(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipWhite(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipWhite(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipWhite(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
