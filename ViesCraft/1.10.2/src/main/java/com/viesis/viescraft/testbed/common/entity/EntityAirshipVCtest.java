...
public class EntityAirshipVCtest extends EntityAirshipBaseVC  implements IInventoryChangedListener, IJumpingMount
{
    private static final Predicate<Entity> IS_HORSE_BREEDING = new Predicate<Entity>()
    {
        public boolean apply(@Nullable Entity p_apply_1_)
        {
            return p_apply_1_ instanceof EntityAirshipVCtest && ((EntityAirshipVCtest)p_apply_1_).isBreeding();
        }
    };
    ...
    private static final DataParameter<Byte> STATUS = EntityDataManager.<Byte>createKey(EntityAirshipVCtest.class, DataSerializers.BYTE);
    private static final DataParameter<Integer> HORSE_TYPE = EntityDataManager.<Integer>createKey(EntityAirshipVCtest.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> HORSE_VARIANT = EntityDataManager.<Integer>createKey(EntityAirshipVCtest.class, DataSerializers.VARINT);
    private static final DataParameter<Optional<UUID>> OWNER_UNIQUE_ID = EntityDataManager.<Optional<UUID>>createKey(EntityAirshipVCtest.class, DataSerializers.OPTIONAL_UNIQUE_ID);
    private static final DataParameter<Integer> HORSE_ARMOR = EntityDataManager.<Integer>createKey(EntityAirshipVCtest.class, DataSerializers.VARINT);
    ...
    public EntityAirshipVCtest(World worldIn)
    {
        super(worldIn);
    ...
    protected EntityAirshipVCtest getClosestHorse(Entity entityIn, double distance)
    {
        ...
        return (EntityAirshipVCtest)entity;
    }
...
*/
    ...
    public void onLivingUpdate()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                EntityAirshipVCtest EntityAirshipVCtest = this.getClosestHorse(this, 16.0D);

                if (EntityAirshipVCtest != null && this.getDistanceSqToEntity(EntityAirshipVCtest) > 4.0D)
                {
                    this.navigator.getPathToEntityLiving(EntityAirshipVCtest);
                }
            }
    ...
    {
        EntityLiving.func_189752_a(p_189803_0_, "EntityAirshipVCtest");
        p_189803_0_.registerWalker(FixTypes.ENTITY, new ItemStackDataLists("EntityAirshipVCtest", new String[] {"Items"}));
        p_189803_0_.registerWalker(FixTypes.ENTITY, new ItemStackData("EntityAirshipVCtest", new String[] {"ArmorItem", "SaddleItem"}));
    }
...
/**    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        {
            EntityAirshipVCtest EntityAirshipVCtest = (EntityAirshipVCtest)otherAnimal;

            if (this.canMate() && EntityAirshipVCtest.canMate())
            {
                HorseType horsetype = this.getType();
                HorseType horsetype1 = EntityAirshipVCtest.getType();
    ...
    {
        EntityAirshipVCtest EntityAirshipVCtest = (EntityAirshipVCtest)ageable;
        EntityAirshipVCtest EntityAirshipVCtest1 = new EntityAirshipVCtest(this.worldObj);
        HorseType horsetype = this.getType();
        HorseType horsetype1 = EntityAirshipVCtest.getType();
        ...
        if (horsetype2 == HorseType.HORSE)
        {
            ...
            {
                i = EntityAirshipVCtest.getHorseVariant() & 255;
            }
            else
            {
            ...
            {
                i = i | EntityAirshipVCtest.getHorseVariant() & 65280;
            }
            else
            {
            ...
            EntityAirshipVCtest1.setHorseVariant(i);
        }

        EntityAirshipVCtest1.setType(horsetype2);
        ...
        EntityAirshipVCtest1.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(d1 / 3.0D);
        ...
        EntityAirshipVCtest1.getEntityAttribute(JUMP_STRENGTH).setBaseValue(d2 / 3.0D);
        ...
        EntityAirshipVCtest1.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(d0 / 3.0D);
        return EntityAirshipVCtest1;
    }
*/
    /**
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
    {
        ...
        if (livingdata instanceof EntityAirshipVCtest.GroupData)
        {
            horsetype = ((EntityAirshipVCtest.GroupData)livingdata).horseType;
            i = ((EntityAirshipVCtest.GroupData)livingdata).horseVariant & 255 | this.rand.nextInt(5) << 8;
        }
        else
        {
            ...
            livingdata = new EntityAirshipVCtest.GroupData(horsetype, i);
        }
