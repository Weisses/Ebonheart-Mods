...
public class ItemAirshipNormal extends ItemAirshipCore {
	
	public ItemAirshipNormal() 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipNormal entityairship = new EntityItemAirshipNormal(worldIn, playerIn);
