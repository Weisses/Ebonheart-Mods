...
public class RenderAirshipLightBlue extends Render<EntityAirshipLightBlue> {
    ...
    public RenderAirshipLightBlue(RenderManager renderManagerIn)
    {
    ...
    public void setupRotation(EntityAirshipLightBlue p_188311_1_, float p_188311_2_, float p_188311_3_)
    {
