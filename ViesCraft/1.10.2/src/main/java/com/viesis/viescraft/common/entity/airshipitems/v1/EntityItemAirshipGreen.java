...
public class EntityItemAirshipGreen extends EntityItemAirshipCore {
	
    public EntityItemAirshipGreen(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipGreen(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipGreen(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipGreen(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
