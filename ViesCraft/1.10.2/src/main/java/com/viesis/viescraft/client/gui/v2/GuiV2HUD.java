...
public class GuiV2HUD extends Gui {
	...
	{
		this.isAirshipV2 = mc.thePlayer.getRidingEntity() instanceof EntityAirshipV2Core;
		
		if(this.isAirshipV2)
	    {
			this.airshipV2 = (EntityAirshipV2Core) Minecraft.getMinecraft().thePlayer.getRidingEntity();
			...
			{
				int fuelbarwidth1 = (int)((((float) (this.airshipV2.getPowered()) / (ViesCraftConfig.v1FuelBurnTime * 20))) * 110);
			...
			{
				int fuelbarwidth2 = (int)(((float) (this.airshipV2.getItemFuelStackPowered() * 20) / ((ViesCraftConfig.v1FuelBurnTime * 20) * 64)) * 178);
			...
			|| this.airshipV2.getModuleSpeedMinor())
			{
	            ...
	            timer = ((((this.airshipV2.getPowered() + 18) ) / 20) + this.airshipV2.getItemFuelStackPowered()) / 2;
			...
			{
				//Calculation from ticks to seconds.
	            timer = (((this.airshipV2.getPowered() + 18) ) / 20) + this.airshipV2.getItemFuelStackPowered() ;
				remainder = (timer % 3600);
				minutes = remainder / 60;
				seconds = remainder % 60;
				hours = timer / 3600;
