...
public class EntityItemAirshipPink extends EntityItemAirshipCore {
	
    public EntityItemAirshipPink(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipPink(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipPink(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipPink(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
