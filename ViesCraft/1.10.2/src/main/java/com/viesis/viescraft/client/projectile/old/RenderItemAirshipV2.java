...
public class RenderItemAirshipV2 extends Render<EntityItemAirshipV2>
{
     ...
     */
    public void doRender(EntityItemAirshipV2 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2 entity)
    {
