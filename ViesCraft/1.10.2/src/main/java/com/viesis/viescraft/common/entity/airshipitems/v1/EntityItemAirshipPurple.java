...
public class EntityItemAirshipPurple extends EntityItemAirshipCore {
	
    public EntityItemAirshipPurple(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipPurple(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipPurple(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipPurple(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
