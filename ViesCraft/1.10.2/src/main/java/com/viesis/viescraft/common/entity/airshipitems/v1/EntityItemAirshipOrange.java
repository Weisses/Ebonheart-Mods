...
public class EntityItemAirshipOrange extends EntityItemAirshipCore {
	
    public EntityItemAirshipOrange(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipOrange(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipOrange(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipOrange(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
