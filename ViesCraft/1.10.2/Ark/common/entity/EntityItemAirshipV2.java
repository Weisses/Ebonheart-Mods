...
public class EntityItemAirshipV2 extends EntityThrowable {
    ...
    public EntityItemAirshipV2(World worldIn, EntityLivingBase entity)
    {
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipBase2(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
