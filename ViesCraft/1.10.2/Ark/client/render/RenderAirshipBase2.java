...
import com.viesis.viescraft.client.entity.model.old.ModelAirshipBase2;
import com.viesis.viescraft.common.entity.old.EntityAirshipBase2;

@SideOnly(Side.CLIENT)
public class RenderAirshipBase2 extends Render<EntityAirshipBase2>
{
	
	public static final ResourceLocation ENTITY_TEXTURE = new ResourceLocation(Reference.MOD_ID, "textures/models/airship_base_v2.png");
	...
	protected ModelBase modelTest = new ModelAirshipBase2();
	

    public RenderAirshipBase2(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipBase2 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipBase2 p_188311_1_, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipBase2 entity)
    {
