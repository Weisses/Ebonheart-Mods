...
public class RenderItemAirship extends Render<EntityItemAirship>
{
    ...
    public RenderItemAirship(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirship entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirship entity)
    {
