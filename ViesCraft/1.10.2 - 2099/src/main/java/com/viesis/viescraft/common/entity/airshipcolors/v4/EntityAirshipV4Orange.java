...
public class EntityAirshipV4Orange extends EntityAirshipV4Core {
	...
	public EntityAirshipV4Orange(World worldIn)
    {
        super(worldIn);
    ...
    public EntityAirshipV4Orange(World worldIn, double x, double y, double z)
    {
        this(worldIn);
	...
	public String getName() {
		return this.hasCustomName() ? this.customName : "Orange " + ViesCraftConfig.v4AirshipName;
	}
}
