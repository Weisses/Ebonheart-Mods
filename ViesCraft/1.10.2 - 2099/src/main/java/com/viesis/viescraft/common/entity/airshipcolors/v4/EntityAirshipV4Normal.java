...
public class EntityAirshipV4Normal extends EntityAirshipV4Core {
	
	public EntityAirshipV4Normal(World worldIn)
    {
        super(worldIn);
    ...
    public EntityAirshipV4Normal(World worldIn, double x, double y, double z)
    {
        this(worldIn);
