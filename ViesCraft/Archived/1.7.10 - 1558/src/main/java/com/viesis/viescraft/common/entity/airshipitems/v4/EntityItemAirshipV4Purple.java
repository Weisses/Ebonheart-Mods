...
public class EntityItemAirshipV4Purple extends EntityItemAirshipCore {
	
    public EntityItemAirshipV4Purple(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipV4Purple(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipV4Purple(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipV4Purple(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
