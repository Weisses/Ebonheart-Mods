...
public class EntityItemAirshipV2Normal extends EntityItemAirshipCore {
	
    public EntityItemAirshipV2Normal(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipV2Normal(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipV2Normal(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipV2Normal(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
