...
public class MessageGuiV4ModuleInventorySmall extends MessageBase<MessageGuiV4ModuleInventorySmall> {
	...
	{
		player.openGui(ViesCraft.instance, GuiHandler.GUI_V4_MODULE_INVENTORY_SMALL, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
