...
public class EntityItemAirshipV3Normal extends EntityItemAirshipCore {
	
    public EntityItemAirshipV3Normal(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipV3Normal(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipV3Normal(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipV3Normal(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
