...
public class RenderItemAirshipV3Wood0Normal extends Render<EntityItemAirshipV3Wood0Normal> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3Wood0Normal(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3Wood0Normal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3Wood0Normal entity)
    {
