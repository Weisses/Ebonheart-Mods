...
public class RenderAirshipV4Wood0LightBlue extends Render<EntityAirshipV4Wood0LightBlue> {
    ...
    public RenderAirshipV4Wood0LightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4Wood0LightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Wood0LightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4Wood0LightBlue entity)
    {
