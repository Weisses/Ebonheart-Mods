...
public class RenderAirshipV4DiamondRed extends Render<EntityAirshipV4DiamondRed> {
    ...
    public RenderAirshipV4DiamondRed(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4DiamondRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4DiamondRed entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4DiamondRed entity)
    {
