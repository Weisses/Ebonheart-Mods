...
public class RenderAirshipV4GoldBlack extends Render<EntityAirshipV4GoldBlack> {
    ...
    public RenderAirshipV4GoldBlack(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4GoldBlack entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4GoldBlack entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4GoldBlack entity)
    {
