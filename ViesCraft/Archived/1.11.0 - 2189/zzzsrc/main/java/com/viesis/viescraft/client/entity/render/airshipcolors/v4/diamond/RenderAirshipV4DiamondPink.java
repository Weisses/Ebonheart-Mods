...
public class RenderAirshipV4DiamondPink extends Render<EntityAirshipV4DiamondPink> {
    ...
    public RenderAirshipV4DiamondPink(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4DiamondPink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4DiamondPink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4DiamondPink entity)
    {
