...
public class RenderItemAirshipV2EmeraldWhite extends Render<EntityItemAirshipV2EmeraldWhite> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2EmeraldWhite(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2EmeraldWhite entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2EmeraldWhite entity)
    {
