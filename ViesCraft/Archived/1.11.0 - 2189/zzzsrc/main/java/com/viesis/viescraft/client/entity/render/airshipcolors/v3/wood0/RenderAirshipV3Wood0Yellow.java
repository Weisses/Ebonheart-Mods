...
public class RenderAirshipV3Wood0Yellow extends Render<EntityAirshipV3Wood0Yellow> {
    ...
    public RenderAirshipV3Wood0Yellow(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3Wood0Yellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Wood0Yellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3Wood0Yellow entity)
    {
