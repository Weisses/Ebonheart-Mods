...
public class RenderAirshipV3Wood0LightGray extends Render<EntityAirshipV3Wood0LightGray> {
    ...
    public RenderAirshipV3Wood0LightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3Wood0LightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Wood0LightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3Wood0LightGray entity)
    {
