...
public class RenderAirshipV2LapisLazuliLightGray extends Render<EntityAirshipV2LapisLazuliLightGray> {
    ...
    public RenderAirshipV2LapisLazuliLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2LapisLazuliLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2LapisLazuliLightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2LapisLazuliLightGray entity)
    {
