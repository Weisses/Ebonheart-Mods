...
public class RenderAirshipV2DiamondPurple extends Render<EntityAirshipV2DiamondPurple> {
    ...
    public RenderAirshipV2DiamondPurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2DiamondPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2DiamondPurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2DiamondPurple entity)
    {
