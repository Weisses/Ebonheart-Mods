...
public class RenderAirshipV4LapisLazuliBlack extends Render<EntityAirshipV4LapisLazuliBlack> {
    ...
    public RenderAirshipV4LapisLazuliBlack(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4LapisLazuliBlack entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4LapisLazuliBlack entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4LapisLazuliBlack entity)
    {
