...
public class RenderAirshipV1LapisLazuli extends Render<EntityV1Wood0> {
     ...
     */
    @Override
    public void doRender(EntityV1Wood0 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV1Wood0 entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV1Wood0 entity)
    {
