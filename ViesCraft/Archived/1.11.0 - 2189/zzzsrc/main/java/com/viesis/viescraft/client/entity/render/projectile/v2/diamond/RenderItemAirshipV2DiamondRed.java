...
public class RenderItemAirshipV2DiamondRed extends Render<EntityItemAirshipV2DiamondRed> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2DiamondRed(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2DiamondRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2DiamondRed entity)
    {
