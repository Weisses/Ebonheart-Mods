...
public class RenderItemAirshipV4Wood0Blue extends Render<EntityItemAirshipV4Wood0Blue> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4Wood0Blue(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4Wood0Blue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4Wood0Blue entity)
    {
