...
public class RenderAirshipV3GoldLime extends Render<EntityAirshipV3GoldLime> {
    ...
    public RenderAirshipV3GoldLime(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3GoldLime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3GoldLime entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3GoldLime entity)
    {
