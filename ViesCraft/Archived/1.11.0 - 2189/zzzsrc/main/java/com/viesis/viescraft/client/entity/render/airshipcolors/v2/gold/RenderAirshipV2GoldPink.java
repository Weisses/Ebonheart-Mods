...
public class RenderAirshipV2GoldPink extends Render<EntityAirshipV2GoldPink> {
    ...
    public RenderAirshipV2GoldPink(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2GoldPink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2GoldPink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2GoldPink entity)
    {
