package com.viesis.viescraft.client.entity.render.airshipcolors.v4.iron;
...
public class RenderAirshipV4IronAdmin extends Render<EntityAirshipV4IronAdmin> {
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		...
		new ResourceLocation(Reference.MOD_ID, "textures/models/v4/airship_v4_frame_admin_iron.png")
	};
    ...
    public RenderAirshipV4IronAdmin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4IronAdmin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4IronAdmin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4IronAdmin entity)
    {
