...
public class RenderItemAirshipV4GoldWhite extends Render<EntityItemAirshipV4GoldWhite> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4GoldWhite(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4GoldWhite entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4GoldWhite entity)
    {
