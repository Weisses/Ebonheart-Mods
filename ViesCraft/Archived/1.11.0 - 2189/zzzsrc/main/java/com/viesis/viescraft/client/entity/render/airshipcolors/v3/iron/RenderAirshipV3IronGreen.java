...
public class RenderAirshipV3IronGreen extends Render<EntityAirshipV3IronGreen> {
    ...
    public RenderAirshipV3IronGreen(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3IronGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3IronGreen entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3IronGreen entity)
    {
