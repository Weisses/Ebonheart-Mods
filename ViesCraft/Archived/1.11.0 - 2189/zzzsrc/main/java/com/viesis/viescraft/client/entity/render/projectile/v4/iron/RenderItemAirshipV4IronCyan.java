...
public class RenderItemAirshipV4IronCyan extends Render<EntityItemAirshipV4IronCyan> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4IronCyan(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4IronCyan entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4IronCyan entity)
    {
