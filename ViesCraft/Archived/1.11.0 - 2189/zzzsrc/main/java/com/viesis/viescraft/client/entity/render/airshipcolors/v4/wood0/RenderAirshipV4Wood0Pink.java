...
public class RenderAirshipV4Wood0Pink extends Render<EntityAirshipV4Wood0Pink> {
    ...
    public RenderAirshipV4Wood0Pink(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4Wood0Pink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Wood0Pink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4Wood0Pink entity)
    {
