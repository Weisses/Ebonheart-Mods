...
public class RenderAirshipV2Wood0LightGray extends Render<EntityAirshipV2Wood0LightGray> {
    ...
    public RenderAirshipV2Wood0LightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2Wood0LightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Wood0LightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2Wood0LightGray entity)
    {
