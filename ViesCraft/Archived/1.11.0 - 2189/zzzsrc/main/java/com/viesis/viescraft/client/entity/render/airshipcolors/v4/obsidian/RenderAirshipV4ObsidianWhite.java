...
public class RenderAirshipV4ObsidianWhite extends Render<EntityAirshipV4ObsidianWhite> {
    ...
    public RenderAirshipV4ObsidianWhite(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4ObsidianWhite entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4ObsidianWhite entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4ObsidianWhite entity)
    {
