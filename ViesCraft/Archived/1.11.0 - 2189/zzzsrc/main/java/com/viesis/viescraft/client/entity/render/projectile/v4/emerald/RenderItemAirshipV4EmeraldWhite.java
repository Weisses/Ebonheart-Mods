...
public class RenderItemAirshipV4EmeraldWhite extends Render<EntityItemAirshipV4EmeraldWhite> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4EmeraldWhite(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4EmeraldWhite entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4EmeraldWhite entity)
    {
