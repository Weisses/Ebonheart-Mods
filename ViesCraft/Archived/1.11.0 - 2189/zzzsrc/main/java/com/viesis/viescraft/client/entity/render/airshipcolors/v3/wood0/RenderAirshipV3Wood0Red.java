...
public class RenderAirshipV3Wood0Red extends Render<EntityAirshipV3Wood0Red> {
    ...
    public RenderAirshipV3Wood0Red(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3Wood0Red entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Wood0Red entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3Wood0Red entity)
    {
