...
public class ItemAirshipV1Black extends ItemAirshipCore {
	
	public ItemAirshipV1Black() 
	{
		ItemHelper.setItemName(this, "item_airship_v1_black");
    ...
    {
        return ("" + I18n.translateToLocal("Black " + ViesCraftConfig.v1AirshipName)).trim();
    }
