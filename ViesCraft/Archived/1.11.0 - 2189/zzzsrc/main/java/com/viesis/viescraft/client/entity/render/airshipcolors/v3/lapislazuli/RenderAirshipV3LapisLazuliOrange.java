...
public class RenderAirshipV3LapisLazuliOrange extends Render<EntityAirshipV3LapisLazuliOrange> {
    ...
    public RenderAirshipV3LapisLazuliOrange(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3LapisLazuliOrange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LapisLazuliOrange entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3LapisLazuliOrange entity)
    {
