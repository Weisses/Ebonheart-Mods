...
public class RenderAirshipV4LapisLazuliGreen extends Render<EntityAirshipV4LapisLazuliGreen> {
    ...
    public RenderAirshipV4LapisLazuliGreen(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4LapisLazuliGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4LapisLazuliGreen entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4LapisLazuliGreen entity)
    {
