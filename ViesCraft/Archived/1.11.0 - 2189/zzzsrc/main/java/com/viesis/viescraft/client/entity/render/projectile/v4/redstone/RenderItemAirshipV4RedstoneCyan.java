...
public class RenderItemAirshipV4RedstoneCyan extends Render<EntityItemAirshipV4RedstoneCyan> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4RedstoneCyan(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4RedstoneCyan entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4RedstoneCyan entity)
    {
