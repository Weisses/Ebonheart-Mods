...
public class RenderAirshipV2Wood0Black extends Render<EntityAirshipV2Wood0Black> {
    ...
    public RenderAirshipV2Wood0Black(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2Wood0Black entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Wood0Black entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2Wood0Black entity)
    {
