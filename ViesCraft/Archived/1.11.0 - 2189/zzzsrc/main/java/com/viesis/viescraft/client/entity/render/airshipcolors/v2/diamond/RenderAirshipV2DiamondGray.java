...
public class RenderAirshipV2DiamondGray extends Render<EntityAirshipV2DiamondGray> {
    ...
    public RenderAirshipV2DiamondGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2DiamondGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2DiamondGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2DiamondGray entity)
    {
