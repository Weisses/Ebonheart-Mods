...
public class RenderAirshipV4LapisLazuliLightGray extends Render<EntityAirshipV4LapisLazuliLightGray> {
    ...
    public RenderAirshipV4LapisLazuliLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4LapisLazuliLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4LapisLazuliLightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4LapisLazuliLightGray entity)
    {
