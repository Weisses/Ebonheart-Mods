...
public class RenderAirshipV3DiamondGreen extends Render<EntityAirshipV3DiamondGreen> {
    ...
    public RenderAirshipV3DiamondGreen(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3DiamondGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3DiamondGreen entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3DiamondGreen entity)
    {
