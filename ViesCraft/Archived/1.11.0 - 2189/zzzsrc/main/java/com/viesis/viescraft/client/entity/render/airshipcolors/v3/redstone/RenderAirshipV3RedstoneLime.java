...
public class RenderAirshipV3RedstoneLime extends Render<EntityAirshipV3RedstoneLime> {
    ...
    public RenderAirshipV3RedstoneLime(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3RedstoneLime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3RedstoneLime entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3RedstoneLime entity)
    {
