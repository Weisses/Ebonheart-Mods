package com.viesis.viescraft.client.entity.render.airshipcolors.v4.wood0;
...
public class RenderAirshipV4Wood0Admin extends Render<EntityAirshipV4Wood0Admin> {
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		...
		new ResourceLocation(Reference.MOD_ID, "textures/models/v4/airship_v4_frame_admin_wood0.png")
	};
    ...
    public RenderAirshipV4Wood0Admin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4Wood0Admin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Wood0Admin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4Wood0Admin entity)
    {
