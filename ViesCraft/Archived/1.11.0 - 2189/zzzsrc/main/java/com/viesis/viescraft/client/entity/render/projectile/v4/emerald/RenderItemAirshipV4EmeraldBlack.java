...
public class RenderItemAirshipV4EmeraldBlack extends Render<EntityItemAirshipV4EmeraldBlack> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4EmeraldBlack(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4EmeraldBlack entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4EmeraldBlack entity)
    {
