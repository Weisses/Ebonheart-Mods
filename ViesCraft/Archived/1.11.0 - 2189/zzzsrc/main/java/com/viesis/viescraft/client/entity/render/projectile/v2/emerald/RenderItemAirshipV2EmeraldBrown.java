...
public class RenderItemAirshipV2EmeraldBrown extends Render<EntityItemAirshipV2EmeraldBrown> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2EmeraldBrown(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2EmeraldBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2EmeraldBrown entity)
    {
