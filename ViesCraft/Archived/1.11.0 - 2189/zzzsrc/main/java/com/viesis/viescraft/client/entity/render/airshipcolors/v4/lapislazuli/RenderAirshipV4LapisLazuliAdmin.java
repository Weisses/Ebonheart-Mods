package com.viesis.viescraft.client.entity.render.airshipcolors.v4.lapislazuli;
...
public class RenderAirshipV4LapisLazuliAdmin extends Render<EntityAirshipV4LapisLazuliAdmin> {
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		...
		new ResourceLocation(Reference.MOD_ID, "textures/models/v4/airship_v4_frame_admin_lapislazuli.png")
	};
    ...
    public RenderAirshipV4LapisLazuliAdmin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4LapisLazuliAdmin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4LapisLazuliAdmin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4LapisLazuliAdmin entity)
    {
