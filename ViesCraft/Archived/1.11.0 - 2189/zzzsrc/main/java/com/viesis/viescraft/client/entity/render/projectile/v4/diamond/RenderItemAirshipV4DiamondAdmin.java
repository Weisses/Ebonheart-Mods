...
public class RenderItemAirshipV4DiamondAdmin extends Render<EntityItemAirshipV4DiamondAdmin> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4DiamondAdmin(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4DiamondAdmin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4DiamondAdmin entity)
    {
