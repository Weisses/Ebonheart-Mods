...
public class RenderItemAirshipV3GoldYellow extends Render<EntityItemAirshipV3GoldYellow> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3GoldYellow(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3GoldYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3GoldYellow entity)
    {
