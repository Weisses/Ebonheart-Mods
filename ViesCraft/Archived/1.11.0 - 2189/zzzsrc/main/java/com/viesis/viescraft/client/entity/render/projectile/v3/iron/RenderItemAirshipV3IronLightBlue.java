package com.viesis.viescraft.client.entity.render.projectile.v3.iron;
...
public class RenderItemAirshipV3IronLightBlue extends Render<EntityItemAirshipV3IronLightBlue> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3IronLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3IronLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3IronLightBlue entity)
    {
