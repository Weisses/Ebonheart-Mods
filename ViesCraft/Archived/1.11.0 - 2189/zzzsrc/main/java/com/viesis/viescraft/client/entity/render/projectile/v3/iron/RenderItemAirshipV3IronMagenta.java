...
public class RenderItemAirshipV3IronMagenta extends Render<EntityItemAirshipV3IronMagenta> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3IronMagenta(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3IronMagenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3IronMagenta entity)
    {
