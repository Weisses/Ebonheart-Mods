...
public class RenderAirshipV3DiamondRed extends Render<EntityAirshipV3DiamondRed> {
    ...
    public RenderAirshipV3DiamondRed(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3DiamondRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3DiamondRed entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3DiamondRed entity)
    {
