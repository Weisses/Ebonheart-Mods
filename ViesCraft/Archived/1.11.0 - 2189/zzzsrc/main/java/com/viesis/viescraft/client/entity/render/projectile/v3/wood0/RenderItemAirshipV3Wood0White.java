...
public class RenderItemAirshipV3Wood0White extends Render<EntityItemAirshipV3Wood0White> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3Wood0White(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3Wood0White entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3Wood0White entity)
    {
