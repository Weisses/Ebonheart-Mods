...
public class RenderAirshipV4DiamondMagenta extends Render<EntityAirshipV4DiamondMagenta> {
    ...
    public RenderAirshipV4DiamondMagenta(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4DiamondMagenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4DiamondMagenta entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4DiamondMagenta entity)
    {
