...
public class RenderAirshipV2LapisLazuliYellow extends Render<EntityAirshipV2LapisLazuliYellow> {
    ...
    public RenderAirshipV2LapisLazuliYellow(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2LapisLazuliYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2LapisLazuliYellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2LapisLazuliYellow entity)
    {
