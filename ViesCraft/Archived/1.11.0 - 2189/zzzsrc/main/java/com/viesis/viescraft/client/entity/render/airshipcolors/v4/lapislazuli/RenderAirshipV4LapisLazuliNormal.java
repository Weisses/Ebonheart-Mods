...
public class RenderAirshipV4LapisLazuliNormal extends Render<EntityAirshipV4LapisLazuliNormal> {
    ...
    public RenderAirshipV4LapisLazuliNormal(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4LapisLazuliNormal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4LapisLazuliNormal entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4LapisLazuliNormal entity)
    {
