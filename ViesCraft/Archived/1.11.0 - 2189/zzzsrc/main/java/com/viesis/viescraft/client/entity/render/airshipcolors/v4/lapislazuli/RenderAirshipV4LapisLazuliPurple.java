...
public class RenderAirshipV4LapisLazuliPurple extends Render<EntityAirshipV4LapisLazuliPurple> {
    ...
    public RenderAirshipV4LapisLazuliPurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4LapisLazuliPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4LapisLazuliPurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4LapisLazuliPurple entity)
    {
