...
public class RenderAirshipV2DiamondLightGray extends Render<EntityAirshipV2DiamondLightGray> {
    ...
    public RenderAirshipV2DiamondLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2DiamondLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2DiamondLightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2DiamondLightGray entity)
    {
