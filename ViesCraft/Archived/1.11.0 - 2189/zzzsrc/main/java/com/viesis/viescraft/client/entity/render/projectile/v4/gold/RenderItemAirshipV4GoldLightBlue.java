package com.viesis.viescraft.client.entity.render.projectile.v4.gold;
...
public class RenderItemAirshipV4GoldLightBlue extends Render<EntityItemAirshipV4GoldLightBlue> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4GoldLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4GoldLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4GoldLightBlue entity)
    {
