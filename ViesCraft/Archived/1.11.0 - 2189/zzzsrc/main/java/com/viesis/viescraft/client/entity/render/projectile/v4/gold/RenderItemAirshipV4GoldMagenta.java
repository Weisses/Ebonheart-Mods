...
public class RenderItemAirshipV4GoldMagenta extends Render<EntityItemAirshipV4GoldMagenta> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4GoldMagenta(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4GoldMagenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4GoldMagenta entity)
    {
