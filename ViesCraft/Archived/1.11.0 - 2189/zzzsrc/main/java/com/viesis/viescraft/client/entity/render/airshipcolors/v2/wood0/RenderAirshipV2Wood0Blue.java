...
public class RenderAirshipV2Wood0Blue extends Render<EntityAirshipV2Wood0Blue> {
    ...
    public RenderAirshipV2Wood0Blue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2Wood0Blue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Wood0Blue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2Wood0Blue entity)
    {
