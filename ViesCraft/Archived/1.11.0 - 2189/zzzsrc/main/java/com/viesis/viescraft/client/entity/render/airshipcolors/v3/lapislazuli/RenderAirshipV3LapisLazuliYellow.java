...
public class RenderAirshipV3LapisLazuliYellow extends Render<EntityAirshipV3LapisLazuliYellow> {
    ...
    public RenderAirshipV3LapisLazuliYellow(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3LapisLazuliYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LapisLazuliYellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3LapisLazuliYellow entity)
    {
