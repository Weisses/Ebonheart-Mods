...
public class RenderAirshipV2LapisLazuliLightBlue extends Render<EntityAirshipV2LapisLazuliLightBlue> {
    ...
    public RenderAirshipV2LapisLazuliLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2LapisLazuliLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2LapisLazuliLightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2LapisLazuliLightBlue entity)
    {
