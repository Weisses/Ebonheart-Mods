...
public class RenderItemAirshipV2DiamondBrown extends Render<EntityItemAirshipV2DiamondBrown> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2DiamondBrown(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2DiamondBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2DiamondBrown entity)
    {
