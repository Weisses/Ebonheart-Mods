...
public class RenderAirshipV2IronPink extends Render<EntityAirshipV2IronPink> {
    ...
    public RenderAirshipV2IronPink(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2IronPink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2IronPink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2IronPink entity)
    {
