...
public class RenderItemAirshipV4RedstoneRed extends Render<EntityItemAirshipV4RedstoneRed> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4RedstoneRed(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4RedstoneRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4RedstoneRed entity)
    {
