...
public class RenderAirshipV3LapisLazuliPurple extends Render<EntityAirshipV3LapisLazuliPurple> {
    ...
    public RenderAirshipV3LapisLazuliPurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3LapisLazuliPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LapisLazuliPurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3LapisLazuliPurple entity)
    {
