...
public class RenderAirshipV4ObsidianRed extends Render<EntityAirshipV4ObsidianRed> {
    ...
    public RenderAirshipV4ObsidianRed(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4ObsidianRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4ObsidianRed entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4ObsidianRed entity)
    {
