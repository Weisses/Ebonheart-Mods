package com.viesis.viescraft.client.entity.render.airshipcolors.v3.emerald;
...
public class RenderAirshipV3EmeraldLightBlue extends Render<EntityAirshipV3EmeraldLightBlue> {
    ...
    public RenderAirshipV3EmeraldLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3EmeraldLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3EmeraldLightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3EmeraldLightBlue entity)
    {
