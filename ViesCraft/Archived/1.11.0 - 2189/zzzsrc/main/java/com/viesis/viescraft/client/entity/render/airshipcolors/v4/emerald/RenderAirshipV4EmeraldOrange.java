...
public class RenderAirshipV4EmeraldOrange extends Render<EntityAirshipV4EmeraldOrange> {
    ...
    public RenderAirshipV4EmeraldOrange(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4EmeraldOrange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4EmeraldOrange entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4EmeraldOrange entity)
    {
