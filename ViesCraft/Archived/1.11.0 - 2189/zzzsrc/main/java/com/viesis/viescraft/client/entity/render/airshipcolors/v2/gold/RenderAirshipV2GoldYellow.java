...
public class RenderAirshipV2GoldYellow extends Render<EntityAirshipV2GoldYellow> {
    ...
    public RenderAirshipV2GoldYellow(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2GoldYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2GoldYellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2GoldYellow entity)
    {
