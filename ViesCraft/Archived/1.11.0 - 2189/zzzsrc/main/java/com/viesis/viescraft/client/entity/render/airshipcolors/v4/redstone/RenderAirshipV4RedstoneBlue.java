...
public class RenderAirshipV4RedstoneBlue extends Render<EntityAirshipV4RedstoneBlue> {
    ...
    public RenderAirshipV4RedstoneBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4RedstoneBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4RedstoneBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4RedstoneBlue entity)
    {
