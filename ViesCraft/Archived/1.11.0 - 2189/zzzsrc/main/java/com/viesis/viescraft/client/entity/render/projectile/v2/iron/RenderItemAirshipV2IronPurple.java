...
public class RenderItemAirshipV2IronPurple extends Render<EntityItemAirshipV2IronPurple> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2IronPurple(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2IronPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2IronPurple entity)
    {
