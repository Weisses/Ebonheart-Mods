...
public class RenderAirshipV4GoldGreen extends Render<EntityAirshipV4GoldGreen> {
    ...
    public RenderAirshipV4GoldGreen(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4GoldGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4GoldGreen entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4GoldGreen entity)
    {
