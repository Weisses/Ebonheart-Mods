...
public class RenderAirshipV2IronWhite extends Render<EntityAirshipV2IronWhite> {
    ...
    public RenderAirshipV2IronWhite(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2IronWhite entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2IronWhite entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2IronWhite entity)
    {
