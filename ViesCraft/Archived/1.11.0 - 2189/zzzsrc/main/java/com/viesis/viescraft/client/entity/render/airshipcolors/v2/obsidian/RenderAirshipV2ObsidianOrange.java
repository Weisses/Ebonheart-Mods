...
public class RenderAirshipV2ObsidianOrange extends Render<EntityAirshipV2ObsidianOrange> {
    ...
    public RenderAirshipV2ObsidianOrange(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2ObsidianOrange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2ObsidianOrange entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2ObsidianOrange entity)
    {
