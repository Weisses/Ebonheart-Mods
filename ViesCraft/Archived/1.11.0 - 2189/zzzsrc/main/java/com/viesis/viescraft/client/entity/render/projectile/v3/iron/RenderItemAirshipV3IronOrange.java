...
public class RenderItemAirshipV3IronOrange extends Render<EntityItemAirshipV3IronOrange> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3IronOrange(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3IronOrange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3IronOrange entity)
    {
