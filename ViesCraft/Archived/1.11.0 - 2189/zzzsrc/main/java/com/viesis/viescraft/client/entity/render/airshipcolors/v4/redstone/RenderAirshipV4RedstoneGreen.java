...
public class RenderAirshipV4RedstoneGreen extends Render<EntityAirshipV4RedstoneGreen> {
    ...
    public RenderAirshipV4RedstoneGreen(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4RedstoneGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4RedstoneGreen entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4RedstoneGreen entity)
    {
