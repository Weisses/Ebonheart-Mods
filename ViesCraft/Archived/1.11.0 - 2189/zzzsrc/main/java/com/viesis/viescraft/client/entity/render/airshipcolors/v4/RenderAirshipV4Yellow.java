...
public class RenderAirshipV4Yellow extends Render<EntityAirshipV4Yellow> {
    ...
    public RenderAirshipV4Yellow(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4Yellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Yellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4Yellow entity)
    {
