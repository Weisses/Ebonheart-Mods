...
public class RenderItemAirshipV3IronLime extends Render<EntityItemAirshipV3IronLime> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3IronLime(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3IronLime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3IronLime entity)
    {
