package com.viesis.viescraft.client.entity.render.projectile.v2.gold;
...
public class RenderItemAirshipV2GoldLightGray extends Render<EntityItemAirshipV2GoldLightGray> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2GoldLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2GoldLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2GoldLightGray entity)
    {
