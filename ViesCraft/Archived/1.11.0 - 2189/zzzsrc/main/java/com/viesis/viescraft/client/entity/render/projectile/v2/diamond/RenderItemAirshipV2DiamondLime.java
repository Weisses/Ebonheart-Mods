...
public class RenderItemAirshipV2DiamondLime extends Render<EntityItemAirshipV2DiamondLime> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2DiamondLime(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2DiamondLime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2DiamondLime entity)
    {
