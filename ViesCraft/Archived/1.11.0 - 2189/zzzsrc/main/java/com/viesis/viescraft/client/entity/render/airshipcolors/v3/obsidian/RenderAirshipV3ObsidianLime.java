...
public class RenderAirshipV3ObsidianLime extends Render<EntityAirshipV3ObsidianLime> {
    ...
    public RenderAirshipV3ObsidianLime(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3ObsidianLime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3ObsidianLime entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3ObsidianLime entity)
    {
