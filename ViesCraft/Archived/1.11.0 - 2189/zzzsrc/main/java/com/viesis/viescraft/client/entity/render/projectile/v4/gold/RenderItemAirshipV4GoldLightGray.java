...
public class RenderItemAirshipV4GoldLightGray extends Render<EntityItemAirshipV4GoldLightGray> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4GoldLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4GoldLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4GoldLightGray entity)
    {
