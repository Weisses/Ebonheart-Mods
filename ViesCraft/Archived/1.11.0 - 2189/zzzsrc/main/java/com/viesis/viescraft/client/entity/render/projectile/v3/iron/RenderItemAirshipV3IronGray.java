...
public class RenderItemAirshipV3IronGray extends Render<EntityItemAirshipV3IronGray> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3IronGray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3IronGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3IronGray entity)
    {
