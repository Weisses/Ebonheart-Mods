...
public class RenderAirshipV4RedstonePurple extends Render<EntityAirshipV4RedstonePurple> {
    ...
    public RenderAirshipV4RedstonePurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4RedstonePurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4RedstonePurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4RedstonePurple entity)
    {
