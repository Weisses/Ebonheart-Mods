...
public class RenderAirshipV4EmeraldBlack extends Render<EntityAirshipV4EmeraldBlack> {
    ...
    public RenderAirshipV4EmeraldBlack(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4EmeraldBlack entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4EmeraldBlack entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4EmeraldBlack entity)
    {
