...
public class RenderAirshipV2RedstoneNormal extends Render<EntityAirshipV2RedstoneNormal> {
    ...
    public RenderAirshipV2RedstoneNormal(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2RedstoneNormal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2RedstoneNormal entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2RedstoneNormal entity)
    {
