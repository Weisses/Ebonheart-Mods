...
public class RenderAirshipV4IronBlue extends Render<EntityAirshipV4IronBlue> {
    ...
    public RenderAirshipV4IronBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4IronBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4IronBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4IronBlue entity)
    {
