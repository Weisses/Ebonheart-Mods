...
public class RenderItemAirshipV3GoldBrown extends Render<EntityItemAirshipV3GoldBrown> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3GoldBrown(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3GoldBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3GoldBrown entity)
    {
