...
public class RenderItemAirshipV4DiamondBlack extends Render<EntityItemAirshipV4DiamondBlack> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4DiamondBlack(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4DiamondBlack entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4DiamondBlack entity)
    {
