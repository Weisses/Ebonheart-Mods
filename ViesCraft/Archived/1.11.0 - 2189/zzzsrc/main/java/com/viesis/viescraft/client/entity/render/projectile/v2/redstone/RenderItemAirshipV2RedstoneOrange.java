...
public class RenderItemAirshipV2RedstoneOrange extends Render<EntityItemAirshipV2RedstoneOrange> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2RedstoneOrange(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2RedstoneOrange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2RedstoneOrange entity)
    {
