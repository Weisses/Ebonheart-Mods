...
public class RenderAirshipV4LapisLazuliWhite extends Render<EntityAirshipV4LapisLazuliWhite> {
    ...
    public RenderAirshipV4LapisLazuliWhite(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4LapisLazuliWhite entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4LapisLazuliWhite entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4LapisLazuliWhite entity)
    {
