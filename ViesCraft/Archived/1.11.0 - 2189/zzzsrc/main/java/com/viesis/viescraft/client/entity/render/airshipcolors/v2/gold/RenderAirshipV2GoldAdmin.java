package com.viesis.viescraft.client.entity.render.airshipcolors.v2.gold;
...
public class RenderAirshipV2GoldAdmin extends Render<EntityAirshipV2GoldAdmin> {
	...
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		...
		new ResourceLocation(Reference.MOD_ID, "textures/models/v2/airship_v2_frame_admin_gold.png")
	};
    ...
    public RenderAirshipV2GoldAdmin(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2GoldAdmin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2GoldAdmin entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2GoldAdmin entity)
    {
