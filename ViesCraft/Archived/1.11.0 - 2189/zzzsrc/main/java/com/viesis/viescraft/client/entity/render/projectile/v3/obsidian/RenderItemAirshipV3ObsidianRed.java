...
public class RenderItemAirshipV3ObsidianRed extends Render<EntityItemAirshipV3ObsidianRed> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3ObsidianRed(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3ObsidianRed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3ObsidianRed entity)
    {
