...
public class RenderAirshipV4RedstoneNormal extends Render<EntityAirshipV4RedstoneNormal> {
    ...
    public RenderAirshipV4RedstoneNormal(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4RedstoneNormal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4RedstoneNormal entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4RedstoneNormal entity)
    {
