...
public class RenderItemAirshipV3GoldGreen extends Render<EntityItemAirshipV3GoldGreen> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3GoldGreen(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3GoldGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3GoldGreen entity)
    {
