...
public class RenderAirshipV3LapisLazuliPink extends Render<EntityAirshipV3LapisLazuliPink> {
    ...
    public RenderAirshipV3LapisLazuliPink(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3LapisLazuliPink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LapisLazuliPink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3LapisLazuliPink entity)
    {
