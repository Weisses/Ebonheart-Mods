...
public class RenderItemAirshipV2GoldMagenta extends Render<EntityItemAirshipV2GoldMagenta> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2GoldMagenta(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV2GoldMagenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV2GoldMagenta entity)
    {
