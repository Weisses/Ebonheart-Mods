...
public class RenderAirshipV4Wood0Normal extends Render<EntityAirshipV4Wood0Normal> {
    ...
    public RenderAirshipV4Wood0Normal(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4Wood0Normal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Wood0Normal entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4Wood0Normal entity)
    {
