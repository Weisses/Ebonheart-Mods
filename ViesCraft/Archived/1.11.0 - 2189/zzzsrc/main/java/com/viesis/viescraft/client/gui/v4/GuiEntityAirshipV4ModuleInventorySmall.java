...
public class GuiEntityAirshipV4ModuleInventorySmall extends GuiContainer {
	...
	public GuiEntityAirshipV4ModuleInventorySmall(IInventory thePlayerInv, EntityAirshipV4Core airshipV4)
	{
		super(new ContainerAirshipV4ModuleInvSmall(thePlayerInv, airshipV4));
