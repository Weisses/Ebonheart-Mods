...
public class RenderAirshipV4EmeraldLightGray extends Render<EntityAirshipV4EmeraldLightGray> {
    ...
    public RenderAirshipV4EmeraldLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4EmeraldLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4EmeraldLightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4EmeraldLightGray entity)
    {
