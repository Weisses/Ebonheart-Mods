...
public class RenderAirshipV3LapisLazuliBrown extends Render<EntityAirshipV3LapisLazuliBrown> {
    ...
    public RenderAirshipV3LapisLazuliBrown(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3LapisLazuliBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LapisLazuliBrown entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3LapisLazuliBrown entity)
    {
