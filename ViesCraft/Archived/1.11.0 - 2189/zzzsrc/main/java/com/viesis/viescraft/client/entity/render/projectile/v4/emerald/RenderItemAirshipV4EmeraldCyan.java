...
public class RenderItemAirshipV4EmeraldCyan extends Render<EntityItemAirshipV4EmeraldCyan> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4EmeraldCyan(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4EmeraldCyan entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4EmeraldCyan entity)
    {
