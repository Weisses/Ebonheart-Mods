...
public class RenderAirshipV4ObsidianBlue extends Render<EntityAirshipV4ObsidianBlue> {
    ...
    public RenderAirshipV4ObsidianBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4ObsidianBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4ObsidianBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4ObsidianBlue entity)
    {
