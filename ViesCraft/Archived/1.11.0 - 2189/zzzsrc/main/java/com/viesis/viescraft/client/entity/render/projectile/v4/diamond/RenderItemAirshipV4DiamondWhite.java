...
public class RenderItemAirshipV4DiamondWhite extends Render<EntityItemAirshipV4DiamondWhite> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4DiamondWhite(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4DiamondWhite entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4DiamondWhite entity)
    {
