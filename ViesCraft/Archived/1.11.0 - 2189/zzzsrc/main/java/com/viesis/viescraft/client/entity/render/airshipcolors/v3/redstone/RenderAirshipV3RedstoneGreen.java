...
public class RenderAirshipV3RedstoneGreen extends Render<EntityAirshipV3RedstoneGreen> {
    ...
    public RenderAirshipV3RedstoneGreen(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3RedstoneGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3RedstoneGreen entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3RedstoneGreen entity)
    {
