...
public class RenderAirshipV4RedstoneLightBlue extends Render<EntityAirshipV4RedstoneLightBlue> {
    ...
    public RenderAirshipV4RedstoneLightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4RedstoneLightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4RedstoneLightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4RedstoneLightBlue entity)
    {
