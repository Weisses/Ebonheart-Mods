...
public class RenderAirshipV3ObsidianBrown extends Render<EntityAirshipV3ObsidianBrown> {
    ...
    public RenderAirshipV3ObsidianBrown(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3ObsidianBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3ObsidianBrown entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3ObsidianBrown entity)
    {
