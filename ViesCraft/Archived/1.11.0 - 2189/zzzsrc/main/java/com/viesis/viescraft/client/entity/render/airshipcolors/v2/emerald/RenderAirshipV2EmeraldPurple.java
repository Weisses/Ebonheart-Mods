...
public class RenderAirshipV2EmeraldPurple extends Render<EntityAirshipV2EmeraldPurple> {
    ...
    public RenderAirshipV2EmeraldPurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2EmeraldPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2EmeraldPurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2EmeraldPurple entity)
    {
