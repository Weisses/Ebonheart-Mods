...
public class RenderAirshipV3IronBrown extends Render<EntityAirshipV3IronBrown> {
    ...
    public RenderAirshipV3IronBrown(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3IronBrown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3IronBrown entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3IronBrown entity)
    {
