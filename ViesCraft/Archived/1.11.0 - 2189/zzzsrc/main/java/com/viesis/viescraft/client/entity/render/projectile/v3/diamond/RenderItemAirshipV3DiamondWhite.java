...
public class RenderItemAirshipV3DiamondWhite extends Render<EntityItemAirshipV3DiamondWhite> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3DiamondWhite(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3DiamondWhite entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3DiamondWhite entity)
    {
