...
public class RenderAirshipV2RedstonePink extends Render<EntityAirshipV2RedstonePink> {
    ...
    public RenderAirshipV2RedstonePink(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2RedstonePink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2RedstonePink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2RedstonePink entity)
    {
