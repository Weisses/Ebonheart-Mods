...
public class RenderAirshipV2LapisLazuliMagenta extends Render<EntityAirshipV2LapisLazuliMagenta> {
    ...
    public RenderAirshipV2LapisLazuliMagenta(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2LapisLazuliMagenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2LapisLazuliMagenta entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2LapisLazuliMagenta entity)
    {
