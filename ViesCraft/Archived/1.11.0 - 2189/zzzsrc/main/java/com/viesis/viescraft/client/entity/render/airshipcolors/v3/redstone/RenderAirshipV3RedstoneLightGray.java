...
public class RenderAirshipV3RedstoneLightGray extends Render<EntityAirshipV3RedstoneLightGray> {
    ...
    public RenderAirshipV3RedstoneLightGray(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3RedstoneLightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3RedstoneLightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3RedstoneLightGray entity)
    {
