...
public class RenderAirshipV4LapisLazuliYellow extends Render<EntityAirshipV4LapisLazuliYellow> {
    ...
    public RenderAirshipV4LapisLazuliYellow(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV4LapisLazuliYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4LapisLazuliYellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV4LapisLazuliYellow entity)
    {
