...
public class RenderItemAirshipV4EmeraldLime extends Render<EntityItemAirshipV4EmeraldLime> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4EmeraldLime(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV4EmeraldLime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV4EmeraldLime entity)
    {
