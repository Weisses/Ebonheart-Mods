...
public class RenderAirshipV3EmeraldBlue extends Render<EntityAirshipV3EmeraldBlue> {
    ...
    public RenderAirshipV3EmeraldBlue(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3EmeraldBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3EmeraldBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3EmeraldBlue entity)
    {
