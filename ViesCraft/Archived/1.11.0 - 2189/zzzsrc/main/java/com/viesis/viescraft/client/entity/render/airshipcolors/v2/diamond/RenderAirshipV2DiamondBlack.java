...
public class RenderAirshipV2DiamondBlack extends Render<EntityAirshipV2DiamondBlack> {
    ...
    public RenderAirshipV2DiamondBlack(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2DiamondBlack entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2DiamondBlack entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2DiamondBlack entity)
    {
