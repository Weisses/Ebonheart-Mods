...
public class RenderAirshipV2IronCyan extends Render<EntityAirshipV2IronCyan> {
    ...
    public RenderAirshipV2IronCyan(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2IronCyan entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2IronCyan entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2IronCyan entity)
    {
