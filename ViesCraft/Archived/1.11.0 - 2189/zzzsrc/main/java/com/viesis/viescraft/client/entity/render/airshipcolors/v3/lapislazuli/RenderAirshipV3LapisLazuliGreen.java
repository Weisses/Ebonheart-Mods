...
public class RenderAirshipV3LapisLazuliGreen extends Render<EntityAirshipV3LapisLazuliGreen> {
    ...
    public RenderAirshipV3LapisLazuliGreen(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3LapisLazuliGreen entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LapisLazuliGreen entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3LapisLazuliGreen entity)
    {
