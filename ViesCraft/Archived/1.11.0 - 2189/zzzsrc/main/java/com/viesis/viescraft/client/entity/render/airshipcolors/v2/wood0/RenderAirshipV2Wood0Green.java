...
public class RenderAirshipV2Wood0Green extends Render<EntityAirshipV2Wood0Green> {
    ...
    public RenderAirshipV2Wood0Green(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV2Wood0Green entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Wood0Green entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV2Wood0Green entity)
    {
