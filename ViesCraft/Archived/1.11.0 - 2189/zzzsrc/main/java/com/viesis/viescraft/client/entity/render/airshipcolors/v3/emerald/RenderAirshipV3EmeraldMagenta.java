...
public class RenderAirshipV3EmeraldMagenta extends Render<EntityAirshipV3EmeraldMagenta> {
    ...
    public RenderAirshipV3EmeraldMagenta(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3EmeraldMagenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3EmeraldMagenta entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3EmeraldMagenta entity)
    {
