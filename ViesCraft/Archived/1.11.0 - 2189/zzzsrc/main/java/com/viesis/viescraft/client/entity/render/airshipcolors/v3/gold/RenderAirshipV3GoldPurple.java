...
public class RenderAirshipV3GoldPurple extends Render<EntityAirshipV3GoldPurple> {
    ...
    public RenderAirshipV3GoldPurple(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityAirshipV3GoldPurple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3GoldPurple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityAirshipV3GoldPurple entity)
    {
