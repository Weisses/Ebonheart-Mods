...
public class EntityV2Gold extends EntityAirshipV2Core {
	
	public EntityV2Gold(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV2Gold(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.GOLD + this.getBoatType().getName() + " " + ViesCraftConfig.v2AirshipName;
	}
