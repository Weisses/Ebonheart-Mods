...
public class RenderItemAirshipV4Wood0 extends Render<EntityItemV4Wood0> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4Wood0(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV4Wood0 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV4Wood0 entity)
    {
