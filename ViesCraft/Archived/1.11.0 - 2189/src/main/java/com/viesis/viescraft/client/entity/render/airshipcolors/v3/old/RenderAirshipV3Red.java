...
public class RenderAirshipV3Red extends Render<EntityAirshipV3Red> {
    ...
    public RenderAirshipV3Red(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3Red entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Red entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3Red entity)
    {
