...
public class RenderItemAirshipV1Iron extends Render<EntityItemV1Iron> {
     ...
     */
    public void doRender(EntityItemV1Iron entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV1Iron entity)
    {
