...
public class EntityV4Wood0 extends EntityAirshipV4Core {
	
	public EntityV4Wood0(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV4Wood0(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.WOOD0 + this.getBoatType().getName() + " " + ViesCraftConfig.v4AirshipName;
	}
