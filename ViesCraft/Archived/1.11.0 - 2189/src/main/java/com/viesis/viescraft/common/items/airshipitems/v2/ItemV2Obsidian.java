...
public class ItemV2Obsidian extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV2Obsidian(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV2Obsidian entityairship = new EntityItemV2Obsidian(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.OBSIDIAN + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v2AirshipName)).trim();
    }
}
