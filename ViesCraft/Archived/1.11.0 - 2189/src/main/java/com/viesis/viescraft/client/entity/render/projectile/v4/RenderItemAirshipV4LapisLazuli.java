...
public class RenderItemAirshipV4LapisLazuli extends Render<EntityItemV4LapisLazuli> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4LapisLazuli(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV4LapisLazuli entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV4LapisLazuli entity)
    {
