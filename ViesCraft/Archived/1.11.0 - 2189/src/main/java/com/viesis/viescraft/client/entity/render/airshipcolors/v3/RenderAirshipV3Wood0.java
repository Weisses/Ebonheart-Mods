...
public class RenderAirshipV3Wood0 extends Render<EntityV3Wood0> {
    ...
    public RenderAirshipV3Wood0(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV3Wood0 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV3Wood0 entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV3Wood0 entity)
    {
