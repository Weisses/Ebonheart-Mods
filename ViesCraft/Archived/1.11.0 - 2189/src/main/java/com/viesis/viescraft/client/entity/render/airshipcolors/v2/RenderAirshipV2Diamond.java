...
public class RenderAirshipV2Diamond extends Render<EntityV2Diamond> {
    ...
    public RenderAirshipV2Diamond(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV2Diamond entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV2Diamond entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV2Diamond entity)
    {
