...
public class RenderItemAirshipV1Diamond extends Render<EntityItemV1Diamond> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV1Diamond(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV1Diamond entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV1Diamond entity)
    {
