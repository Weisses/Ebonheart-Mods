...
public class RenderItemAirshipV1Obsidian extends Render<EntityItemV1Obsidian> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV1Obsidian(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV1Obsidian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV1Obsidian entity)
    {
