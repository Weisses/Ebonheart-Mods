...
public class RenderItemAirshipV2Redstone extends Render<EntityItemV2Redstone> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2Redstone(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV2Redstone entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV2Redstone entity)
    {
