...
public class RenderAirshipV1Gray extends Render<EntityAirshipV1Gray> {
    ...
    public RenderAirshipV1Gray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV1Gray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1Gray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV1Gray entity)
    {
