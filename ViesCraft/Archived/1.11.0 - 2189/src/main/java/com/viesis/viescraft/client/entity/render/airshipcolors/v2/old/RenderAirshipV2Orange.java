...
public class RenderAirshipV2Orange extends Render<EntityAirshipV2Orange> {
     ...
     */
    public void doRender(EntityAirshipV2Orange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Orange entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2Orange entity)
    {
