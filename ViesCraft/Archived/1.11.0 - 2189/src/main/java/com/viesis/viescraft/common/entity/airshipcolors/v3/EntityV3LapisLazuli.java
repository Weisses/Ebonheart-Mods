...
public class EntityV3LapisLazuli extends EntityAirshipV3Core {
	
	public EntityV3LapisLazuli(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV3LapisLazuli(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.LAPISLAZULI + this.getBoatType().getName() + " " + ViesCraftConfig.v3AirshipName;
	}
