...
public class RenderItemAirshipV2Obsidian extends Render<EntityItemV2Obsidian> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2Obsidian(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV2Obsidian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV2Obsidian entity)
    {
