...
public class RenderItemAirshipV3Redstone extends Render<EntityItemV3Redstone> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV3Redstone(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV3Redstone entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV3Redstone entity)
    {
