...
public class RenderAirshipV1Brown extends Render<EntityAirshipV1Brown> {
    ...
    public RenderAirshipV1Brown(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV1Brown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1Brown entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV1Brown entity)
    {
