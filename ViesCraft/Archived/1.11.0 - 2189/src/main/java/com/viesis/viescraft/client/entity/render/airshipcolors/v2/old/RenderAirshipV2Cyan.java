...
public class RenderAirshipV2Cyan extends Render<EntityAirshipV2Cyan> {
    ...
    public RenderAirshipV2Cyan(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV2Cyan entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Cyan entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2Cyan entity)
    {
