...
public class RenderAirshipV4Wood0 extends Render<EntityV4Wood0> {
    ...
    public RenderAirshipV4Wood0(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV4Wood0 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV4Wood0 entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV4Wood0 entity)
    {
