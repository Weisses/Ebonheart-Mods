...
public class RenderItemAirshipV1Emerald extends Render<EntityItemV1Emerald> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV1Emerald(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV1Emerald entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV1Emerald entity)
    {
