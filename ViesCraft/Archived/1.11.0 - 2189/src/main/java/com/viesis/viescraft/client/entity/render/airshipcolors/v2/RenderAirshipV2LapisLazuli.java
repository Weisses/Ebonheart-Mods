...
public class RenderAirshipV2LapisLazuli extends Render<EntityV2LapisLazuli> {
    ...
    public RenderAirshipV2LapisLazuli(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV2LapisLazuli entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV2LapisLazuli entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV2LapisLazuli entity)
    {
