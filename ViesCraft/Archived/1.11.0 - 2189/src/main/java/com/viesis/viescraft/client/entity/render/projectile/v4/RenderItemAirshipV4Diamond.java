...
public class RenderItemAirshipV4Diamond extends Render<EntityItemV4Diamond> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4Diamond(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV4Diamond entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV4Diamond entity)
    {
