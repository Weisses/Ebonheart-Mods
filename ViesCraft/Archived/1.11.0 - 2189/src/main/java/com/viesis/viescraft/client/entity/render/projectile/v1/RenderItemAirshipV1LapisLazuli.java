...
public class RenderItemAirshipV1LapisLazuli extends Render<EntityItemV1LapisLazuli> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV1LapisLazuli(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV1LapisLazuli entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV1LapisLazuli entity)
    {
