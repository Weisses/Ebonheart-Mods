...
public class EntityV3Emerald extends EntityAirshipV3Core {
	
	public EntityV3Emerald(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV3Emerald(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.EMERALD + this.getBoatType().getName() + " " + ViesCraftConfig.v3AirshipName;
	}
