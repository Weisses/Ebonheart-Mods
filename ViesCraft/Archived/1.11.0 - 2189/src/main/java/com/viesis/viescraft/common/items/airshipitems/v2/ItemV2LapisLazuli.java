...
public class ItemV2LapisLazuli extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV2LapisLazuli(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV2LapisLazuli entityairship = new EntityItemV2LapisLazuli(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.LAPISLAZULI + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v2AirshipName)).trim();
    }
}
