...
public class RenderAirshipV2Brown extends Render<EntityAirshipV2Brown> {
    ...
    public RenderAirshipV2Brown(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV2Brown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Brown entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2Brown entity)
    {
