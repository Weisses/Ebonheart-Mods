...
public class RenderItemAirshipV2Iron extends Render<EntityItemV2Iron> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2Iron(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV2Iron entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV2Iron entity)
    {
