...
public class RenderItemAirshipV1Admin extends Render<EntityItemAirshipV1Admin> {
    ...
    public RenderItemAirshipV1Admin(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV1Admin entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        TextureAtlasSprite textureatlassprite = Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(InitItemsVC.item_airship_v1_rainbow);
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV1Admin entity)
    {
