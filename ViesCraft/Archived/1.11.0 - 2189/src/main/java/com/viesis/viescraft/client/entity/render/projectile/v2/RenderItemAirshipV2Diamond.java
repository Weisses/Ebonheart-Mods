...
public class RenderItemAirshipV2Diamond extends Render<EntityItemV2Diamond> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2Diamond(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV2Diamond entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV2Diamond entity)
    {
