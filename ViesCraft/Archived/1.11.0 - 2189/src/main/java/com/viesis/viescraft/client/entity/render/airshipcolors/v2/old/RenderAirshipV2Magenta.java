...
public class RenderAirshipV2Magenta extends Render<EntityAirshipV2Magenta> {
    ...
    public RenderAirshipV2Magenta(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV2Magenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Magenta entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2Magenta entity)
    {
