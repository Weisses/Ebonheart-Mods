...
public class EntityV4Gold extends EntityAirshipV4Core {
	
	public EntityV4Gold(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV4Gold(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.GOLD + this.getBoatType().getName() + " " + ViesCraftConfig.v4AirshipName;
	}
