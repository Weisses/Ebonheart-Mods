...
public class ItemV2Iron extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV2Iron(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV2Iron entityairship = new EntityItemV2Iron(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.IRON + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v2AirshipName)).trim();
    }
}
