...
public class RenderAirshipV2Red extends Render<EntityAirshipV2Red> {
    ...
    public RenderAirshipV2Red(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV2Red entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Red entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2Red entity)
    {
