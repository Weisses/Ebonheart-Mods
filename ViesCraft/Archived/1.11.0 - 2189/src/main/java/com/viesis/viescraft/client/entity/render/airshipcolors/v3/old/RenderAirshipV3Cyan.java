...
public class RenderAirshipV3Cyan extends Render<EntityAirshipV3Cyan> {
    ...
    public RenderAirshipV3Cyan(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3Cyan entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Cyan entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3Cyan entity)
    {
