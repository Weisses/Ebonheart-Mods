...
public class RenderItemAirshipV2Emerald extends Render<EntityItemV2Emerald> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2Emerald(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV2Emerald entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV2Emerald entity)
    {
