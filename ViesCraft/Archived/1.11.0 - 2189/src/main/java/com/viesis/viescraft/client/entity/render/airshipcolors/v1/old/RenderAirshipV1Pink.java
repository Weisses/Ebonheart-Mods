...
public class RenderAirshipV1Pink extends Render<EntityAirshipV1Pink> {
    ...
    public RenderAirshipV1Pink(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV1Pink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV1Pink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV1Pink entity)
    {
