...
public class RenderItemAirshipV4Gold extends Render<EntityItemV4Gold> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV4Gold(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV4Gold entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV4Gold entity)
    {
