...
public class ItemV3Redstone extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV3Redstone(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV3Redstone entityairship = new EntityItemV3Redstone(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.REDSTONE + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v3AirshipName)).trim();
    }
}
