...
public class RenderAirshipV3LightBlue extends Render<EntityAirshipV3LightBlue> {
    ...
    public RenderAirshipV3LightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3LightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3LightBlue entity)
    {
