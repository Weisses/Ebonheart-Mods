...
public class RenderAirshipV3Yellow extends Render<EntityAirshipV3Yellow> {
    ...
    public RenderAirshipV3Yellow(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3Yellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Yellow entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3Yellow entity)
    {
