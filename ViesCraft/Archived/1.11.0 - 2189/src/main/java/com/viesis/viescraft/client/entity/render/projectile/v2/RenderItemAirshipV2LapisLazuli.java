...
public class RenderItemAirshipV2LapisLazuli extends Render<EntityItemV2LapisLazuli> {
	
	private Item itemModel = InitItemsVC.achievement_airship_portal;
	private float scale;
    
    public RenderItemAirshipV2LapisLazuli(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemV2LapisLazuli entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemV2LapisLazuli entity)
    {
