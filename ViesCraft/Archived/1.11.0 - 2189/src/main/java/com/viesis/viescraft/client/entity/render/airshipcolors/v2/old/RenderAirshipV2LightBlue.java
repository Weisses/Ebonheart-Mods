...
public class RenderAirshipV2LightBlue extends Render<EntityAirshipV2LightBlue> {
    ...
    public RenderAirshipV2LightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV2LightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2LightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2LightBlue entity)
    {
