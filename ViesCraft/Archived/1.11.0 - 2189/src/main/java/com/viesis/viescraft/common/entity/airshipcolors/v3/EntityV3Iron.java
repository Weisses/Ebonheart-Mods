...
public class EntityV3Iron extends EntityAirshipV3Core {
	
	public EntityV3Iron(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV3Iron(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.IRON + this.getBoatType().getName() + " " + ViesCraftConfig.v3AirshipName;
	}
