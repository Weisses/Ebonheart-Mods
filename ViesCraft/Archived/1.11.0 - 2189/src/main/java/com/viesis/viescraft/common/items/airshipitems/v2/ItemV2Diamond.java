...
public class ItemV2Diamond extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV2Diamond(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV2Diamond entityairship = new EntityItemV2Diamond(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.DIAMOND + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v2AirshipName)).trim();
    }
}
