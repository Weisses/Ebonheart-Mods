...
public class ItemV1Diamond extends ItemAirshipCore {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV1Diamond entityairship = new EntityItemV1Diamond(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.DIAMOND + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v1AirshipName)).trim();
    }
}
