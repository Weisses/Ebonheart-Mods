...
public class ItemV3Iron extends ItemAirshipCore {
	
	public int typeAirshipitem;
	
	public ItemV3Iron(String unlocalizedName, int typeIn) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemV3Iron entityairship = new EntityItemV3Iron(worldIn, playerIn, this.typeAirshipitem);
    ...
    {
        return (Reference.IRON + ITEM_COLOR[this.typeAirshipitem] + " " + I18n.translateToLocal(ViesCraftConfig.v3AirshipName)).trim();
    }
}
