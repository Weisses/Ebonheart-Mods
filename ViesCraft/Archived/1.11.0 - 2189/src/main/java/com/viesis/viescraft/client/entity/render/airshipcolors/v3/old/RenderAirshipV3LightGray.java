...
public class RenderAirshipV3LightGray extends Render<EntityAirshipV3LightGray> {
    ...
    public RenderAirshipV3LightGray(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3LightGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3LightGray entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3LightGray entity)
    {
