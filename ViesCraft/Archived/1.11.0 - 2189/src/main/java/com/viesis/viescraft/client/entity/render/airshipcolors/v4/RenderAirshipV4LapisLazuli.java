...
public class RenderAirshipV4LapisLazuli extends Render<EntityV4LapisLazuli> {
    ...
    public RenderAirshipV4LapisLazuli(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV4LapisLazuli entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV4LapisLazuli entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV4LapisLazuli entity)
    {
