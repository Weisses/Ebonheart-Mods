...
public class RenderAirshipV1Obsidian extends Render<EntityV1Obsidian> {
    ...
    public RenderAirshipV1Obsidian(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV1Obsidian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV1Obsidian entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV1Obsidian entity)
    {
