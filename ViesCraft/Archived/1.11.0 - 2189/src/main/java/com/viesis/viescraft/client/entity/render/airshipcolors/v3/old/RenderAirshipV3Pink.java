...
public class RenderAirshipV3Pink extends Render<EntityAirshipV3Pink> {
    ...
    public RenderAirshipV3Pink(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3Pink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Pink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3Pink entity)
    {
