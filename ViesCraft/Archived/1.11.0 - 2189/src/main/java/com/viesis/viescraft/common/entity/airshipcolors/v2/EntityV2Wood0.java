...
public class EntityV2Wood0 extends EntityAirshipV2Core {
	
	public EntityV2Wood0(World worldIn)
    {
        super(worldIn);
    ...
    public EntityV2Wood0(World worldIn, double x, double y, double z, int typeIn)
    {
        this(worldIn);
	...
	{
		return this.hasCustomName() ? this.customName : Reference.WOOD0 + this.getBoatType().getName() + " " + ViesCraftConfig.v2AirshipName;
	}
