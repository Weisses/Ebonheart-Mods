...
public class RenderAirshipV2Wood0 extends Render<EntityV2Wood0> {
    ...
    public RenderAirshipV2Wood0(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityV2Wood0 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityV2Wood0 entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityV2Wood0 entity)
    {
