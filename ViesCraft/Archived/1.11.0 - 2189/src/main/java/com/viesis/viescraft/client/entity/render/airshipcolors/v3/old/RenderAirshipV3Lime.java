...
public class RenderAirshipV3Lime extends Render<EntityAirshipV3Lime> {
    ...
    public RenderAirshipV3Lime(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV3Lime entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV3Lime entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV3Lime entity)
    {
