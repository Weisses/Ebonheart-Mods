...
public class RenderAirshipV2Green extends Render<EntityAirshipV2Green> {
     ...
     */
    public void doRender(EntityAirshipV2Green entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Green entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2Green entity)
    {
