...
public class RenderAirshipV4Green extends Render<EntityAirshipV4Green> {
    ...
    public RenderAirshipV4Green(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4Green entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Green entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4Green entity)
    {
