...
public class EntityItemAirshipV4Cyan extends EntityItemAirshipCore {
	
    public EntityItemAirshipV4Cyan(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipV4Cyan(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipV4Cyan(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipV4Cyan(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
