...
public class RenderAirshipV4Brown extends Render<EntityAirshipV4Brown> {
    ...
    public RenderAirshipV4Brown(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4Brown entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Brown entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4Brown entity)
    {
