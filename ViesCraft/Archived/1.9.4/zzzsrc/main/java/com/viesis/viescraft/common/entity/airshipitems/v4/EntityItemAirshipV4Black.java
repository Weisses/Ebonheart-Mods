...
public class EntityItemAirshipV4Black extends EntityItemAirshipCore {
	
    public EntityItemAirshipV4Black(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipV4Black(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipV4Black(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipV4Black(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
