...
public class RenderAirshipV4Magenta extends Render<EntityAirshipV4Magenta> {
    ...
    public RenderAirshipV4Magenta(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4Magenta entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Magenta entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4Magenta entity)
    {
