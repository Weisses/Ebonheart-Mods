...
public class GuiEntityAirshipV3ModuleInventorySmall extends GuiContainer {
	...
	public GuiEntityAirshipV3ModuleInventorySmall(IInventory thePlayerInv, EntityAirshipV3Core airshipV3)
	{
		super(new ContainerAirshipV3ModuleInvSmall(thePlayerInv, airshipV3));
