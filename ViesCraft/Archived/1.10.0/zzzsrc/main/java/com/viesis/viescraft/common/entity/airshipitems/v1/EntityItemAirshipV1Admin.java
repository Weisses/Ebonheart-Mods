...
public class EntityItemAirshipV1Admin extends EntityItemAirshipCore {
	
    public EntityItemAirshipV1Admin(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipV1Admin(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipV1Admin(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipV1Admin(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
