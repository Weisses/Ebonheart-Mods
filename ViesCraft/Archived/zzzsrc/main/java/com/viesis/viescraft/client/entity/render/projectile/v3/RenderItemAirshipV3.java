...
public class RenderItemAirshipV3 extends Render<EntityItemAirshipV3> {
	
	private Item itemModel = InitItemsVC.ITEM_ENTITY_AIRSHIP;
	private float scale;
    
    public RenderItemAirshipV3(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityItemAirshipV3 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityItemAirshipV3 entity)
    {
