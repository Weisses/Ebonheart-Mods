...
public class EntityItemAirshipV3Gray extends EntityItemAirshipCore {
    ...
    public EntityItemAirshipV3Gray(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipV3Gray(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipV3Gray(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipV3Gray(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
