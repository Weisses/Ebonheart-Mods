...
public class RenderAirshipV4Purple extends Render<EntityAirshipV4Purple> {
    ...
    public RenderAirshipV4Purple(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4Purple entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Purple entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4Purple entity)
    {
