...
public class RenderAirshipV4Red extends Render<EntityAirshipV4Red> {
    ...
    public RenderAirshipV4Red(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4Red entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Red entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4Red entity)
    {
