...
public class InitEntityVC {
	...
	public static void preInit()
	{
		...
		register("airship_v1_normal", EntityAirshipV1Normal.class, "airship.normal", 64, 1, true);
		register("airship_v1_black", EntityAirshipV1Black.class, "airship.black", 64, 1, true);
		register("airship_v1_blue", EntityAirshipV1Blue.class, "airship.blue", 64, 1, true);
		register("airship_v1_brown", EntityAirshipV1Brown.class, "airship.brown", 64, 1, true);
		register("airship_v1_cyan", EntityAirshipV1Cyan.class, "airship.cyan", 64, 1, true);
		register("airship_v1_gray", EntityAirshipV1Gray.class, "airship.gray", 64, 1, true);
		register("airship_v1_green", EntityAirshipV1Green.class, "airship.green", 64, 1, true);
		register("airship_v1_lightblue", EntityAirshipV1LightBlue.class, "airship.lightblue", 64, 1, true);
		register("airship_v1_lightgray", EntityAirshipV1LightGray.class, "airship.lightgray", 64, 1, true);
		register("airship_v1_lime", EntityAirshipV1Lime.class, "airship.lime", 64, 1, true);
		register("airship_v1_magenta", EntityAirshipV1Magenta.class, "airship.magenta", 64, 1, true);
		register("airship_v1_orange", EntityAirshipV1Orange.class, "airship.orange", 64, 1, true);
		register("airship_v1_pink", EntityAirshipV1Pink.class, "airship.pink", 64, 1, true);
		register("airship_v1_purple", EntityAirshipV1Purple.class, "airship.purple", 64, 1, true);
		register("airship_v1_red", EntityAirshipV1Red.class, "airship.red", 64, 1, true);
		register("airship_v1_white", EntityAirshipV1White.class, "airship.white", 64, 1, true);
		register("airship_v1_yellow", EntityAirshipV1Yellow.class, "airship.yellow", 64, 1, true);
	...
	public static void register(String name, Class<? extends Entity> entityClass, String entityName, int trackingRange, int updateFrequency, boolean sendsVelocityUpdates)
	{
		EntityRegistry.registerModEntity(
				//new ResourceLocation("vc:" + name), 
				entityClass, entityName, entityID++, ViesCraft.instance, trackingRange, updateFrequency, sendsVelocityUpdates);
	}
}
