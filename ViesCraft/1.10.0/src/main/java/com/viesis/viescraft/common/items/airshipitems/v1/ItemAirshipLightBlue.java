...
public class ItemAirshipLightBlue extends ItemAirshipCore {
	
	public ItemAirshipLightBlue() 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipLightBlue entityairship = new EntityItemAirshipLightBlue(worldIn, playerIn);
