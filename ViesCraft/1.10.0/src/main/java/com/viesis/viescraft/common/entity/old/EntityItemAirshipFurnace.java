...
public class EntityItemAirshipFurnace extends EntityThrowable {
	
	Random random = new Random();
	
    public EntityItemAirshipFurnace(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipFurnace(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipFurnace(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipFurnace(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
