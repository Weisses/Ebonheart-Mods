...
public class ItemAirshipLime extends ItemAirshipCore {
	
	public ItemAirshipLime() 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
		if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipLime entityairship = new EntityItemAirshipLime(worldIn, playerIn);
