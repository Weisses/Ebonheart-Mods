...
public class RenderAirshipOrange extends Render<EntityAirshipOrange>
{
     ...
     */
    public void doRender(EntityAirshipOrange entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipOrange p_188311_1_, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipOrange entity)
    {
