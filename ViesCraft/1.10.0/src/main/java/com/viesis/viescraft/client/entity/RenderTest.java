package com.viesis.viescraft.client.entity;
...
public class RenderTest extends Render<EntityAirshipVC>
{
     ...
     */
    public void doRender(EntityAirshipVC entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipVC p_188311_1_, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipVC entity)
    {
