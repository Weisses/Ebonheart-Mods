...
public class EntityItemAirshipBrown extends EntityItemAirshipCore {
	
    public EntityItemAirshipBrown(World worldIn)
    {
        super(worldIn);
    }
    
    public EntityItemAirshipBrown(World worldIn, EntityLivingBase entity)
    {
        super(worldIn, entity);
    }
    
    public EntityItemAirshipBrown(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.spawnEntityInWorld(new EntityAirshipBrown(this.worldObj, this.posX, this.posY + 0.5F, this.posZ));
