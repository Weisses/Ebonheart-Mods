...
public class RenderAirshipV2Black extends Render<EntityAirshipV2Black> {
	
	private static final ResourceLocation[] ENTITY_TEXTURE = new ResourceLocation[] 
	{
		new ResourceLocation(Reference.MOD_ID, "textures/models/airship_v2_black.png")//, 
	};
    ...
    public RenderAirshipV2Black(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV2Black entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV2Black entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV2Black entity)
    {
