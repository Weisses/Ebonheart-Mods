...
public class ViesCraftConfig 
{
	...
	public static void syncConfig()
	{
		...
		final String PARTICLES = ViesCraft.config.CATEGORY_GENERAL + ViesCraft.config.CATEGORY_SPLITTER + ChatFormatting.AQUA + "Animation";
		...
		modelAnimation = ViesCraft.config.get(PARTICLES, ChatFormatting.YELLOW + MODELANIMATION_NAME, MODELANIMATION_DEFAULT).getBoolean(MODELANIMATION_DEFAULT);
