...
public class CopyOfEntityAirshipV1Core extends EntityAirshipBaseVC implements IInventory {
	
	//General
	private static final DataParameter<Integer> TIME_SINCE_HIT = EntityDataManager.<Integer>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> FORWARD_DIRECTION = EntityDataManager.<Integer>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.VARINT);
	private static final DataParameter<Float> DAMAGE_TAKEN = EntityDataManager.<Float>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.FLOAT);
	private static final DataParameter<Integer> BOAT_TYPE = EntityDataManager.<Integer>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.VARINT);
    
	//Fuel
	private static final DataParameter<Integer> POWERED = EntityDataManager.<Integer>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> TOTALPOWERED = EntityDataManager.<Integer>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> ITEMFUELSTACKPOWERED = EntityDataManager.<Integer>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> ITEMFUELSTACKSIZEPOWERED = EntityDataManager.<Integer>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.VARINT);
    
	//Passive
	private static final DataParameter<Boolean> MODULE_INVENTORY_SMALL = EntityDataManager.<Boolean>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> MODULE_INVENTORY_LARGE = EntityDataManager.<Boolean>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> MODULE_FUEL_INFINITE = EntityDataManager.<Boolean>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> MODULE_SPEED_MINOR = EntityDataManager.<Boolean>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> MODULE_SPEED_MAJOR = EntityDataManager.<Boolean>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.BOOLEAN);
	
	//Active
	private static final DataParameter<Boolean> MODULE_STEALTH = EntityDataManager.<Boolean>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> MODULE_DASH = EntityDataManager.<Boolean>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.BOOLEAN);
	...
	//Ability is On
	private static final DataParameter<Integer> MODULE_ABILITY_ON = EntityDataManager.<Integer>createKey(CopyOfEntityAirshipV1Core.class, DataSerializers.VARINT);
	...
	public CopyOfEntityAirshipV1Core.Status status;
    public CopyOfEntityAirshipV1Core.Status previousStatus;
	...
	public CopyOfEntityAirshipV1Core(World worldIn)
    {
        super(worldIn);
    ...
    public CopyOfEntityAirshipV1Core(World worldIn, double x, double y, double z)
    {
        this(worldIn);
	...
	protected void entityInit() 
	{
        ...
        this.dataManager.register(BOAT_TYPE, Integer.valueOf(CopyOfEntityAirshipV1Core.Type.NORMAL.ordinal()));
    ...
    public void onUpdate()
    {
        ...
        if (this.status != CopyOfEntityAirshipV1Core.Status.UNDER_WATER && this.status != CopyOfEntityAirshipV1Core.Status.UNDER_FLOWING_WATER)
        {
    ...
    public void updateMotion()
    {
        ...
        if (this.previousStatus == CopyOfEntityAirshipV1Core.Status.IN_AIR && this.status != CopyOfEntityAirshipV1Core.Status.IN_AIR && this.status != CopyOfEntityAirshipV1Core.Status.ON_LAND)
        {
            this.waterLevel = this.getEntityBoundingBox().minY + (double)this.height;
            this.setPosition(this.posX, (double)(this.getWaterLevelAbove() - this.height) + 0.101D, this.posZ);
            this.motionY = 0.0D;
            this.lastYd = 0.0D;
            this.status = CopyOfEntityAirshipV1Core.Status.IN_WATER;
        }
        else
        {
            if (this.status == CopyOfEntityAirshipV1Core.Status.IN_WATER)
            {
            	this.momentum = 0.45F;
            }
            else if (this.status == CopyOfEntityAirshipV1Core.Status.UNDER_FLOWING_WATER 
        	  || this.status == CopyOfEntityAirshipV1Core.Status.UNDER_WATER)
            {
            	if (!this.worldObj.isRemote)
            	{
            ...
            else if (this.status == CopyOfEntityAirshipV1Core.Status.IN_AIR
            	  || this.status == CopyOfEntityAirshipV1Core.Status.ON_LAND)
            {
            	this.momentum = 0.9F;
            }
    ...
    public void setBoatType(CopyOfEntityAirshipV1Core.Type boatType)
    {
        this.dataManager.set(BOAT_TYPE, Integer.valueOf(boatType.ordinal()));
    }
    
    public CopyOfEntityAirshipV1Core.Type getBoatType()
    {
        return CopyOfEntityAirshipV1Core.Type.byId(((Integer)this.dataManager.get(BOAT_TYPE)).intValue());
    }
    ...
    public static enum Type
    {
         ...
         */
        public static CopyOfEntityAirshipV1Core.Type byId(int id)
        {
        ...
        public static CopyOfEntityAirshipV1Core.Type getTypeFromString(String nameIn)
        {
    ...
    */
     ...
     */
    public CopyOfEntityAirshipV1Core.Status getAirshipStatus()
    {
        CopyOfEntityAirshipV1Core.Status EntityAirshipEA$status = this.getUnderwaterStatus();
        ...
        {
            return CopyOfEntityAirshipV1Core.Status.IN_WATER;
        }
        else
        {
            ...
            {
                this.boatGlide = f;
                return CopyOfEntityAirshipV1Core.Status.ON_LAND;
            }
            else
            {
                return CopyOfEntityAirshipV1Core.Status.IN_AIR;
            }
        }
    }
     ...
     */
    @Nullable
    private CopyOfEntityAirshipV1Core.Status getUnderwaterStatus()
    {
        AxisAlignedBB axisalignedbb = this.getEntityBoundingBox();
                ...
                for (int l1 = k; l1 < l; ++l1)
                {
                    for (int i2 = i1; i2 < j1; ++i2)
                    {
                        ...
                        if (iblockstate.getMaterial() == Material.WATER && d0 < (double)getLiquidHeight(iblockstate, this.worldObj, blockpos$pooledmutableblockpos))
                        {
                            ...
                            {
                                CopyOfEntityAirshipV1Core.Status EntityAirshipEA$status = CopyOfEntityAirshipV1Core.Status.UNDER_FLOWING_WATER;
                                return EntityAirshipEA$status;
                            }
        ...
        return flag ? CopyOfEntityAirshipV1Core.Status.UNDER_WATER : null;
    }
