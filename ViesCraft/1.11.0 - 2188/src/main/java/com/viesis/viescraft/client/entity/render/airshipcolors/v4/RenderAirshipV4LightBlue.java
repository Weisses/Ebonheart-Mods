...
public class RenderAirshipV4LightBlue extends Render<EntityAirshipV4LightBlue> {
    ...
    public RenderAirshipV4LightBlue(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4LightBlue entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4LightBlue entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4LightBlue entity)
    {
