...
public class ItemAirshipV4Brown extends ItemAirshipCore {
	
	public ItemAirshipV4Brown() 
	{
		ItemHelper.setItemName(this, "item_airship_v4_brown");
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(playerIn.isSneaking())
		{
			...
			if (!worldIn.isRemote)
			{
				EntityItemAirshipV4Brown entityairship = new EntityItemAirshipV4Brown(worldIn, playerIn);
    ...
    {
        return ("" + I18n.translateToLocal("Brown " + ViesCraftConfig.v4AirshipName)).trim();
    }
}
