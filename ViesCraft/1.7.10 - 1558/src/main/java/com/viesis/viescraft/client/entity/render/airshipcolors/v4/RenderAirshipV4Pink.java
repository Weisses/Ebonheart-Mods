...
public class RenderAirshipV4Pink extends Render<EntityAirshipV4Pink> {
    ...
    public RenderAirshipV4Pink(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityAirshipV4Pink entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void setupRotation(EntityAirshipV4Pink entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityAirshipV4Pink entity)
    {
