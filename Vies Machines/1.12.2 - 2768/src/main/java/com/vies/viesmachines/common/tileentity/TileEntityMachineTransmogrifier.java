...
public class TileEntityMachineTransmogrifier extends TileEntity implements ITickable {
    ...
    private final String defaultNameVM = "appliance_machine_transmogrifier";
    
    public TileEntityMachineTransmogrifier() 
    {
