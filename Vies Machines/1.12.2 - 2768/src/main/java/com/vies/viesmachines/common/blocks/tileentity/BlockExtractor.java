...
public class BlockExtractor extends Block implements ITileEntityProvider {
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        {
        	((TileEntityExtractor)worldIn.getTileEntity(pos)).getDisplayName();
        }
    }
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing heldItem, float side, float hitX, float hitY) 
	{
        ...
        {
        	playerIn.openGui(References.MOD_ID, GuiHandler.GUI_APPLIANCE_EXTRACTOR, worldIn, pos.getX(), pos.getY(), pos.getZ());
            return true;
        }
	}
