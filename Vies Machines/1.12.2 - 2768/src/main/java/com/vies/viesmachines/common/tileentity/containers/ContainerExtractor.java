...
public class ContainerExtractor extends ContainerTileEntityVM {
    ...
    public boolean canInteractWith(EntityPlayer playerIn)
    {
        ...
        return this.world.getBlockState(this.appliance.getPos()).getBlock() != BlocksVM.EXTRACTOR ? false : playerIn.getDistanceSq((double)this.appliance.getPos().getX() + 0.5D, (double)this.appliance.getPos().getY() + 0.5D, (double)this.appliance.getPos().getZ() + 0.5D) <= 64.0D;
    }
