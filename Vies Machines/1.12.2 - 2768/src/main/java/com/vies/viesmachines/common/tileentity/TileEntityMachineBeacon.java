...
public class TileEntityMachineBeacon extends TileEntity implements ITickable {
    ...
    private final String defaultNameVM = "appliance_machine_beacon";
    
    public TileEntityMachineBeacon() 
    {
