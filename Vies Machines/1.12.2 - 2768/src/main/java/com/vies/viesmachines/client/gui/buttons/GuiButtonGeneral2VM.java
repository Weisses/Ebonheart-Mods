...
public class GuiButtonGeneral2VM extends GuiButton {
	...
	public GuiButtonGeneral2VM(int buttonId, int x, int y, int widthIn, int heightIn, String buttonTextIn, int textureIn) 
	{
