...
public class MessageHelperEventTrigger51Server extends MessageBase<MessageHelperEventTrigger51Server> {
	...
	@Override
	public void handleClientSide(MessageHelperEventTrigger51Server message, EntityPlayer player) 
	{
		
	}
	
	@Override
	public void handleServerSide(MessageHelperEventTrigger51Server message, EntityPlayer player) 
	{
		...
		NetworkHandler.sendToAllAround(new MessageHelperEventTrigger51Client(), 
