...
public class BlockMachineBeacon extends Block implements ITileEntityProvider {
	
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
    
	public BlockMachineBeacon(String unlocalizedNameIn, Material materialIn, SoundType soundTypeIn) 
	{
		super(materialIn);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        {
        	((TileEntityMachineBeacon)worldIn.getTileEntity(pos)).getDisplayName();
        }
    }
    ...
    public boolean shouldSideBeRendered(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
        ...
        if (this == BlocksVM.MACHINE_BEACON)
        {
	...
	{
		TileEntityMachineBeacon te = (TileEntityMachineBeacon)world.getTileEntity(pos);
	...
	{
		return new TileEntityMachineBeacon();
	}
