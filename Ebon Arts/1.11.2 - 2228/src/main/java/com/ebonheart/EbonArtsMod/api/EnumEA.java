...
public class EnumEA {
    ...
    public static enum GemstoneTypeItemV1 implements IStringSerializable
    {
        ...
        DRACONITE(0, "draconite", I18n.translateToLocal("ea.item.enum.frame.0"), RegistryType.ITEMONLY, EnumRarity.COMMON),
        VELIOUS(1, "velious", I18n.translateToLocal("ea.item.enum.frame.1"), RegistryType.ITEMONLY, EnumRarity.UNCOMMON),
    	ARCANITE(2, "arcanite", I18n.translateToLocal("ea.item.enum.frame.2"), RegistryType.ITEMONLY, EnumRarity.UNCOMMON),
    	KATCHEEN(3, "katcheen", I18n.translateToLocal("ea.item.enum.frame.3"), RegistryType.ITEMONLY, EnumRarity.RARE),
    	CARNELIAN(4, "carnelian", I18n.translateToLocal("ea.item.enum.frame.4"), RegistryType.ITEMONLY, EnumRarity.RARE),
    	NECROCITE(5, "necrocite", I18n.translateToLocal("ea.item.enum.frame.5"), RegistryType.ITEMONLY, EnumRarity.EPIC),
    	ONYXIUS(6, "onyxius", I18n.translateToLocal("ea.item.enum.frame.6"), RegistryType.ITEMONLY, EnumRarity.RARE),
    	SOULARITE(7, "soularite", I18n.translateToLocal("ea.item.enum.frame.7"), RegistryType.ITEMONLY, EnumRarity.EPIC),
    	EBONHEART(8, "ebonheart", I18n.translateToLocal("ea.item.enum.frame.8"), RegistryType.ITEMONLY, EnumRarity.EPIC);
    ...
    {
    	//STRING(meta, registerName, localizedName, generalType, enumRarity)
        GATAMITE(0, "zz1", I18n.translateToLocal("ea.item.enum.frame.0"), RegistryType.ITEMONLY, EnumRarity.COMMON),
        INFERNUS(1, "zz2", I18n.translateToLocal("ea.item.enum.frame.1"), RegistryType.ITEMONLY, EnumRarity.UNCOMMON),
        ATRIUS(2, "zz3", I18n.translateToLocal("ea.item.enum.frame.2"), RegistryType.ITEMONLY, EnumRarity.UNCOMMON),
        ENSTATITE(3, "zz4", I18n.translateToLocal("ea.item.enum.frame.3"), RegistryType.ITEMONLY, EnumRarity.RARE),
    	Z1(4, "z1", I18n.translateToLocal("ea.item.enum.frame.4"), RegistryType.ITEMONLY, EnumRarity.RARE),
    	Z2(5, "z2", I18n.translateToLocal("ea.item.enum.frame.5"), RegistryType.ITEMONLY, EnumRarity.EPIC),
    	Z3(6, "z3", I18n.translateToLocal("ea.item.enum.frame.6"), RegistryType.ITEMONLY, EnumRarity.RARE),
    	Z4(7, "z4", I18n.translateToLocal("ea.item.enum.frame.7"), RegistryType.ITEMONLY, EnumRarity.EPIC),
    	Z5(8, "x5", I18n.translateToLocal("ea.item.enum.frame.8"), RegistryType.ITEMONLY, EnumRarity.EPIC);
    ...
    public static enum GemstoneTypeBlockV1 implements IStringSerializable
    {
        ...
        DRACONITE(0, "draconite", I18n.translateToLocal("ea.blockv1.enum.frame.0"), RegistryType.ALL, EnumRarity.COMMON, 2, 5.0F, 4.0F, 0F),
        VELIOUS(1, "velious", I18n.translateToLocal("ea.blockv1.enum.frame.1"), RegistryType.ALL, EnumRarity.COMMON, 2, 5.0F, 15.0F, 0F),
    	ARCANITE(2, "arcanite", I18n.translateToLocal("ea.blockv1.enum.frame.2"), RegistryType.ALL, EnumRarity.COMMON, 2, 5.0F, 30.0F, 0F),
    	KATCHEEN(3, "katcheen", I18n.translateToLocal("ea.blockv1.enum.frame.3"), RegistryType.ALL, EnumRarity.COMMON, 2, 5.0F, 30.0F, 0F),
    	CARNELIAN(4, "carnelian", I18n.translateToLocal("ea.blockv1.enum.frame.4"), RegistryType.ALL, EnumRarity.COMMON, 2, 5.0F, 30.0F, 0F),
    	NECROCITE(5, "necrocite", I18n.translateToLocal("ea.blockv1.enum.frame.5"), RegistryType.ALL, EnumRarity.COMMON, 2, 5.0F, 30.0F, 0F),
    	ONYXIUS(6, "onyxius", I18n.translateToLocal("ea.blockv1.enum.frame.6"), RegistryType.ALL, EnumRarity.COMMON, 2, 5.0F, 30.0F, 0F),
    	SOULARITE(7, "soularite", I18n.translateToLocal("ea.blockv1.enum.frame.7"), RegistryType.ALL, EnumRarity.COMMON, 2, 5.0F, 30.0F, 0F),
    	EBONHEART(8, "ebonheart", I18n.translateToLocal("ea.blockv1.enum.frame.8"), RegistryType.ALL, EnumRarity.COMMON, 2, 5.0F, 30F, 0F);
