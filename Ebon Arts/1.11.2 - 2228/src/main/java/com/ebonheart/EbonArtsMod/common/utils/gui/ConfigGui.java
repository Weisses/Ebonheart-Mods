...
public class ConfigGui extends GuiConfig {
	...
	{
		super(screen, new ConfigElement(EbonArtsMod.config.getCategory(Configuration.CATEGORY_GENERAL)).getChildElements(), References.MOD_NAME, true, true, GuiConfig.getAbridgedConfigPath(EbonArtsMod.config.toString()));
