...
import com.ebonheart.EbonArtsMod.common.blocks.basic.BlockFenceEA;
import com.ebonheart.EbonArtsMod.common.blocks.basic.BlockStairsEA;
import com.ebonheart.EbonArtsMod.common.blocks.gemstones.BlockGemstoneBasicV1;
import com.ebonheart.EbonArtsMod.common.blocks.gemstones.ItemBlockGemstoneBasicV1;
import com.ebonheart.EbonArtsMod.common.blocks.slabs.BlockDoubleSlabEA;
import com.ebonheart.EbonArtsMod.common.blocks.slabs.BlockHalfSlabEA;
...
public class InitBlocksEA extends BlocksEA {
	...
	{
		gemstone_block_basic_v1 = registerBlockMetaGemstoneBasicV1(new BlockGemstoneBasicV1("gemstone/basic/block_basic"));
		gemstone_block_brick_v1 = registerBlockMetaGemstoneBasicV1(new BlockGemstoneBasicV1("gemstone/brick/block_brick"));
		
		basic_doubleslab_draconite = new BlockDoubleSlabEA("gemstone/slab/basic_doubleslab_draconite").setResistance(4.0F).setLightLevel(0.4f);
		basic_doubleslab_velious = new BlockDoubleSlabEA("gemstone/slab/basic_doubleslab_velious").setResistance(15.0F);
		basic_doubleslab_arcanite = new BlockDoubleSlabEA("gemstone/slab/basic_doubleslab_arcanite").setResistance(30.0F);
		basic_doubleslab_katcheen = new BlockDoubleSlabEA("gemstone/slab/basic_doubleslab_katcheen").setResistance(100.0F);
		basic_doubleslab_carnelian = new BlockDoubleSlabEA("gemstone/slab/basic_doubleslab_carnelian").setResistance(45.0F).setLightLevel(1.0f);
		basic_doubleslab_necrocite = new BlockDoubleSlabEA("gemstone/slab/basic_doubleslab_necrocite").setResistance(45.0F);
		basic_doubleslab_onyxius = new BlockDoubleSlabEA("gemstone/slab/basic_doubleslab_onyxius").setResistance(2000.0F);
		basic_doubleslab_soularite = new BlockDoubleSlabEA("gemstone/slab/basic_doubleslab_soularite").setResistance(45.0F);
		basic_doubleslab_ebonheart = new BlockDoubleSlabEA("gemstone/slab/basic_doubleslab_ebonheart").setResistance(2000.0F);
		
		basic_halfslab_draconite = new BlockHalfSlabEA("gemstone/slab/basic_halfslab_draconite").setResistance(4.0F).setLightLevel(0.4f).setCreativeTab(EbonArtsMod.tabEbonArtsBlocks);
		basic_halfslab_velious = new BlockHalfSlabEA("gemstone/slab/basic_halfslab_velious").setResistance(15.0F).setCreativeTab(EbonArtsMod.tabEbonArtsBlocks);
		basic_halfslab_arcanite = new BlockHalfSlabEA("gemstone/slab/basic_halfslab_arcanite").setResistance(30.0F).setCreativeTab(EbonArtsMod.tabEbonArtsBlocks);
		basic_halfslab_katcheen = new BlockHalfSlabEA("gemstone/slab/basic_halfslab_katcheen").setResistance(100.0F).setCreativeTab(EbonArtsMod.tabEbonArtsBlocks);
		basic_halfslab_carnelian = new BlockHalfSlabEA("gemstone/slab/basic_halfslab_carnelian").setResistance(45.0F).setCreativeTab(EbonArtsMod.tabEbonArtsBlocks);
		basic_halfslab_necrocite = new BlockHalfSlabEA("gemstone/slab/basic_halfslab_necrocite").setResistance(45.0F).setCreativeTab(EbonArtsMod.tabEbonArtsBlocks);
		basic_halfslab_onyxius = new BlockHalfSlabEA("gemstone/slab/basic_halfslab_onyxius").setResistance(45.0F).setCreativeTab(EbonArtsMod.tabEbonArtsBlocks);
		basic_halfslab_soularite = new BlockHalfSlabEA("gemstone/slab/basic_halfslab_soularite").setResistance(45.0F).setCreativeTab(EbonArtsMod.tabEbonArtsBlocks);
		basic_halfslab_ebonheart = new BlockHalfSlabEA("gemstone/slab/basic_halfslab_ebonheart").setResistance(2000.0F).setCreativeTab(EbonArtsMod.tabEbonArtsBlocks);
		...
		basic_stairs_draconite = registerBlock(new BlockStairsEA("gemstone/stairs/basic_stairs_draconite", gemstone_block_basic_v1).setResistance(4.0F).setLightLevel(0.4f));
		basic_stairs_velious = registerBlock(new BlockStairsEA("gemstone/stairs/basic_stairs_velious", gemstone_block_basic_v1).setResistance(15.0F));
		basic_stairs_arcanite = registerBlock(new BlockStairsEA("gemstone/stairs/basic_stairs_arcanite", gemstone_block_basic_v1).setResistance(30.0F));
		basic_stairs_katcheen = registerBlock(new BlockStairsEA("gemstone/stairs/basic_stairs_katcheen", gemstone_block_basic_v1).setResistance(100.0F));
		basic_stairs_carnelian = registerBlock(new BlockStairsEA("gemstone/stairs/basic_stairs_carnelian", gemstone_block_basic_v1).setResistance(100.0F));
		basic_stairs_necrocite = registerBlock(new BlockStairsEA("gemstone/stairs/basic_stairs_necrocite", gemstone_block_basic_v1).setResistance(45.0F));
		basic_stairs_onyxius = registerBlock(new BlockStairsEA("gemstone/stairs/basic_stairs_onyxius", gemstone_block_basic_v1).setResistance(100.0F));
		basic_stairs_soularite = registerBlock(new BlockStairsEA("gemstone/stairs/basic_stairs_soularite", gemstone_block_basic_v1).setResistance(45.0F));
		basic_stairs_ebonheart = registerBlock(new BlockStairsEA("gemstone/stairs/basic_stairs_ebonheart", gemstone_block_basic_v1).setResistance(2000.0F));
		
		basic_fence_draconite = registerBlock(new BlockFenceEA("gemstone/fence/basic_fence_draconite").setResistance(4.0F).setLightLevel(0.4f));
		basic_fence_velious = registerBlock(new BlockFenceEA("gemstone/fence/basic_fence_velious").setResistance(15.0F));
		basic_fence_arcanite = registerBlock(new BlockFenceEA("gemstone/fence/basic_fence_arcanite").setResistance(30.0F));
		basic_fence_katcheen = registerBlock(new BlockFenceEA("gemstone/fence/basic_fence_katcheen").setResistance(100.0F));
		basic_fence_carnelian = registerBlock(new BlockFenceEA("gemstone/fence/basic_fence_carnelian").setResistance(45.0F));
		basic_fence_necrocite = registerBlock(new BlockFenceEA("gemstone/fence/basic_fence_necrocite").setResistance(45.0F));
		basic_fence_onyxius = registerBlock(new BlockFenceEA("gemstone/fence/basic_fence_onyxius").setResistance(45.0F));
		basic_fence_soularite = registerBlock(new BlockFenceEA("gemstone/fence/basic_fence_soularite").setResistance(45.0F));
		basic_fence_ebonheart = registerBlock(new BlockFenceEA("gemstone/fence/basic_fence_ebonheart").setResistance(2000.0F));
